		...
		$school_balance_point=$arr['school_balance_point'];
			...
			//change in query done by Pranali for bug SMC-3312
					...
					$tID = $arr['t_id'];
	  				...
	  				mysql_query("update tbl_teacher set tc_balance_point='$tc_balance_point' where t_id='$tID' and school_id='$school_id'");
...
<!--align="center" in <h2> tag added by Pranali -->
        	<h2 style="padding-left:20px; margin-top:10px;" align="center">Assign  Green Points To <?php echo $dynamic_teacher;?></h2>
...
<div style="background-color:#FFFFFF; border:1px solid #CCCCCC;box-shadow: 0px 1px 3px 1px #C3C3C4;" align="left">
		...
		?>  </center></h2>
         ...
         <?php 
            ...
            $sql=mysql_query("select id,t_id,t_complete_name,t_name,t_middlename,t_lastname,school_id,t_current_school_name,tc_balance_point from tbl_teacher where t_id='$teacher_id' and school_id='$school_id'");
...
<a href="teacherassign.php" style="text-decoration:none;"><input type="button" value="Back" class="btn btn-danger"></a></div>
