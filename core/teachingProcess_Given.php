...
<title>Teaching Process Given</title>
   ...
   $dpt=$_GET['dpt']; 
    ...
    $(function () {
        ...
        window.pagObj = $('#pagination').twbsPagination({
            ...
            console.log(page);
        			window.location.assign('teachingProcess_Given.php?yr=<?php echo $yr."&dpt=".$dpt;?>&page='+page);
                                                      ...
                                                      $(function () {
                                                        ...
                                                        window.pagObj = $('#pagination').twbsPagination({
                                                          ...
                                                          <?php if($_GET['yr'] or $_GET['dpt']){ ?>
                                                            window.location.assign('teachingProcess_Given.php?yr=<?php echo $yr."&dpt=".$dpt; ?>&Search=<?php echo $searchq; ?>&spage='+page);
                                                            <?php } else{ ?>
                                                              window.location.assign('teachingProcess_Given.php?Search=<?php echo $searchq; ?>&spage='+page);
                                                              <?php } ?>
                                                            });
                                                          });
                                                        </script>
                                                        ...
                                                        <div class="container" style="width:100%;">
                                                          ...
                                                          <div class='row'>
                                                            <form style="margin-top:5px;">
                                                              ...
                                                              <div class="col-md-1" >
                                                                <input type="button" class="btn btn-info" value="Reset" onclick="window.open('teachingProcess_Given.php?yr=<?php echo $yr; ?>&dpt=<?php echo $dpt; ?>','_self')" />
                                                              </div>
                                                              <div class='col-md-1 '>
