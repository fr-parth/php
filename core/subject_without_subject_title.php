...
$result = mysql_query("SELECT subject_id,Subject_Code,subject FROM tbl_school_subject where(subject  ='' or subject is null ) and School_ID='$school_id'");
?>
<html>
<head>
<style>
...
<div class="container">
	<div class="panel panel-default">
		<div class="panel-heading" align='center'><h3> Subject without<br> Subject Name</h3></div>
