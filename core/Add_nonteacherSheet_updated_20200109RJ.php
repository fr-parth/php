<?php
//include("conn.php");
//Added by Rutuja Jori for Non-teaching/Management Staff on 09/01/2020 for SMC-4413
error_reporting(0);
if(isset($_GET['id']))
{
...
<div class='container' style="padding-top:30px;padding-left:30px;">
   ...
   <div style="color:red;font-size:15px;font-weight:bold;margin-top:10px;"> <?php if(isset($_GET['report'])){ echo $_GET['report']; };?></div>
          <div class='panel-heading'>
                ...
                <h3>Add <?php echo $nonTeacherStaff;?> Excel Sheet</h3>
      ...
      <div class='panel-body' style="background:lightgrey; box-shadow: 0 0 10px 10px black;">
          ...
          <div class="row" style="margin-left: 500px;">
                  ...
                  <div class='form-group'>
                                ...
                                <div class='col-md-3' style="margin-top:-35px">
								 <a href="add_Nonteacherlist.php" style="text-decoration:none;">
                            <!--<button class='btn-lg btn-danger'  type='submit'>Cancel</button>-->
							<!--Height parameter added by Rutuja for SMC-4354 on 09/01/20202-->
...
<table cellpadding="12" cellspacing="6" align="center">
<tr bgcolor="#9900CC">
<center><a href="download_stud_upload_format.php?name=<?php echo "T";?>">Download <?php echo $nonTeacherStaff;?> Upload Excel Sheet Format</a></center><tr>
<center><?php for($space=1;$space<=25;$space++){?>&nbsp;<?php }?>
<a href="download_stud_upload_format.php?name=<?php echo "ET";?>">Download <?php echo $nonTeacherStaff;?> Error Excel Sheet</a></center><tr>
