...
tbl_vol_spect_master vm on vm.id=ls.EntityID and vm.school_id=ls.school_id 
 where ls.Entity_type='119' and ls.school_id='$school_id' order by RowID desc LIMIT $start_from, $webpagelimit") or die("Could not Search!");
 ...
 ls inner join 
tbl_vol_spect_master vm on vm.id=ls.EntityID and vm.school_id=ls.school_id 
 where ls.Entity_type='119' and ls.school_id='$school_id' order by RowID desc");
...
else
{
 ...
 ls inner join 
tbl_vol_spect_master vm on vm.id=ls.EntityID and vm.school_id=ls.school_id 
 where ls.Entity_type='119' and ls.school_id='$school_id' AND (vm.name LIKE '%$searchq%' or vm.category LIKE '%$searchq%' or vm.mobile LIKE '%$searchq%' or ls.EntityID LIKE '%$searchq%'  or ls.school_id LIKE '%$searchq%'
...
<script type="text/javascript">
    $(function () {
        ...
        window.pagObj = $('#pagination').twbsPagination({
			...
			window.location.assign('sc_spectator_login_Details.php?page='+page);
        });
    });
</script>
<?php }else{
...
<script type="text/javascript">
    $(function () {
        ...
        window.pagObj = $('#pagination').twbsPagination({
            ...
            console.info(page + '(from event listening)');
			window.location.assign('sc_spectator_login_Details.php?colname=<?php echo $colname;?>&Search=<?php echo $searchq; ?>&spage='+page);
        });
    });
</script>
<?php }?>
...
<div align="center">
    <div class="container" style="width:100%;">
		...
		<form style="margin-top:5px;">
			...
			<div class="col-md-1" >
			<input type="button" class="btn btn-info" value="Reset" onclick="window.open('sc_spectator_login_Details.php','_self')" />
			</div>
			<div class="col-md-1" >
