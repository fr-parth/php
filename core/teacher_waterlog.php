...
//Added user & below if conditions to solve the issue of 'No data available' even though there are records. -Rutuja for SMC-4353 on 21/03/2020
...
<div class="container">
    <div  style="width:100%;">
    	...
    	<div style="height:50px; background-color:#FFFFFF; border:1px solid #CCCCCC;box-shadow: 0px 1px 3px 1px #C3C3C4;" align="left">
        	<h2 style="padding-left:20px; margin-top:2px;color:#666" class="text-center">Water Points Given To <?php echo $dynamic_teacher;?> For Distribution</h2>
        </div>
