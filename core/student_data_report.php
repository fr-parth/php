...
/*Author:Rutuja Jori
  Date  :30/12/2020
  This file was created for generating Excel Report of Student for SMC-5075
*/
$report="";
...
?> <div align="center"> <?php if($j1>0){ echo "<h3>".$j1." $dynamic_student Data Downloaded Successfully"; ?>&nbsp;&nbsp;&nbsp;&nbsp; <?php echo "<a href='student_data_report.php'>Back</a></h3>"; }else{echo "<h3>$dynamic_student data not found"; ?>&nbsp;&nbsp;&nbsp;&nbsp; <?php echo "<a href='student_data_report.php'>Back</a></h3>";} ?> </div> 
<?php 

echo ("<script LANGUAGE='JavaScript'> 
          window.location.href='export_student.php?year=".$year."';
          </script>");
}
?>
...
<?php $row=mysql_query("select distinct(Academic_Year) from tbl_student where Academic_Year !='' and school_id='$school_id'");
