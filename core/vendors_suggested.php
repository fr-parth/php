...
<head>
    ...
    <title> Suggested Sponsors</title>
...
<div align="center">
    <div class="container" style="width:100%;">
        <div style="padding-top:30px;">
            ...
            <h2 style="padding-left:20px; margin-top:2px;color:#666"> Suggested Sponsors</h2>
		 		...
		 		<?php if (!($_GET['Search']))
		 			{
		 				...
		 				echo "<div style='margin-top:5px;'><font color='blue'><b style='padding-left:-60px;'>Now showing ".($start_from +1)." to ".($webpagelimit)." records out of ".$total_records. " records.</b></font></div>";
		    }else
		 			{
		 				if ($webpagelimit >$total_records){ $webpagelimit=$total_records;}
