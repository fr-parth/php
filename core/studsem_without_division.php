...
and semester.`IsCurrentSemester`='1' 
  ...
  and(semester.DivisionName  ='' or semester.DivisionName is null ) 
	...
	$sql1=" SELECT id FROM StudentSemesterRecord 
			where(DivisionName ='' or DivisionName is null ) and school_id='$school_id' and AcdemicYear='$Academic_Year'";
		...
		and semester.`IsCurrentSemester`='1' 
		  ...
		  and(semester.DivisionName  ='' or semester.DivisionName is null ) 
				...
				$sql1 =mysql_query("SELECT id FROM StudentSemesterRecord 
									WHERE  (DivisionName ='' or DivisionName is null ) 
...
//$result = mysql_query("SELECT student_id , Semesterid, BranchName, DeptName ,SemesterName,DivisionName,ExtDivisionID FROM StudentSemesterRecord where(DivisionName  ='' or DivisionName is null ) and School_ID='$school_id'");
?>
<html>
<head>
<style>
	...
	<?php if (!($_GET['Search'])){ ?>
		<script type="text/javascript">
    		$(function () {
				...
				window.location.assign('studsem_without_division.php?page='+page);
    });
  });
  </script>
	<?php }else{
		...
		<script type="text/javascript">
    		$(function () {
            	...
            	console.info(page + '(from event listening)');
				window.location.assign('studsem_without_division.php?colname=<?php echo $colname;?>&Search=<?php echo $searchq; ?>&spage='+page);
    		});
		});
   </script>
<?php }?>
...
<div class="container">
			<div style="padding-top:30px" align="center" >
        		<h2 style="padding-left:20px;padding-top:10px;padding-bottom:10px;background-color:#428BCA; margin-top:2px;color:#666;color:white">Student Semester Data without Division (<?php echo $total_records; ?>)</h2>
			</div>
...
<form>
		...
		<select name="colname" class="form-control">
			...
			<?php if (($_GET['colname']) == "SemesterName") {
					echo $_GET['colname']; ?> selected="selected" <?php } ?>>Semester Name</option>  
                     ...
                     <option value="ExtDivisionID"
			<?php if (($_GET['colname']) == "ExtDivisionID") {
					echo $_GET['colname']; ?> selected="selected" <?php } ?>>Division Id</option>  
	...
	<div class="col-md-1">
	<input type="button" class="btn btn-danger" value="Reset" onclick="window.open('studsem_without_division.php','_self')" />
	</div>	
</form>
<!-- search form END -->	
