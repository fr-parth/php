...
<div class="radius " style="height:50px; width:100%; background-color:#694489;" align="center">
        	<h2 style="padding-left:20px;padding-top:15px; margin-top:20px;color:white">Dashboard</h2>
        </div>
...
<div  style="padding-top:20px;">
 ...
 <a href="school_list.php" style="text-decoration:none";>
    <div class="col-md-3 shadow radius" style="background-color:#FFFFFF; border:1px solid #694489;">
                	<h4 class="" align="center">No. of Schools</h4>
...
<div class="col-sm-1" style="padding-top:20px;" ></div>
 <a  href="teacher_list.php" style="text-decoration:none";>
    <div class="col-md-3 shadow radius" style="background-color:#FFFFFF; border:1px solid #694489;">
                ...
                $result = mysql_query('SELECT count(t.t_id) as total_teachers ,t.t_name,t.t_complete_name,t.t_middlename,t.t_lastname,t.school_id,tsa.school_name,t.t_email,t.t_phone,t.t_address
	FROM tbl_teacher t 
	JOIN tbl_school_admin tsa ON t.school_id = tsa.school_id
	WHERE t.t_emp_type_pid in (133,134,135,137)'); 
 ...
 <a href="sponsor_list.php" style="text-decoration:none";>
    <div class="col-md-3 shadow radius" style="background-color:#FFFFFF; border:1px solid #694489;">
                	<h4 align="center">No. of Sponsors</h4>
                            <div align="center" style="font-size:54px;padding-left:5px;color:#7647a2;font-weight:bold;">
									<?php
									    $row=mysql_query("select COUNT(id) AS total from tbl_sponsorer");
 ...
 <a href="parent_list.php" style="text-decoration:none";>
    <div class="col-md-3 shadow radius" style="background-color:#FFFFFF; border:1px solid #694489; ">
                	<h4 align="center">No. of Parents</h4>
                            <div align="center" style="font-size:54px;padding-left:5px;color:#7647a2;font-weight:bold;">
									<?php $row=mysql_query("select COUNT(id) AS total from tbl_parent");
                                             $row = mysql_fetch_array($row);
												echo $row['total'];
 ...
 <a href="CookieAdminStaff_list.php" style="text-decoration:none";>
    <div class="col-md-3 shadow radius" style="background-color:#FFFFFF; border:1px solid #694489; ">
                	<h4 align="center">No. of Staff</h4>
                            <div align="center" style="font-size:54px;padding-left:5px;color:#7647a2;font-weight:bold;">
									<?php $row=mysql_query("select COUNT(id) AS total from tbl_cookie_adminstaff");
                                             $row = mysql_fetch_array($row);
												echo $row['total'];
	...
	<div class="col-sm-1" style="padding-top:20px;"></div>
	<a href="group_admin_list.php" style="text-decoration:none";>
    <div class="col-md-3 shadow radius" style="background-color:#FFFFFF; border:1px solid #694489; ">
                	<h4 align="center">No. of Groups</h4>
                            <div align="center" style="font-size:54px;padding-left:5px;color:#7647a2;font-weight:bold;">
									<?php $row=mysql_query("select COUNT(id) AS total from tbl_cookieadmin where id>1");
                                             $row = mysql_fetch_array($row);
												echo $row['total'];
