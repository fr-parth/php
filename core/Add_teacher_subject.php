...
// query for check the subject code already exist or not
$query_chk_exist=mysql_query("select count(*) as cnt from tbl_teacher_subject_master where teacher_id ='$tid' and school_id='$sc_id' and subjcet_code='$subject_code' and subjectName='$subject' and Division_id='$division' and Semester_id='$semester' and Branches_id='$branch' and Department_id='$department' and CourseLevel='$coursename' and AcademicYear='$academic_year' ");
$query_chk_exist_result=mysql_fetch_assoc($query_chk_exist);
// echo $query_chk_exist_result['cnt'];
// exit;
if($query_chk_exist_result['cnt']>0){
    $subject_already_exist=0;
}
 else{
...
//echo $branch;end;
        ...
        else
        {
            ...
            // echo "failed";
            echo ("<script LANGUAGE='JavaScript'>
                     alert('$dynamic_teacher $dynamic_subject already exist');
                    </script>");
        }
    }
    ?>
                        ...
                        <div class="row" style="padding-top:30px;">
                            ...
                            <div class="col-md-3">
                                ...
                                <option value=""> Select <?php echo $dynamic_subject;?> Title</option>
                                    ...
                                    <?php
                                    $sql_subject = mysql_query("select subject, Subject_Code from  tbl_school_subject where school_id='$sc_id' order by subject");
                ...
                <div class="row formgroup" style="padding:5px;">
                    <form method="post">
                        ...
                        <div class="row" style="padding-top:30px;">
                            ...
                            <div class="col-md-3">
                                <select name="subject_name" id="subject_name" class="form-control" onChange="Myfunction(this.value,'fun_subject')">
                                <option value="<?php echo $subjcet_code.','.$subjectName; ?>"><?php echo $subjectName; ?>(<?php echo $subjcet_code; ?>)</option>
                                    <?php
                                    $sql_subject = mysql_query("select subject,Subject_Code from  tbl_school_subject where school_id='$sc_id' order by subject");
                                    while ($result_subject = mysql_fetch_array($sql_subject)) {
                                        ?>
                            ...
                            <div class="col-md-3">
                                ...
                                <option value="<?php echo $ExtYearID.','.$AcademicYear; ?>"><?php echo $AcademicYear; ?></option>
                                    ...
                                    while ($result_year = mysql_fetch_array($sql_year)) {
                                        ...
                                        <option value="<?php echo $result_year['ExtYearID'].','.$result_year['Academic_Year'].','.$result_year['Year']?>"><?php echo $result_year['Academic_Year']?></option>
