...
if (isset($_GET['edit_id'])) {
    ...
    if (isset($_POST['Update'])) {
        ...
        $age = $year_diff;
        $sqls = "update tbl_teacher set t_name='$name',t_exprience='$experience',t_designation='$designation',t_qualification='$education',t_address='$address',t_dept = '$department',t_city='$city',t_dob='$date',t_age='$age',t_gender='$gender',t_country='$country',t_email='$email',t_phone='$phone',state='$state', is_active='$is_active' where id=" . $t_id . "";
...
color: #777;">
                            ...
                            <div class='form-group'>
                                <div class='col-md-6'>
                                    <input class='form-control' id='phone' name="id_phone" placeholder='Mobile No'
                                           maxlength="10" pattern="[1-9]{1}[0-9]{9}" type='text' onChange="PhoneValidation(this);">
                                </div>
    ...
    if (isset($_GET['id'])) {
        ...
        if (isset($_POST['submit'])) {
            ...
            if (mysql_num_rows($row) <= 0) {
                $id_first_name = mysql_real_escape_string($_POST['id_first_name']);
                $id_last_name = mysql_real_escape_string($_POST['id_last_name']);
                $name = mysql_real_escape_string($id_first_name . " " . $id_last_name);
                //$education = $_POST['id_education'];
                $test = $_POST['other1'];
                ...
                $school_name = mysql_real_escape_string($r['school_name']);

                $class = mysql_real_escape_string($_POST['class1']);
                $subject = mysql_real_escape_string($_POST['subject']);
                $email = mysql_real_escape_string($_POST['id_email']);
...
if(isset($_GET['t_id'])==''){
                ...
                if (mysql_num_rows($row) <= 0) {
                    ...
                    if (mysql_num_rows($row_id) <= 0) {
                        ...
                        if($test == "" ){
                         ...
                         $date_3= explode('/',$date_of_appointment);

                         if($date_3[0] <= 6){                            
                            $academic_year = ($date_3[2]-1)."-".$date_3[2];
                        }else{
                            $academic_year = $date_3[2]."-".($date_3[2]+1);
                        }
                      ...
                      ///   $acad_year = $_POST['Intruduce_YeqarID'];
                        ...
                        $depart = $_POST['dept'];
                         ...
                         $dep = explode (",", $depart); 
                         $t_DeptCod = $_POST['t_DeptCode'];
                         $dep1 = explode (",", $t_DeptCod);
                        $t_DeptCode=$dep1[1];
                         $department = $dep[1];
                         $dept_id = $dep[0];
    ...
    list($month1,$day1,$year1) = explode("/",$date_of_appointment);

    $year_diff1  = date("Y") - $year1; 
    $month_diff1 = date("m") - $month1; 
    $day_diff1   = date("d") - $day1; 
        if ($day_diff1 < 0 || $month_diff1 < 0) $year_diff1--;
    
    $age1= $year_diff1;

    $dateformat1=$year1. "-" .$month1. "-" .$day1;
   ...
   if($department=="All" && $dept_id==0)
                  ...
                  $sqls = "INSERT INTO `tbl_teacher`(t_academic_year,school_type,entity_type_id,reporting_manager_id,t_id,CountryCode,t_name,t_middlename,t_lastname,t_complete_name, t_current_school_name,school_id,t_exprience ,t_designation,t_subject,t_qualification,t_dept,t_DeptID,t_DeptCode,t_class,t_date_of_appointment, t_address,t_temp_address, t_city, t_dob, t_gender,t_age, t_country, t_email,t_internal_email,  t_date,state,t_phone,t_password,t_emp_type_pid,group_member_id,created_by,created_on,group_teacher_id,edu_org_teacher_id,state_group_teacher_id,state_group_id,edu_org_id) VALUES ('$academic_year','$school_type','$entity_type_id','$reporting_id','$t_id','$calling_code','$id_first_name','$id_middle_name', '$id_last_name','$name','$school_name','$school_id','$experience','$designation','$subject','$education',NULL,NULL,$t_DeptCode,$class,'$dateformat1','$address','$t_address','$city','$dateformat','$gender','$age' ,'$country', '$email', '$inemail', NOW(),'$state','$phone','$password','$employee','','','','$group_teacher_id','$edu_org_teacher_id','$state_group_teacher_id','$state_group_id','$edu_org_id')";
                            
                     }
                     else{

                 $sqls = "INSERT INTO `tbl_teacher`(t_academic_year,school_type,entity_type_id,reporting_manager_id,t_id,CountryCode,t_name,t_middlename,t_lastname,t_complete_name, t_current_school_name,school_id,t_exprience ,t_designation,t_subject,t_qualification,t_dept,t_DeptID,t_DeptCode,t_class,t_date_of_appointment, t_address,t_temp_address, t_city, t_dob, t_gender,t_age, t_country, t_email,t_internal_email,  t_date,state,t_phone,t_password,t_emp_type_pid,group_member_id,created_by,created_on,group_teacher_id,edu_org_teacher_id,state_group_teacher_id,state_group_id,edu_org_id) 
                                            VALUES ('$academic_year','$school_type','$entity_type_id','$reporting_id','$t_id','$calling_code','$id_first_name','$id_middle_name', '$id_last_name','$name','$school_name','$school_id','$experience','$designation','$subject','$education','$department','$dept_id','$t_DeptCode',$class,'$dateformat1','$address','$t_address','$city','$dateformat','$gender','$age' ,'$country', '$email', '$inemail',NOW(),'$state','$phone','$password','$employee','','','','$group_teacher_id','$edu_org_teacher_id','$state_group_teacher_id','$state_group_id','$edu_org_id')";
 ...
 {  
     ...
     $("#phone").on('change',function(){      
         var dup_phone = document.getElementById("phone").value;

         $.ajax({
             type:"POST",
             data:{dup_phone:dup_phone}, 
             url:'phone_validation.php',
             success:function(data)
             {
                 if(data == 0)
                 {
                      $(data).hide();
                       ...
                       alert("Phone Number already exists...Please try another one");
                      $('#phone').val("");
                 }
                // $('#managerList').html(data);
             }
    ...
    function valid() 
    {
        ...
        //Below code updated by Rutuja for SMC-4846 on 22-09-2020
                ...
                {
                    alert("Please enter <?php echo $dynamic_teacher;?> ID");
                    return false;
                }
                else if (!pattern.test(t_id)) {
                   alert("It is not valid <?php echo $dynamic_teacher;?> ID!");
                    return false;
                }
                else{
                ...
                var pattern = /^[a-zA-Z .-]+$/;
                if(id_first_name=="" || id_first_name==null)
                {
...
<script>
 function Relationfunction1(value,fn)
{
        //alert("hi");
 if(value!='')
 {
          ...
          if (xmlhttp.readyState==4 && xmlhttp.status==200)
            {
                if(fn=='fun_deptname')
                {
                      ...
                      document.getElementById("t_DeptCode").innerHTML =xmlhttp.responseText;
                }
                
                
            }
          }
xmlhttp.open("GET","get_teacher_detail.php?fn="+fn+"&value="+value,true);
        xmlhttp.send();
 }
        ...
        <div class='container'>
            ...
            <div class='panel-body'>
                <form class='form-horizontal' role='form' name="registration" method="post">
                    ...
                    <div class='form-group'>
                        <label class='control-label col-md-2 col-md-offset-2' for='id_accomodation' style="text-align:left;"><?php echo $dynamic_teacher;?> ID <span class="error"><b> *</b></span></label>
                        <div class='col-md-3'>
                            <input type="text" class='form-control' id='t_id' name="t_id" placeholder="Enter <?php echo $dynamic_teacher;?> ID" maxlength="30">
                        </div>
                 ...
                 <div class='form-group'>
                        <div class='row'>
                            <label class='control-label col-md-2 col-md-offset-2' for='id_service' style="text-align:left;padding-left:27px;" ><?php echo $dynamic_teacher;?> Type<span class="error"><b> *</b></span></label>
                            <div class='col-md-3' style="padding-left:20px;">
                    ...
                    <div class='form-group'>
                        <label class='control-label col-md-2 col-md-offset-2' for='id_department' style="text-align:left;">Department Name<span class="error"><b> *</b></span></label>
                        <div class='col-md-3'>
                        <select name='dept' id='deptname' class='form-control' required="required" onChange="Relationfunction1(this.value,'fun_deptname')">
                           <option value="">Select Department</option>            
                        <?php 
                        $sql = "select ExtDeptId,trim(Dept_Name) as Dept_Name from tbl_department_master where School_ID='$school_id' and Dept_Name!='' group by Dept_Name order by trim(Dept_Name)  asc";
                        //$sql = "select ExtDeptId, Dept_Name from tbl_department_master where School_ID='$school_id'";
                    ...
                    <div class='form-group'>
                        <label class='control-label col-md-2 col-md-offset-2' for='id_department' style="text-align:left;">Department Code</label>
                        <div class='col-md-3'>
                            <select  readonly type="text" name='t_DeptCode' id='t_DeptCode' class='form-control' >
                            <option value="">Select Department Code</option> 
                        <?php 
                        //$sql = "select * from tbl_department_master where school_id='$school_id'";
                        //$result = mysql_query($sql);
                        //while($row=mysql_fetch_array($result))
                        //{
                        //  $ExtDeptId = $row['ExtDeptId'];
                        //  $Dept_code = $row['Dept_code'];
                        //  echo "<option value='$ExtDeptId,$Dept_code'>$Dept_code | $ExtDeptId</option>";
                        //}
                        ?>
                     </select> 
...
<?php 
 $query_date = date("M-d-Y", mktime(0, 0, 0, 1, 1, date('Y')));
 ?>
<div class="form-group">

            <label class='control-label col-md-2 col-md-offset-2'  style="text-align:left;" >Date Of Appointment<span class="error"><b> *</b></span></label>
                
              
                <div class='col-md-3' style="text-align:left;">
                 <input type="text" name="date_of_appointment" value="<?php echo date('m/d/Y', strtotime($query_date)); ?>" class="form-control "  autocomplete="off" id="date_of_appointment" required/>
...
<!--<div class="form-group">
            ...
            <?php 
         //   $currentyear = date("Y", mktime(0, 0, 0, 1, 1, date('Y')));
           // $nexyear = date("Y", mktime(0, 0, 0, 1, 1, date('Y')+1));

                ?>
                <?php// echo $currentyear ,"-",$nexyear ?>
                <div class='col-md-3' style="text-align:left;">

                <input type="text" name="Intruduce_YeqarID" readonly id="Intruduce_YeqarID" value="" class="form-control "/> -->
                    ...
                    <div class='form-group '>
                        <label class='control-label col-md-2 col-md-offset-2' for='Mobile no.' style="text-align:left;">Mobile No.<span class="error"><b> *</b></span></label>
                            <div class='col-md-6'>
                                <div class='form-group'>
                                <div class='col-md-6'>
                                    <input class='form-control' id='phone' name="phone" placeholder='Mobile No'   length="10" pattern="[1-9]{1}[0-9]{9}" type='text' onChange="PhoneValidation(this);">
                                </div>
...
if ($t_id != '') {
           ...
           if($department=='All')
            {
                 ...
                 $sql_update11 = "UPDATE `tbl_teacher` SET t_academic_year='$academic_year',reporting_manager_id='$reporting_id', t_complete_name=' $complete_name',t_name='$fname',t_middlename='$mname',t_lastname='$lname',CountryCode='$CountryCode',t_emp_type_pid='$t_emp_type_pid',t_designation='$designation',t_qualification='$education',t_date_of_appointment='$dateformat1',t_dob='$dateformat',t_email='$e_id',            
                
            t_exprience='$exp_mon',t_dept=NULL,t_DeptID=NULL,t_DeptCode=NULL,t_class=$class,t_age='$age',t_gender='$gen',t_internal_email='$internal_emailid',t_phone='$mob',t_landline='$land',t_address='$address',t_temp_address='$t_address',t_country='$country',state='$t_state',t_city='$cty',CountryCode='$CountryCode', group_teacher_id='$group_teacher_id', edu_org_teacher_id='$edu_org_teacher_id', state_group_teacher_id='$state_group_teacher_id', state_group_id='$state_group_id', edu_org_id='$edu_org_id', is_active='$is_active'
            ...
            $sql_update11 = "UPDATE `tbl_teacher` SET t_academic_year='$academic_year',reporting_manager_id='$reporting_id', t_complete_name=' $complete_name',t_name='$fname',t_middlename='$mname',t_lastname='$lname',CountryCode='$CountryCode',t_emp_type_pid='$t_emp_type_pid',t_designation='$designation',t_qualification='$education',t_date_of_appointment='$dateformat1',t_dob='$dateformat',t_email='$e_id',
            t_exprience='$exp_mon',t_dept='$department',t_DeptID='$dept_id',t_DeptCode='$Dept_code',t_class=$class,t_age='$age',t_gender='$gen',t_internal_email='$internal_emailid',t_phone='$mob',t_landline='$land',t_address='$address',t_temp_address='$t_address',t_country='$country',state='$t_state',t_city='$cty',CountryCode='$CountryCode', group_teacher_id='$group_teacher_id', edu_org_teacher_id='$edu_org_teacher_id', state_group_teacher_id='$state_group_teacher_id', state_group_id='$state_group_id', edu_org_id='$edu_org_id', is_active='$is_active'
            WHERE t_id='$t_id' AND school_id='$school_id'";
        }
            ...
            //     $report = 'There is no change while updating record';
                // echo "<script type=text/javascript>alert('There is no change while updating record');
                // window.location='teacherlist.php'</script>";
            // }
            else {echo "<script type=text/javascript>alert('There is no change while updating record'); 
                window.location='teacherlist.php'</script>";}
        } 
        else {
             echo "<script type=text/javascript>alert('There is no change while updating record'); 
    ...
    if (mysql_num_rows($query) >= 1) {
      ...
      if($mname1==''){
        ...
        $date_of_appointment = $value1['t_date_of_appointment'];
        $d2=explode("-",$date_of_appointment);
        $date_birth = $value1['t_dob'];
        $doapp=$d2['1']. "/" .$d2['2']. "/" .$d2['0'];
 ...
 //Validations added by Rutuja Jori on 01/11/2019
        function valid() {
           ...
           /* if (experience == null || experience == "") {
            ...
            var is_active1 = document.getElementById("is_active1").checked;

            var is_active2 = document.getElementById("is_active2").checked;

            if (is_active1 == false && is_active2 == false) {
            document.getElementById('erroris_active').innerHTML = 'Please Select active';
            return false;
            } else {
            document.getElementById('erroris_active').innerHTML = '';
            }
...
<div class='container'>
    ...
    <div class='panel-body'>
        ...
        <div class='form-group'>
                <label class='control-label col-md-2 col-md-offset-2' for='id_accomodation' style="text-align:left;"><?php echo $dynamic_teacher;?> ID<b style="color:red";> *</b></span></label>
                <div class='col-md-3'>
            ...
            <div class='form-group'>
                ...
                <div class='col-md-3' >
                 ...
                 <script>
                  ...
                  <div class='form-group'>
                <label class='control-label col-md-2 col-md-offset-2' for='id_accomodation' style="text-align:left;"><?php echo $dynamic_teacher;?> Type<b style="color:red";> *</b></span></label>
                <div class='col-md-3'>
             ...
             <div class='form-group'>
                ...
                <div class='col-md-3'>
                    ...
                    <!--SMC-4575 Updated for showing Department list by default on 03/03/2020 by Rutuja & for solving the issue of Department getting blank after we update Department-->
                        ...
                        echo $dept;
                        if ($dept != '') {
                            $arr = mysql_query("select Dept_code,ExtDeptId,trim(Dept_Name) as Dept_Name from tbl_department_master where School_ID='$school_id' and Is_Enabled='1' and Dept_Name!='' group by Dept_Name order by trim(Dept_Name)  asc");
                            while ($row = mysql_fetch_array($arr)) {
                                $Dept_code =$row['Dept_code']; 
                                $Dept_Name=$row['Dept_Name'];
                                $ExtDeptId=$row['ExtDeptId'];
                                 if ($dept != $Dept_Name) { ?>
                                    <option value="<?php echo $Dept_Name;?>,<?php echo $Dept_code; ?>,<?php echo $ExtDeptId; ?>"><?php echo $Dept_Name,'(', $Dept_code,')';?></option>
                                <?php  }
                                    
                                 }
                            ?>
                            <!-- <option value='<?php //echo $dept ?>,<?php// echo $t_DeptID; ?>'
                                    selected><?php //echo $t_DeptID,',',$dept; ?></option> -->

                                      <option value='<?php echo $dept ?>,<?php echo $t_DeptCode; ?>'
                                    selected><?php echo $dept,'(',$t_DeptCode,')'; ?></option>
                            <?php
                        }
                        ...
                        <?php
                       // $arr = mysql_query("select ExtDeptId,trim(Dept_Name) as Dept_Name from tbl_department_master where School_ID='$school_id' and Is_Enabled='1' and Dept_Name!='' group by Dept_Name order by trim(Dept_Name)  asc");
                        // $arr = mysql_query("select * from tbl_department_master where school_id='$school_id' and Is_Enabled='1'"); 
                       //  while ($row = mysql_fetch_array($arr)) { 
                        // $Dept_Name=$row['Dept_Name'];
                        // $ExtDeptId=$row['ExtDeptId'];
                        ...
                        <?php //if ($dept != $Dept_Name) { ?>
                            <!-- <option value="<?php// echo $Dept_Name;?>,<?php// echo $ExtDeptId; ?>"><?php //echo $Dept_Name,',', $ExtDeptId;?></option> -->
                         <?php //}
...
<div class="form-group">
            ...
            <div class='form-group'>
                <label class='control-label col-md-2 col-md-offset-2' for='id_accomodation' style="text-align:left;">Date of Appointment<b style="color:red";>* </b></span></label>
                <div class='col-md-3'>
                
                <input type="text"  id='date_of_appointment' name="date_of_appointment" value="<?php echo $doapp; ?>" autocomplete="off" class='form-control'>
...
color: #777;">
  ...
  <div class='form-group'>
        ...
        <div class='form-group'>
                <label class='control-label col-md-2 col-md-offset-2' for='id_pets' style="text-align:left;">Active</label>
                <div class='col-md-2' style="font-weight: 600;

color: #777;">
                    <input type="radio" name="is_active" id="is_active1" <?php if ($is_active == "1") echo 'checked'; ?> value="1">Yes
                </div>
                <div class='col-md-3' style="font-weight: 600;

color: #777;">
                    <input type="radio"   name="is_active" id="is_active2" <?php if ($is_active == "0") echo 'checked'; ?> value="0">No
                </div>
                <div class='col-md-2 indent-small' id="erroris_active" style="color:#FF0000">
                </div>
            </div>
            ...
            <div class='form-group row'>
                ...
                <div class='col-md-1'>
                    <a href="teacherlist.php">
                        <input type="button" class='btn-lg btn-danger' value="Cancel" name="cancel" style="padding:5px;"/></a>
                </div>
        </form>
    </div>
