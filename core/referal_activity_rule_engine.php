			...
			<tbody>
				...
				?>
					<tr>
						...
						<!--changes done by Pranali intern-->
						<td><?php echo ucwords($row['referal_reason'],"_");?></td>
						<td><a href="update_referal_activity.php?&id=<?php echo $row['id'];?>"><i class='glyphicon glyphicon-pencil'></i></a></td>
						<!--<td><p onclick="delete_item(<?php echo $row['id'];?>)"><i class='glyphicon glyphicon-trash'></i></p></td>-->
						<!--Hided delete option as per discussion with Santosh Sir for new development for SMC-4447 by Rutuja on 23/01/2020<td><a href="add_update_delete_referal_activity.php?curd=delete&id=<?php echo $row['id'];?>"><i class='glyphicon glyphicon-trash'></i></a></td>-->
					</tr>
				<?php
					}
				?>
