...
<head>
    ...
    <title>Department Activity Not Given</title>
...
FROM tbl_teacher  t
 where t.school_id='$school_id' and t.t_academic_year='$yr' and t.t_dept='$dpt' and t.t_emp_type_pid
		in (135,137) and t.t_id NOT IN
 (
select ft.tID
from tbl_360_activities_data ft where ft.activity_level_id='1' and  ft.tID is not NULL and  ft.schoolID='$school_id' )
...
<script type="text/javascript">
    $(function () {
        ...
        window.pagObj = $('#pagination').twbsPagination({
            ...
            console.log(page);
        			window.location.assign('department360_notGiven.php?yr=<?php echo $yr."&dpt=".$dpt;?>&page='+page);
    ...
    $(function () {
        ...
        window.pagObj = $('#pagination').twbsPagination({
            ...
            <?php if($_GET['yr'] or $_GET['dpt']){ ?>
      			window.location.assign('department360_notGiven.php?yr=<?php echo $yr."&dpt=".$dpt; ?>&Search=<?php echo $searchq; ?>&spage='+page);
                <?php } else{ ?>
            window.location.assign('department360_notGiven.php?Search=<?php echo $searchq; ?>&spage='+page);
                <?php } ?>
        });
    });
</script>
...
<div align="center">
    <div class="container" style="width:100%;">
       ...
       <input type='hidden' name='dpt' value='<?php echo $_GET['dpt']?>'> </input>
			...
			<div class="col-md-1" >
			<input type="button" class="btn btn-info" value="Reset" onclick="window.open('department360_notGiven.php?yr=<?php echo $yr; ?>&dpt=<?php echo $dpt; ?>','_self')" />
			</div>
