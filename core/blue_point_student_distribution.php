...
if (isset($_GET['name'])) {
        ...
        <div style="width:100%;">
            ...
            <div id="no-more-tables" style="padding-top:20px;">
                <table class="col-md-12 table-bordered table-striped table-condensed cf" align="center"
                    ...
                    $arrs = mysql_query("select s.id ,s.std_name,s.used_blue_points, re.sc_total_point from tbl_student_reward re join tbl_student s on re.sc_stud_id = s.id  where s.school_id=$school_id ORDER BY s.id LIMIT $offset, $rec_limit");
                    ...
                    while ($student = mysql_fetch_array($arrs)) {
                        ...
                        <tr>
                            ...
                            <td data-title="<?php echo $dynamic_student ?> Name"><?php echo $student['std_name']; ?></td>
							...
							*/
                            ...
                            <td data-title="Used Points"><?php echo $student['used_blue_points']; ?></td>
                        </tr>
    ...
    <div class="container">
        <div style="width:100%;">
            ...
            <div style="height:50px; background-color:#FFFFFF; border:1px solid #CCCCCC;box-shadow: 0px 1px 3px 1px #C3C3C4;"
                 align="left">
                <h2 style="padding-left:20px; margin-top:2px;color:#666">Blue Points Given to <?php echo $dynamic_student?> for Distribution</h2>
            </div>
            <div id="no-more-tables" style="padding-top:20px;">
                ...
                <table id="example" class="table-bordered  table-condensed cf" width="100%">
                    ...
                    <tr style="background-color:#555;color:#FFFFFF;height:30px;">
                        <th>Sr. No.</th>
                        <th><?php echo $dynamic_student ?> PRN</th>
                        <th><?php echo $dynamic_student ?> Name</th>
                    ...
                    $sql = mysql_query("Select std_PRN,std_name,std_Father_name,std_lastname,std_complete_name,used_blue_points,balance_bluestud_points from tbl_student where school_id='$school_id' order by std_complete_name,std_name ASC");
                    while ($value1 = mysql_fetch_array($sql)) {
                        ...
                        <tr>
                            <td><?php echo $j; ?></td>
                            <td><?php echo $value1['std_PRN']; ?></td>
                            <td data-title="<?php echo $dynamic_student?> Name"><?php
                            ...
                            <td data-title="Used Points"><?php echo $value1['used_blue_points']; ?></td>
                            <td data-title="Used Points"><?php echo $value1['balance_bluestud_points']; ?></td>
                        </tr>
                        <?php
                    }
