...
<div class="container" style="padding:10px;">
    ...
    <div class="col-md-8 "  align="left">
        ...
        <div id="no-more-tables" style="padding-top:20px;">
                ...
                <tbody>
                     <?php  $sql="select sc_list,activity_type,stp.sc_id from tbl_studentpointslist stp join tbl_activity_type  act on stp.sc_type=act.id  where stp.school_id='0' and stp.group_member_id='0' ORDER BY  sc_id DESC";
                    ...
                    $i=0;
                        ...
                        <tr>
                            ...
                            <td data-title="Edit" width="10%" align="center"> <a href="edit_system_activity.php?activity=<?php echo $row1['sc_id'];  ?>"   style="text-decoration:none"><span class="glyphicon glyphicon-pencil"></span> </a></td>
                            <td data-title="Delete" width="10%" align="center"><a style="text-decoration:none" onClick="confirmation(<?php echo $row1['sc_id']; ?> )"><span class="glyphicon glyphicon-trash"></span></a></td>
