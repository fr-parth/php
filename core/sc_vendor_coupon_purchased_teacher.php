...
$sql=mysql_query("SELECT tvc.coupon_id, tvc.code, tvc.user_id,t.t_complete_name,t.school_id  
...
$sql1 ="SELECT count(t.t_complete_name),tvc.coupon_id, tvc.code, tvc.user_id,t.school_id  
 FROM tbl_selected_vendor_coupons tvc 
 INNER JOIN tbl_teacher t ON tvc.user_id=t.id and t.school_id=tvc.school_id where tvc.entity_id='2' and t.school_id='$school_id'";  
...
if($searchq !='')
	...
	{
		$query1=mysql_query("SELECT tvc.coupon_id, tvc.code, tvc.user_id,t.t_complete_name,t.school_id  
 FROM tbl_selected_vendor_coupons tvc 
 INNER JOIN tbl_teacher t ON tvc.user_id=t.id and t.school_id=tvc.school_id and t.school_id=tvc.school_id  where (tvc.entity_id='2' and  t.school_id='$school_id')
 and
			...
			$sql1 ="SELECT count(t.t_complete_name),tvc.code, tvc.user_id,tvc.coupon_id,t.school_id  
 FROM tbl_selected_vendor_coupons tvc 
 INNER JOIN tbl_teacher t ON tvc.user_id=t.id and t.school_id=tvc.school_id where (tvc.entity_id='2' and  t.school_id='$school_id')
 and 
           ( t.t_complete_name LIKE '%$searchq%' or 
			...
			$query1=mysql_query("SELECT t.t_complete_name,tvc.coupon_id, tvc.code, tvc.user_id,t.school_id  
 FROM tbl_selected_vendor_coupons tvc 
 INNER JOIN tbl_teacher t ON tvc.user_id=t.id and t.school_id=tvc.school_id where (tvc.entity_id='2' and  t.school_id='$school_id')
 and 
...
<script type="text/javascript">
    $(function () {
        ...
        window.pagObj = $('#pagination').twbsPagination({
			...
			window.location.assign('sc_vendor_coupon_purchased_teacher.php?page='+page);
        });
    });
</script>
<?php }else{
...
<script type="text/javascript">
    $(function () {
        ...
        window.pagObj = $('#pagination').twbsPagination({
            ...
            console.info(page + '(from event listening)');
			window.location.assign('sc_vendor_coupon_purchased_teacher.php?Search=<?php echo $searchq; ?>&spage='+page);
        });
    });
</script>
...
<div align="center">
    <div class="container" style="width:100%;">
		...
		<div class="col-md-2" style="width:17%;">
			...
			<div class="col-md-1" >
			<input type="button" class="btn btn-info" value="Reset" onclick="window.open('sc_vendor_coupon_purchased_teacher.php','_self')" />
			</div>
			<div class="col-md-1" >
