...
Date:02/11/2020
This file is created for display error log summary of app name with count for SMC-4929.
*/
...
$sql=mysql_query("select id,app_name from tbl_error_log where app_name !='' and (datetime between '".$_SESSION['from']."' and '".$_SESSION['to']."') group by app_name LIMIT $start_from, $webpagelimit");	

$sql1 ="select id, app_name from tbl_error_log where app_name !='' and (datetime between '".$_SESSION['from']."' and '".$_SESSION['to']."') group by app_name ";  
...
<script type="text/javascript">
    $(function () {
        ...
        window.pagObj = $('#pagination').twbsPagination({
			...
			window.location.assign('error_app_name_list.php?page='+page);
        });
    });
</script>
<?php }else{
...
<script type="text/javascript">
    $(function () {
        ...
        window.pagObj = $('#pagination').twbsPagination({
            ...
            console.info(page + '(from event listening)');
			window.location.assign('error_app_name_list.php?Search=<?php echo $searchq; ?>&spage='+page);
        });
    });
</script>
...
<div align="center">
    <div class="container" style="width:100%;">
        <div style="padding-top:30px;">
            ...
            <h2 style="padding-left:20px; margin-top:2px;color:#666"> App Name List</h2>
        ...
        <div id="no-more-tables" style="padding-top:20px;">
            ...
            <table id="example" class="col-md-12 table-bordered " align="center">
                ...
                while($result = mysql_fetch_array($sql)) {
					...
					$querys=mysql_query("select id,app_name from tbl_error_log where app_name ='".$result['app_name']."' and (datetime between '".$_SESSION['from']."' and '".$_SESSION['to']."')");
                    ...
                    <tr>
                        ...
                        <td data-title="Webservice Name"><?php echo $result['app_name'];?></td>
			...
			<?php 
			$qr=mysql_query("select  app_name from tbl_error_log where app_name !='' and (datetime between '".$_SESSION['from']."' and '".$_SESSION['to']."') ");
