...
$Entity_type = xss_clean(mysql_real_escape_string($obj->{'Entity_type'}));
  ...
  $format = 'json';
    ...
    if($teacher_id!="")
	{
	$query="UPDATE tbl_LoginStatus SET LogoutTime = '$date' where EntityID='$teacher_id' and Entity_type='$Entity_type' ORDER BY `RowID` DESC limit 1";
