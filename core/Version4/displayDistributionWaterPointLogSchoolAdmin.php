 ...
 $offset=offset($offset);//default offset = "0"
	if($t_id!="" && $school_id!="" )
	{
			$arr=mysql_query("Select sc_point,reason,point_date from tbl_teacher_point
				where (point_type='Waterpoint' or point_type='Water Points') and sc_teacher_id ='$t_id' and school_id='$school_id' and sc_entities_id='102' ORDER BY id DESC LIMIT $limit OFFSET $offset");	
