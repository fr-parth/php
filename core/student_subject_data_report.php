<?php
  ...
  /*
  Author:Ashutosh Chavhan
  Date  :04/07/2021
  This file was created for generating Excel Report of Student Subject for SMC-5470
  */
  ...
  if(isset($_POST['submit']))
  {
    ...
    if($year != ''){
        $qr="select * from tbl_student_subject_master where school_id='$sc_id' and AcademicYear = '$year' ";
   ...
   //$_SESSION['report_header']=array("SchoolID","StudentPRN","SubjectCode","SemesterID","BranchID","SubjectID","YearID","DivisionID","SubjectName","Division","Semester","Branch","Department","CourseLevel","AcademicYear","TeacherID");
    ...
    <div align="center"> 
      <?php 
        ...
        { 
          //echo "<h2>".$sc_name."</h2>";
          echo "<h3>".$j1." ".$dynamic_student_Subject." Downloaded Successfully"; ?>
          &nbsp;&nbsp;&nbsp;&nbsp; 
          <?php echo "<a href='student_subject_data_report.php'>Back</a></h3>"; 
        }
        else
        {
          //echo "<h2>".$sc_name."</h2>";
    ...
    <?php echo ("<script LANGUAGE='JavaScript'> window.location.href='export_student_subject.php?year=".$year."'; </script>");		
...
<html>
  ...
  <body bgcolor="#CCCCCC">
          ...
          <form method="post" name="academic_yr" style="height: 47%;" onSubmit="return validateForm()">
            ...
            <div class="row">
                        ...
                        <div class="col-md-11 " align="center" style="color:#663399;" >
                              ...
                              <h2>Download <?php echo $dynamic_student_Subject;?> Data</h2>
                        </div>
    ...
    <select name="year" id="year" class="smartsearch form-control" />
            ...
            <?php $row=mysql_query("select AcademicYear from tbl_student_subject_master where school_id='$school_id' and AcademicYear !='' group by AcademicYear");
