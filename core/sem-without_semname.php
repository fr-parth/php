...
$result = mysql_query("SELECT Semester_Id ,  Semester_Name , class  FROM tbl_semester_master where(Semester_Name  ='' or Semester_Name is null ) and School_ID='$school_id'");
?>
<html>
<head>
<style>
...
<div class="container">
	<div class="panel panel-default">
		<div class="panel-heading" align='center'><h3> Semester  without <br>Semester Name</h3></div>
