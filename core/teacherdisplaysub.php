...
<div class="container">
<div  align="center"  >
	<h2><?php echo $dynamic_teacher;?> <?php echo $dynamic_subject; ?></h2>
 </div>
<form method="post">
<table align="center" style="margin-top: 1cm;">
<!-- Added labels and Academic Year dropdown list code by Chaitali for SMC-4619 -->
<tr>
<td>
<dic class='row'>
<div class=''>
<div class="form-group has-success">
<label>Enter <?php echo $dynamic_teacher; ?> Name</label>
...
<div class=''>
<div class="form-group has-success">
<label>Enter <?php echo $dynamic_teacher; ?> ID</label>
<!-- Camel casing done for Teacher ID and Go by Pranali -->
...
<input  class="form-control"  type="text" name="subtitle" placeholder="<?php echo $dynamic_subject; ?> Name" value="<?php if(isset($_POST['subtitle'])) { echo $_POST['subtitle']; }?>">
</div>
</div>
</td>
<td><?php echo "&nbsp"  ?></td>
...
<div class=''>
<div class="form-group has-success">
<label>Enter <?php echo $dynamic_subjects;?> Code</label>
<input  class="form-control"  type="text" name="subcode" placeholder="<?php echo $dynamic_subjects;?> Code" value="<?php if(isset($_POST['subcode'])) { echo $_POST['subcode']; }?>">
</div>
</div>
</td>
<td><?php echo "&nbsp"  ?></td>
...
<input  class="form-control"  type="text" name="branch" placeholder="<?php echo $dynamic_branches;?>" value="<?php if(isset($_POST['branch'])) { echo $_POST['branch']; }?>">
</div>
</div>
</td>
<td><?php echo "&nbsp"  ?></td>
...
<option value="<?php if(isset($_POST['acadamicyear'])) { echo $_POST['acadamicyear']; }?>"><?php if(isset($_POST['acadamicyear'])) { echo $_POST['acadamicyear']; } else {echo 'Select Academic Year';}?></option>
<?php while($row = mysql_fetch_array($query_acadamic)) { ?>
<option value="<?php echo $row['Academic_Year']; ?>"><?php echo $row['Academic_Year']; ?></option>
<?php } ?>
<!--
<input  class="form-control"  type="text" name="acadamicyear" placeholder="<?php echo $dynamic_year;?>" value="<?php if(isset($_POST['acayear'])) { echo $_POST['acayear']; }?>">
-->
</div>
</div>
</td>
...
else
{
	...
	?>
			...
			<th style="text-align:center"><?php echo $dynamic_subject; ?> Code</th>
			<th style="text-align:center">Branch</th>
			<th style="text-align:center">Semester</th>
			<th style="text-align:center">Academic Year</th></tr>
			</thead>
			<tbody>
