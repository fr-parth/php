...
//echo hii; exit;
    ...
    $imagepath = (isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] === 'on' ? 
				...
				$activity_type = $post['activity_type'];
						...
						$posts[] = array("BlogID"=>$BlogID,"BlogTitle"=>$BlogTitle,"Description"=>$Description,"featureimage"=>$imagepath,"MemberID"=>$MemberID,"EntityType"=>$EntityType,"PRN_TID"=>$PRN_TID,"SchoolID"=>$SchoolID,"cnt_likes"=>$cnt_likes,"avg_star_cnt"=>$avg_star_cnt,"rating"=>$rating,"name"=>$name,"activity"=>$activity,"date"=>$date,"sc_list"=>$sc_list,"activity_type"=>$activity_type);
