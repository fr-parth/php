...
//$dynamic_school_admin VARIABLE ADDED BY SAYALI BALKAWADE FOR SMC-4254 ON 11/12/2019 
					mysql_query("insert into tbl_teacher_point(sc_teacher_id,sc_entities_id,assigner_id,sc_point,sc_thanqupointlist_id,point_date,reason,point_type,school_id,Teacher_Member_Id) values('$t_id','102','$scadmin_id','$point','$activity_id','$assign_date','assign by $dynamic_school_admin','Bluepoint','$school_id','$Teacher_Member_Id')");
          ...
          <div class="col-md-4">
              ...
              <div class="row" style="padding:5px;">
               ...
               <div class="col-md-3"></div>
                ...
                <a href="search_teacher_reward_points.php" style="text-decoration:none;"> <input type="button" class="btn btn-danger" name="back" value="Back"/></a>
