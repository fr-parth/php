...
{               
			...
			{   
        	   ...
        	   $prn=$result['std_PRN'];
				...
				//insert query modified by Pranali for SMC-4132 on 03-10-19

				//$dynamic_school_admin added by Sayali Balkawade for SMC-4254 on 11/12/2019
                    $log=mysql_query("INSERT into tbl_student_point(sc_stud_id,sc_entites_id,sc_point,point_date,reason,school_id,type_points,Stud_Member_Id)
							   VALUES($prn,102,$points,'$date',
							   'assigned by $dynamic_school_admin','$school_id','blue_point','$Stud_Member_Id')");
				...
				echo ("<script LANGUAGE='JavaScript'>
					...
					window.location.href='search_student_points.php';
					</script>");
...
<div class="container">
<div class="row" align="center"> 
<h2> Blue Points to <?php echo $dynamic_student;?> </h2>
</div>
...
<form id="form-1" action="" method="post">
  <fieldset>
    <legend><?php echo $result['std_name'];?></legend>
     ...
     <?php if($result['std_class']!="" && $_SESSION['usertype'] == 'School Admin'){?>
     <label for="field1">Class</label>&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $result['std_class'];?><br><br>
<?php }?>
 ...
 <?php }?>
   ...
   ?>
    ...
    <div align="center">
     <input type="submit" class="button" value="Assign" name="submit" onClick="return valid();" />
   <a href="search_student_points.php" style="text-decoration:none; ">
  <input type="button" class="button" value="Back" style="width: 80px;
	color: #f3f3f3;
	-moz-border-radius: 6px;
	-webkit-border-radius: 6px;
