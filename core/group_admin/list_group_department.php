...
function confirmation(xxx)
  {
    ...
    if (answer){
        ...
        window.location = "delete_group_class.php?id="+xxx;
    }
    else{
...
<div class="container" style="padding:25px;">
              ...
              <div style="padding:2px 2px 2px 2px;border:1px solid #CCCCCC; border:1px solid #CCCCCC;box-shadow: 0px 1px 3px 1px #C3C3C4;">
                    ...
                    <div class="col-md-3 "  style="color:#700000 ;padding:5px;" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                       <a href="add_group_class.php?id=<?=$staff_id?>">   <input type="submit" class="btn btn-primary" name="submit" value="Add Class" style="width:100px;font-weight:bold;font-size:14px;"/></a>
                     </div>
           ...
           $i=1;
          $arr=mysql_query("select *  tbl_school_class where group_member_id='$group_member_id' ORDER BY class ASC");?>
                 ...
                 <?php $class_id= $row['id'];?>  <a href="edit_group_class.php?cl=<?php echo $class_id; ?>">Edit</a></center></b></th><th style="width:150px;" ><center><a onClick="confirmation(<?php echo $class_id; ?>"> Delete</a></center> </th></tr>
                <?php $i++;?>
                 <?php }?>
                  </tbody>
...
<script>
    function confirmation($d_id)
  {
    ...
    if (answer){
        ...
        window.location = "delete_group_department.php?id="+$d_id;
    }
    else{
              ...
              <div style="padding:2px 2px 2px 2px;border:1px solid #CCCCCC; border:1px solid #CCCCCC;box-shadow: 0px 1px 3px 1px #C3C3C4;">
                    ...
                    <div class="col-md-3 "  style="color:#700000 ;padding:5px;" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                      <!--below href updated by Rutuja Jori for merging Add & Edit pages into one on 28/11/2019 for SMC-4196-->
                       <a href="add_group_department.php">   <input type="submit" class="btn btn-primary" name="submit" value="Add Department" style="width:150px;font-weight:bold;font-size:14px;"/></a>
                     </div>
                     <div class="col-md-5 " align="center" style="color:black;padding:5px;" >
...
<!--Removed <align='left'> styling and Added Sr. No. column by Pranali for SMC-5154 -->
        ...
        <?php
           ...
           $i=1;
          $arr=mysql_query("select * from tbl_department_master where group_member_id='$group_member_id' ORDER BY id desc");?>
                  <?php while($row=mysql_fetch_array($arr)){?>
                 <tr style="height:40px;">
                 ...
                 <td><a href="add_group_department.php?d_id=<?php echo $row['id'];?>&d_code=<?php echo $row['Dept_code']; ?>"><span class="glyphicon glyphicon-pencil"></a>
                </td>
