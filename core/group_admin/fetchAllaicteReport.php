...
//    } 
    ...
    if($sID === 'all' && $deptName === 'all' && $acdYear === 'all')
    {
        //echo "Condition 1";
         
       $per_page_results = 1000;  

       $sqlInd2 = ("SELECT * FROM aicte_ind_feedback_summary_report where group_member_id='$GroupMemId'");
    ...
    $query = ("SELECT school_id,school_name,dept_name,teacher_id,teacher_name,scadmin_state,teaching_process,student_feedback,dept_activity,inst_activity,acr,cont_society,total_on_100,total_on_scale_10,academic_year FROM aicte_ind_feedback_summary_report where group_member_id='$GroupMemId' order by school_id ASC LIMIT " . $this_page_first_result . ',' .$per_page_results); 
         ...
         $query1 = ("SELECT COUNT(teaching_process) as teaCount,COUNT(student_feedback) as stuCount,COUNT(dept_activity) as deptCount,COUNT(inst_activity) as instCount,COUNT(acr) as acrCount,COUNT(cont_society) as cotToSocCount FROM aicte_ind_feedback_summary_report"); 
...
//             header("Content-Disposition: attachment; filename=download.xls");
    ...
    else if($sID === 'all' && $deptName != '' && $deptName != 'all' && $acdYear === 'all')
    { 
       $per_page_results = 1000;  

       $sqlInd2 = ("SELECT * FROM aicte_ind_feedback_summary_report WHERE dept_name='$deptName' AND group_member_id='$GroupMemId'");
    ...
    $query = ("SELECT school_id,school_name,dept_name,teacher_id,teacher_name,scadmin_state,teaching_process,student_feedback,dept_activity,inst_activity,acr,cont_society,total_on_100,total_on_scale_10,academic_year FROM aicte_ind_feedback_summary_report  WHERE dept_name='$deptName' AND group_member_id='$GroupMemId' order by school_id ASC LIMIT " . $this_page_first_result . ',' .$per_page_results); 
         ...
         $query1 = ("SELECT COUNT(teaching_process) as teaCount,COUNT(student_feedback) as stuCount,COUNT(dept_activity) as deptCount,COUNT(inst_activity) as instCount,COUNT(acr) as acrCount,COUNT(cont_society) as cotToSocCount FROM aicte_ind_feedback_summary_report WHERE dept_name='$deptName'"); 
    ...
    }else if($sID === 'all' && $deptName === 'all' && $acdYear != '' && $acdYear != 'all')
    { 
       $per_page_results = 1000;  

       $sqlInd2 = ("SELECT * FROM aicte_ind_feedback_summary_report WHERE academic_year='$acdYear' AND group_member_id='$GroupMemId'");
    ...
    $query = ("SELECT school_id,school_name,dept_name,teacher_id,teacher_name,scadmin_state,teaching_process,student_feedback,dept_activity,inst_activity,acr,cont_society,total_on_100,total_on_scale_10,academic_year FROM aicte_ind_feedback_summary_report WHERE academic_year='$acdYear' AND group_member_id='$GroupMemId' order by school_id ASC LIMIT " . $this_page_first_result . ',' .$per_page_results); 
...
//             header("Content-Disposition: attachment; filename=download.xls");
    ...
    else if($sID === 'all' && $deptName != '' && $deptName != 'all' && $acdYear != '' && $acdYear != 'all')
    { 
       $per_page_results = 1000;  

       $sqlInd2 = ("SELECT * FROM aicte_ind_feedback_summary_report WHERE dept_name='$deptName' AND academic_year='$acdYear' AND group_member_id='$GroupMemId'");
    ...
    $query = ("SELECT school_id,school_name,dept_name,teacher_id,teacher_name,scadmin_state,teaching_process,student_feedback,dept_activity,inst_activity,acr,cont_society,total_on_100,total_on_scale_10,academic_year FROM aicte_ind_feedback_summary_report  WHERE dept_name='$deptName' AND academic_year='$acdYear' AND group_member_id='$GroupMemId' order by school_id ASC LIMIT " . $this_page_first_result . ',' .$per_page_results); 
...
//             header("Content-Disposition: attachment; filename=download.xls");
    ...
    else if($sID != '' && $sID != 'all' && $deptName === 'all' && $acdYear === 'all')
    {  
       $per_page_results = 1000;  

       $sqlInd2 = ("SELECT * FROM aicte_ind_feedback_summary_report WHERE school_id='$sID' AND group_member_id='$GroupMemId'");
    ...
    $query = ("SELECT school_id,school_name,dept_name,teacher_id,teacher_name,scadmin_state,teaching_process,student_feedback,dept_activity,inst_activity,acr,cont_society,total_on_100,total_on_scale_10,academic_year FROM aicte_ind_feedback_summary_report  WHERE school_id='$sID' AND group_member_id='$GroupMemId' order by school_id ASC LIMIT " . $this_page_first_result . ',' .$per_page_results); 
         ...
         $query1 = ("SELECT COUNT(teaching_process) as teaCount,COUNT(student_feedback) as stuCount,COUNT(dept_activity) as deptCount,COUNT(inst_activity) as instCount,COUNT(acr) as acrCount,COUNT(cont_society) as cotToSocCount FROM aicte_ind_feedback_summary_report WHERE school_id='$sID'"); 
...
//             header("Content-Disposition: attachment; filename=download.xls");
    ...
    } else if($sID != '' && $sID != 'all' && $deptName === 'all' && $acdYear != '' && $acdYear != 'all')
    {  
       $per_page_results = 1000;  

       $sqlInd2 = ("SELECT * FROM aicte_ind_feedback_summary_report WHERE school_id='$sID' AND academic_year='$acdYear' AND group_member_id='$GroupMemId'");
    ...
    $query = ("SELECT school_id,school_name,dept_name,teacher_id,teacher_name,scadmin_state,teaching_process,student_feedback,dept_activity,inst_activity,acr,cont_society,total_on_100,total_on_scale_10,academic_year FROM aicte_ind_feedback_summary_report  WHERE school_id='$sID' AND academic_year='$acdYear' AND group_member_id='$GroupMemId' order by school_id ASC LIMIT " . $this_page_first_result . ',' .$per_page_results); 
...
//             header("Content-Disposition: attachment; filename=download.xls");
    ...
    else if($sID != '' && $sID != 'all' && $deptName != 'all' && $deptName != '' && $acdYear === 'all') 
    { 
       $per_page_results = 1000;  
 
       $sqlInd2 = ("SELECT * FROM aicte_ind_feedback_summary_report WHERE school_id='$sID' and dept_name='$deptName' AND group_member_id='$GroupMemId'");
    ...
    $query = ("SELECT school_id,school_name,dept_name,teacher_id,teacher_name,scadmin_state,teaching_process,student_feedback,dept_activity,inst_activity,acr,cont_society,total_on_100,total_on_scale_10,academic_year FROM aicte_ind_feedback_summary_report  WHERE school_id='$sID' and dept_name='$deptName' AND group_member_id='$GroupMemId' order by school_id ASC LIMIT " . $this_page_first_result . ',' .$per_page_results); 
         ...
         $query1 = ("SELECT COUNT(teaching_process) as teaCount,COUNT(student_feedback) as stuCount,COUNT(dept_activity) as deptCount,COUNT(inst_activity) as instCount,COUNT(acr) as acrCount,COUNT(cont_society) as cotToSocCount FROM aicte_ind_feedback_summary_report WHERE school_id='$sID' and dept_name='$deptName'"); 
...
//             header("Content-Disposition: attachment; filename=download.xls");
    ...
    else if($sID != '' && $sID != 'all' && $deptName != 'all' && $deptName != '' && $acdYear != '' && $acdYear != 'all') 
    { 
       $per_page_results = 1000;  
 
       $sqlInd2 = ("SELECT * FROM aicte_ind_feedback_summary_report WHERE school_id='$sID' and dept_name='$deptName' and academic_year='$acdYear' AND group_member_id='$GroupMemId'");
    ...
    $query = ("SELECT school_id,school_name,dept_name,teacher_id,teacher_name,scadmin_state,teaching_process,student_feedback,dept_activity,inst_activity,acr,cont_society,total_on_100,total_on_scale_10,academic_year FROM aicte_ind_feedback_summary_report  WHERE school_id='$sID' and dept_name='$deptName' and academic_year='$acdYear' AND group_member_id='$GroupMemId' order by school_id ASC LIMIT " . $this_page_first_result . ',' .$per_page_results); 
