...
if($_SESSION['usertype']=='HR Admin Staff' OR $_SESSION['usertype']=='School Admin Staff')
    {
        ...
        $query2 = mysql_query("select id from tbl_school_admin where group_member_id ='$group_member_id'"); 
...
if (isset($_POST['submit'])) {
    ...
    if ($_POST['dept_code'] != '') {
        ...
        $sql = mysql_query("select  tdm.Dept_code,tdm.ExtDeptId from tbl_department_master tdm inner join tbl_group_school tgs on tdm.school_id=tgs.school_id where tgs.group_member_id='$group_member_id' and (tdm.Dept_code='$dept_code'or tdm.ExtDeptId='$department_id')");
        $result = mysql_num_rows($sql);
        
        $res=mysql_fetch_array($sql);
        if ($result == 0) {
            $query = mysql_query("insert into tbl_department_master (PhoneNo,Dept_code,Dept_Name,Establiment_Year,ExtDeptId,`Fax_No`,Email_Id,group_member_ID,Is_Enabled,landline) values('$phone_no','$dept_code','$dept_name','$year','$department_id','$FaxNo','$email_id','$group_member_id','$isenable','$landline')");
           // $successreport = "$dept_name is successfully Inserted";
           echo ("<script LANGUAGE='JavaScript'>
                    window.alert('$dept_name is successfully Inserted');
                    window.location.href='list_group_department.php';
                    </script>");
                ...
                <div class="row" style="padding-top:30px;">
                    ...
                    <div class="col-md-3">
                       <!-- Changes done by Pranali on 26-06-2018 for bug SMC-2895-->
                        ...
                        <input type="text" style="padding-right: 25px;margin-left:-95px;" class="form-control" name="dept_name" id="dept_name" placeholder="Enter Department Name"
            ...
            <!--    
                ...
                <div class="col-md-3">
                    <select name="course_level" class="form-control" required>
                        ...
                        <?php
                      //  $sql = "SELECT * FROM `tbl_degree_master` WHERE `group_member_id`='$group_member_id'";
...
<!--Added checked for yes option for setting it by default value of Is Enabled field by Pranali for SMC-5154-->
                ...
                <div class="row" style="padding-top:60px;">
                    ...
                    <div><a href="list_group_department.php" style="text-decoration:none;">
...
if($_SESSION['usertype']=='HR Admin Staff' OR $_SESSION['usertype']=='School Admin Staff')
    {
        $group_member_id=$_SESSION['id']; 
        $query2 = mysql_query("select tsa.id from tbl_school_admin tsa inner join tbl_group_school tgs on tsa.school_id=tgs.school_id where tgs.group_member_id ='$group_member_id'");
...
if($de_code == $d_code)
{
    ...
    $sql = "UPDATE `tbl_department_master` SET Dept_Name='$d_name', Dept_code='$d_code',Establiment_Year='$year',PhoneNo='$phone_no',ExtDeptId='$dept_id',Fax_No='$FaxNo', Email_Id='$email',Is_Enabled='$isenable', landline='$landline' WHERE id='$d_id'";
    //echo "<script>alert('123') </script>";
}
else
{
$sql1 = mysql_query("select * from tbl_department_master tdm inner join tbl_group_school tgs on tdm.School_ID=tgs.school_id where tgs.group_member_id='$group_member_id' and tdm.Dept_code='$d_code'");

// select * from tbl_department_master tdm inner join tbl_group_school tgs on tdm.School_ID=tgs.school_id where tgs.group_member_id='$group_member_id' and tdm.Dept_code='$d_code'
if (mysql_num_rows($sql1) > 0) {
    echo "<script>alert('Record already present') </script>";
}
else
{
    $sql = "UPDATE `tbl_department_master` SET Dept_Name='$d_name', Dept_code='$d_code',Establiment_Year='$year',PhoneNo='$phone_no',ExtDeptId='$dept_id',Fax_No='$FaxNo', Email_Id='$email', landline='$landline' WHERE id='$d_id'";
}
}
...
$sql = mysql_query("select * from tbl_department_master tdm inner join tbl_group_school tgs on tdm.School_ID=tgs.school_id where tgs.group_member_id='$group_member_id' and tgs.id='$d_id'");
        ...
        <div style="padding:2px 2px 2px 2px;border:1px solid #CCCCCC; border:1px solid #CCCCCC;box-shadow: 0px 1px 3px 1px #C3C3C4; background-color:#F8F8F8 ;">
            ...
            <form method="post">
              ...
              <!--  <div class="row" style="padding-top:30px;">
                ...
                <div class="col-md-1"><a href="list_group_department.php"><input type="button" value="Back" class="btn btn-danger"></a></div>
