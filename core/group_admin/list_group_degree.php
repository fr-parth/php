...
<head>
    ...
    if (answer){
       ...
       window.location = "delete_group_degree.php?id="+xxx;
            ...
            <div style="background-color:#F8F8F8 ;">
                <div class="row">
                    <div class="col-md-3 " style="color:#700000 ;padding:5px;">&nbsp;&nbsp;&nbsp;&nbsp;
                        <a href="Add_group_degree.php"> <input type="submit" class="btn btn-primary" name="submit" value="Add Degree" style="font-weight:bold;font-size:14px;"/></a>
                    </div>
                    ...
                    <div class="col-md-12" id="no-more-tables">
                        <table id="example" width="100%" cellspacing="0">
                            ...
                            <tr><!-- Camel casing done for Sr. No. by Pranali -->
                                ...
                                <th><center>Degree  ID</center></th>
                                <th><center>Degree Name</center></th>
                                <th><center>Degree Code</center></th>
                            ...
                            <tbody>
                            <?php $sql = "SELECT * FROM `tbl_degree_master` WHERE `group_member_id`='$group_member_id'";
                            ...
                            <tr >
                                    ...
                                    <td><center>
                                    <a class="btn btn-default" href="Add_group_degree.php?degree_id=<?php echo $rows['id']; ?>">
