...
if(isset($_POST['reset'])){
    ...
    $condition = "WHERE sa.group_member_id='$GroupMemId' AND ".$datetype."='".date("Y-m-d")."'";
            ...
            <div style="background-color:#F8F8F8; padding-top: 20px;">
                <div class="row">
                    ...
                    <div class="col-md-offset-3 col-md-6" align="center">
                        ...
                        ?>
                        <h2 class="center">AICTE College Readiness By <?= $dt;?> For <?= date("d-M-Y");?> </h2>
                    </div>
