<?php
//Updated code for adding pagination & search functionalities-Rutuja on 07/01/2020 for SMC-4399
...
<div class="container" style="padding:25px;">
    ...
    <div class="col-md-8 "  align="left">
                    ...
                    <h1 style="padding-left:50%; margin-top:5px;">List of Activity </h1>
         </div>

                 <div class="col-md-4"  style="left:-35px;">
               <a href="addsystemlevel_activity.php"><input type="button" class="btn btn-primary" name="Add" value="Add Activity" style="background-color:"></a>
                 </div>
				   <div class="col-md-4"  align="right">
               <a href="copyActivityList.php"><input type="submit" class="btn btn-primary" name="copy" value="Copy Activity from Cookieadmin" style="background-color:;margin-top:-50px"></a>
                 </div>
        ...
        <div id="no-more-tables" style="padding-top:20px;">
                ...
                <thead>
                    <tr>
                        ...
                        <th width="50%" align="left">Activity Name</th>
                        <th width="20%" align="left">Activity Type</th>
                ...
                <tbody>
<!-- align='center' removed for proper alignment for bug SMC-4428 by Pranali on 15-1-20 -->
                     <?php  $sql="select sc_list,activity_type,stp.sc_id from tbl_studentpointslist stp join tbl_activity_type  act on stp.sc_type=act.id  where stp.group_member_id='$id' and stp.school_id='0' ORDER BY  sc_id DESC";
                    ...
                    $i=0;
                        ...
                        ?>
                        <tr>
                            <td data-title="Sr.No" width="15%"><?php echo $i;?></td>
                            <td data-title="Activity" width="45%"><?php echo ucwords($row1['sc_list']);?></td>
                            <td data-title="points" width="20%" ><?php echo ucwords($row1['activity_type']);?></td>
                            <td data-title="Edit" width="10%"> <a href="edit_system_activity.php?activity=<?php echo $row1['sc_id'];  ?>"   style="text-decoration:none"><span class="glyphicon glyphicon-pencil"></span> </a></td>
                            <td data-title="Delete" width="10%"><a style="text-decoration:none" onClick="confirmation(<?php echo $row1['sc_id']; ?> )"><span class="glyphicon glyphicon-trash"></span></a></td>
