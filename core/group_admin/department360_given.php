...
SELECT distinct t.t_id,t.t_complete_name,t.t_dept ,t.school_id,t.t_academic_year
  ...
  and t.t_emp_type_pid in (135,137) and t.t_id  IN
   (select sf.tID
    ...
    $(function () {
        ...
        window.pagObj = $('#pagination').twbsPagination({
            ...
            console.info(page + '(from event listening)');
						<?php if($_GET['year']){ ?>
               window.location.assign('department360_given.php?sc_id=<?php echo $sc_id;?>&year=<?php echo $year;?>&group_name=<?php echo $group_name;?>&page='+page);
            <?php } else {?>
 			        window.location.assign('department360_given.php?sc_id=<?php echo $sc_id;?>&page='+page);
            <?php } ?>
        });
    });
</script>
...
<script type="text/javascript">
    $(function () {
        ...
        window.pagObj = $('#pagination').twbsPagination({
            ...
            console.info(page + '(from event listening)');
			<?php if($_GET['year']){ ?>
				 window.location.assign('department360_given.php?sc_id=<?php echo $sc_id;?>&year=<?php echo $year;?>&group_name=<?php echo $group_name;?>&Search=<?php echo $searchq; ?>&spage='+page);
			<?php } else {?>
				window.location.assign('department360_given.php?sc_id=<?php echo $sc_id;?>&Search=<?php echo $searchq; ?>&spage='+page);
			<?php } ?>
        });
    });
</script>
...
<div align="center">
    <div class="container" style="width:100%;">
        <div style="padding-top:30px;">
            ...
            <h2 style="padding-left:20px; margin-top:2px;color:#666"> Department Activity- Given</h2>
     ...
     <?php } ?>
			...
			<div class="col-md-1" >
			<input type="button" class="btn btn-info" value="Reset" onclick="window.open('department360_given.php?sc_id=<?php echo $_GET['sc_id']; ?>&year=<?php echo $_GET['year'];?>&group_name=<?php echo $group_name;?>','_self')" />
			</div>

		 </div>
				</form>
						 </div>
  					<form method="post" class="pull-left" action="dept_given_school.php?year=<?php echo $year?>&group_name=<?php echo $group_name;?>">
