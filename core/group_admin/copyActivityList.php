...
if(isset($_POST['submit']))
{
	...
	$results=mysql_query("SELECT * FROM tbl_studentpointslist where sc_type='$activity_type_id' and group_member_id='0' and school_id='0'");
//echo	$cnt=mysql_num_rows($results);exit;
	 while ($row = mysql_fetch_array($results))
	 {
		 $sc_list=$row['sc_list'];
		 $results1=mysql_query("SELECT * FROM tbl_studentpointslist where sc_list='$sc_list' and school_id='0' and group_member_id='$group_member_id'");
		 $cnt=mysql_num_rows($results1);
		
		 if($cnt==0)
		 {
			$query = mysql_query("INSERT INTO tbl_studentpointslist (sc_list,sc_type,school_id,group_member_id) VALUES ('$sc_list','$activity_type_id1','0','$group_member_id')");
			$number++;
		 }
	 } 
...
<div class="container" style="padding:25px;">
			...
			<?php }?>
               ...
               <div class="col-md-3" id="error_activity_type" style="color:#FF0000;">
			       ...
			       <div class="col-md-4" align="left" >
                    <b><h4 style="margin-left: 175px";>Group Activity Type</h4></b>
                    </div>
            ...
            <?php $row=mysql_query("select * from tbl_activity_type where group_member_id='$group_member_id' and school_id='0'");
			while($value=mysql_fetch_array($row)){?>
