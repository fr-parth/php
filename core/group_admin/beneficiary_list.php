...
$sql=mysql_query("SELECT std_name,std_Father_name,std_lastname,std_complete_name,s.school_id,std_school_name,std_email,std_phone,std_address from tbl_student s inner join tbl_group_school gs on s.school_id=gs.school_id where gs.group_member_id = '$group_member_id' order by s.school_id LIMIT $start_from, $webpagelimit");	

$sql1 ="select COUNT(s.id) from tbl_student s inner join tbl_group_school gs on s.school_id=gs.school_id where gs.group_member_id = '$group_member_id' order by s.school_id";  
...
$colname=mysql_real_escape_string($_GET['colname']);
	if ($colname != ''and $colname != 'Select')
	{
		if($colname== "school_id"){
           $colname = "s.".$colname;
            $query1=mysql_query("SELECT std_name,std_Father_name,std_lastname,std_complete_name, s.school_id,std_school_name,std_email, std_phone,std_address from tbl_student s inner join tbl_group_school gs on s.school_id=gs.school_id where gs.group_member_id = '$group_member_id' AND $colname LIKE '%$searchq%' order by s.school_id LIMIT $start_from, $webpagelimit") or die("could not Search!");
		}else{
            $query1=mysql_query("SELECT
        std_name,std_Father_name,std_lastname,std_complete_name,s.school_id,std_school_name,std_email, std_phone,std_address from tbl_student s inner join tbl_group_school gs on s.school_id=gs.school_id where gs.group_member_id = '$group_member_id' AND $colname LIKE '%$searchq%' order by s.school_id LIMIT $start_from, $webpagelimit") or die("could not Search!");
        }			
		$sql1 ="select COUNT(s.id) from tbl_student s inner join tbl_group_school gs on s.school_id=gs.school_id where gs.group_member_id = '$group_member_id' AND $colname LIKE '%$searchq%' order by s.school_id"; 
					$rs_result = mysql_query($sql1);  
					$row1 = mysql_fetch_row($rs_result);  
					$total_records = $row1[0];  
					$total_pages = ceil($total_records / $webpagelimit);
			...
			$query1=mysql_query("SELECT std_name,std_Father_name,std_lastname,std_complete_name,s.school_id,std_school_name,std_email,std_phone,std_address from tbl_student s inner join tbl_group_school gs on s.school_id=gs.school_id where gs.group_member_id = '$group_member_id' AND (std_name LIKE '$searchq%' or std_Father_name LIKE '$searchq%' or std_lastname LIKE '$searchq%' or std_complete_name LIKE '%$searchq%' or school_id LIKE '$searchq%' or std_school_name LIKE '%$searchq%' or std_email LIKE '$searchq%' or std_phone LIKE '$searchq%'or std_address LIKE '$searchq%')order by s.school_id LIMIT $start_from, $webpagelimit") or die("could not Search!");
			
			$sql1 ="select COUNT(s.id) from tbl_student s inner join tbl_group_school gs on s.school_id=gs.school_id where gs.group_member_id = '$group_member_id' AND (std_name LIKE '$searchq%' or std_Father_name LIKE '$searchq%' or std_lastname LIKE '$searchq%' or std_complete_name LIKE '%$searchq%' or school_id LIKE '$searchq%' or std_school_name LIKE '%$searchq%' or std_email LIKE '$searchq%' or std_phone LIKE '$searchq%'or std_address LIKE '$searchq%')order by school_id "; 
...
<script type="text/javascript">
    $(function () {
        ...
        window.pagObj = $('#pagination').twbsPagination({
			...
			window.location.assign('beneficiary_list.php?page='+page);
        });
    });
</script>
<?php }else{
...
<script type="text/javascript">
    $(function () {
        ...
        window.pagObj = $('#pagination').twbsPagination({
            ...
            console.info(page + '(from event listening)');
			window.location.assign('beneficiary_list.php?colname=<?php echo $colname;?>&Search=<?php echo $searchq; ?>&spage='+page);
        });
    });
</script>
<?php }?>
...
<div align="center">
    <div class="container" style="width:100%;">
        <div style="padding-top:30px;">
            ...
            <h2 style="padding-left:20px; margin-top:2px;color:#666"> List of <?php echo $dynamic_student;?></h2>
		...
		<form style="margin-top:5px;">
            ...
            <div class="col-md-2" style="width:17%;">
                <select name="colname" class="form-control">
					...
					<?php if (($_GET['colname']) == "std_complete_name") {
                     ...
                     <option value="std_school_name"
					<?php if (($_GET['colname']) == "std_school_name") {
					...
					<option value="std_address"
					<?php if (($_GET['colname']) == "std_address") {
			...
			<div class="col-md-1" >
			<input type="button" class="btn btn-info" value="Reset" onclick="window.open('beneficiary_list.php','_self')" />
			</div>
            ...
            <table id="example" class="col-md-12 table-bordered " align="center">
                ...
                while($result = mysql_fetch_array($query1)) {
                    ...
                    <tr>
                        ...
                        <td data-title="Club ID"><?php echo $result['school_id']; ?></td>
