...
if (isset($_GET['from']))
	{
		...
		$row = mysql_query("Select distinct (l.EntityID),s.group_member_id,s.t_complete_name,l.school_id,l.LatestLoginTime,l.LogoutTime 
from tbl_LoginStatus l join tbl_teacher s on l.EntityID=s.id where $where and l.Entity_type='103'
...
<body>
  ...
  <div class="panel panel-default">
	...
	<div class="'col-md-2' col-md-offset-3" style="margin-left: 560px;" >
                            <a href="studTeacher_stat.php" style="text-decoration:none;">
	...
	<tbody>
     ...
     ?>
			...
			<td data-title="Sr.No."><?php echo $i; ?></td>
						...
						<td data-title="ID"><?php echo $result['EntityID']; ?></td>
