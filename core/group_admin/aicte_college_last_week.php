...
if(isset($_POST['reset'])){
  ...
  $staticfinish = date('Y-m-d',strtotime('last Sunday'));    
    ...
    $condition = "WHERE sa.group_member_id='$GroupMemId' AND aci.reg_date>= '".$staticstart."' AND aci.reg_date < '".$staticfinish."'";
    // echo $condition; exit;
            ...
            <div style="background-color:#F8F8F8; padding-top: 20px;">
                <div class="row">
                    ...
                    <div class="col-md-offset-3 col-md-6" align="center">
                        <h2 class="center">AICTE College Readiness By Registration Date For Last Week </h2>
                    </div>
