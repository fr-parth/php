...
if(isset($_POST['reset'])){
    ...
    $condition = "WHERE sa.group_member_id='$GroupMemId' AND  date_format(aci.reg_date,'%Y-%m')='".date("Y-m",strtotime('-1 Month'))."'";
            ...
            <div style="background-color:#F8F8F8; padding-top: 20px;">
                <div class="row">
                    ...
                    <div class="col-md-offset-3 col-md-6" align="center">
                        ...
                        <h2 class="center">AICTE College Info Report By Registration Date FOR <?= date("M-Y", strtotime('-1 month'));?> </h2>
                    </div>
                    ...
                    <div class="col-md-12 table-responsive">
                        ...
                        <table class="table table-bordered" id="example">
                            ...
                            <tr style="background-color:#694489;color:white">
                                ...
                                <!-- <th style="width:10%;">ERP Incharge</th>
                                <th style="width:10%;">IT Incharge</th>
                            ...
                            $arr = mysql_query($sql1);
                             ...
                             if($impliment_date=="01-01-1970"){$impliment_date="";} ?>
                                <tr style="color:#808080;" class="active">
                                    ...
                                    <!-- <td data-title="College"><?php echo $row['college_id'].'<br>'.ucwords($row['college_name']).'<br>'.$impliment_date; ?> </td> -->
                                    <!-- <td data-title="College"><?php echo $row['college_id']; ?> </td> -->
                                    ...
                                    <td data-title="College"><?php echo $impliment_date; ?> </td>
