...
$group_mnemonic_name=$group_mnumonic_code;
...
<!-- <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js"></script>-->
    ...
    <script type="text/javascript">
      ...
      if(schoolPattern=="")
        {
        alert("please select School Pattern...!");
            return false;
        }
...
if($counts > 0 || $counts1 > 0){
 ...
 //var_dump($calculated_json);die;
        ...
        if ($user_type == 1) {
            ...
            if (mysql_num_rows($row2) > 0){
                echo "<script>alert('School id already exist, please try with different id!!'); window.location.href='addschool.php'; </script>";
                ...
                {
                echo "<script>alert('AICTE Application ID  already exist, please try with different id!!'); window.location.href='addschool.php'; </script>";
                

                } 
                else if(mysql_num_rows($aids) > 0)
                {
                echo "<script>alert('AICTE Permanent ID  already exist, please try with different id!!'); window.location.href='addschool.php'; </script>";
                

                }
                
            /*Below query updated by Rutuja Jori for inserting School pattern to solve SMC-4817 on 08-09-2020*/
            $sqls = "INSERT INTO `tbl_school_admin`(name,address, scadmin_city, scadmin_gender,scadmin_country, email,  reg_date,scadmin_state,mobile,password,school_type,group_type,school_id,school_name,CountryCode,aicte_permanent_id,aicte_application_id,school_pattern,group_member_id) VALUES ('$name','$address','$city','$gender','$country', '$email','$dates','$state','$phone','$password','$school_type','$group_id','$school_id','$school_name','$country_code','$aciteid','$acite_aid','$schoolPattern','$group_member_id')";

            /*Below query updated by Kaushlya  for inserting School into intersection table to solve SMC-5285 on 11-05-2021*/
            $insert="INSERT INTO `tbl_group_school`(group_member_id,group_mnemonic_name, school_id,createdby, isenabled) VALUES ('$group_member_id','$group_name','$school_id','$name','1')";
                ...
                <div class='panel-body'>
                    <form class='form-horizontal' role='form' method="post">
                        ...
                        <div class="row form-group" id="school_id1">
                            ...
                            <div class='col-md-3'>
                                <div class='form-group internal'>
                                    <input type="text"  name="school_id" id='school_id' class='form-control' placeholder='Enter School ID' maxlength="20" value="<?php if (isset($_POST['school_id'])) {
                        ...
                        <div class="row form-group" id="sc_school_name1">
                            ...
                            <div class='col-md-3'>
                                <div class='form-group internal'>
                                    <input class='form-control ' type="text" id='sc_school_name' name="sc_school_name" placeholder='Enter School Name' maxlength="80" value="<?php if (isset($_POST['sc_school_name'])) {
                        ...
                        <div class="row form-group" id="group_id1">
                            ...
                            <div class='col-md-3'>
                                        ...
                                        <?php
                                        $grp=mysql_query("SELECT group_type FROM tbl_group_type ");
                                        while($result=mysql_fetch_array($grp)){ ?>
                                        <option value="<?php echo $result['group_type']; ?>" <?php if($_POST['group_id']==$result['group_type']){ echo "selected"; }?>><?php echo $result['group_type']; ?></option>
                                        <?php }?>
                                        </select> 
                                <!--<div  id="errorcat" style="color:#FF0000" align="center">      -->
                            </div>
                        ...
                        <div class="row form-group" id="school_type1">
                            ...
                            <div class='col-md-3'>
                                <div class='form-group internal'>
                                    <select  name="school_type" id='school_type' class='form-control'  >
                                        ...
                                        <option value="school" <?php if($_POST['school_type']=="school") echo "selected";?>>School</option>
                                        <option value="organization" <?php if($_POST['school_type']=="organization") echo "selected";?>>Organization</option>
                                        <option value="NYKS" <?php if($_POST['school_type']=="NYKS") echo "selected";?>>NYKS</option>
                            ...
                            <div class='col-md-3'>
                                <div class='form-group internal'>
                                    <select  name="schoolPattern" id='schoolPattern' class='form-control'  />
                                        ...
                                        <option value="">Select</option>
                                        <option value="Annual" <?php if($_POST['schoolPattern']=="Annual") echo "selected";?>>Annual</option>
                                        <option value="Semester" <?php if($_POST['schoolPattern']=="Semester") echo "selected";?>>Semester</option>
                            ...
                            <div class='col-md-3'>
                                <div class='form-group internal'>
                                    <input class='form-control ' id='aciteId' name="aciteId" placeholder='Enter AICTE Permanent ID' maxlength="80" value="<?php if($_POST['aciteId']!='') echo $_POST['aciteId']; else echo ""; ?>" autocomplete="off">
                        ...
                        <div class="row form-group" id="aicte_application_id">
                            ...
                            <div class='col-md-3'>
                                <div class='form-group internal'>
                                    <input class='form-control ' id='acite_aid' name="acite_aid" placeholder='Enter AICTE Application ID' maxlength="80" value="<?php if($_POST['acite_aid']!='') echo $_POST['acite_aid']; else echo ""; ?>" autocomplete="off">
   ...
   -->
                        ...
                        <div class="row form-group">
                            ...
                            <div class='col-md-3 '>
                                ...
                                <textarea class='form-control' id='id_address' name="address" placeholder='Address' rows='3' maxlength="200" value="<?php if ($_POST['address']!='') {
                                           echo $_POST['address'];
