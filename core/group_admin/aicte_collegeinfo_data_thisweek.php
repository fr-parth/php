...
if($_GET['dt']=="reg_date"){
    $datetype="date_format(aci.reg_date,'%Y-%m-%d')";
    $order="aci.reg_date";
}else{
    $datetype="aci.impliment_date";
...
if(isset($_POST['reset'])){
    ...
    $condition = "WHERE sa.group_member_id='$GroupMemId' AND ".$datetype.">= curdate() - INTERVAL DAYOFWEEK(curdate())-1 DAY AND ".$datetype."< curdate() + INTERVAL DAYOFWEEK(curdate())+6 DAY";
                    ...
                    <div class="col-md-offset-3 col-md-6" align="center">
                        <?php 
                            if($_GET['dt']=="reg_date"){
                                ...
                                $dt="Implementation Date";
                            }
                        ?>
                        <h2 class="center">AICTE College Readiness By <?= $dt;?> For This Week </h2>
                    </div>
