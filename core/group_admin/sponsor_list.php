...
$sql=mysql_query("select id,sp_company,sp_address,sp_phone,sp_email,sp_name from tbl_sponsorer order by id desc 
        
LIMIT $start_from, $webpagelimit");	

$sql1 ="select count(id),sp_company,sp_address,sp_phone,sp_email,sp_name from tbl_sponsorer order by id desc ";  
...
if($searchq !='')
	...
	{
		$query1=mysql_query("select id,sp_company,sp_address,sp_phone,sp_email,sp_name from tbl_sponsorer 
  
  where 
           sp_name LIKE '%$searchq%' or 
		   sp_address LIKE '%$searchq%'  or 
		   sp_company LIKE '%$searchq%'or 
		   sp_email LIKE '%$searchq%'or 
	       sp_phone LIKE '%$searchq%'
			...
			$sql1 ="select count(id),sp_company,sp_address,sp_phone,sp_email,sp_name from tbl_sponsorer 
  where 
             sp_name LIKE '%$searchq%' or 
		   sp_address LIKE '%$searchq%'  or 
		   sp_company LIKE '%$searchq%'or 
	       ...
	       sp_phone LIKE '%$searchq%'
			...
			$query1=mysql_query("select id,sp_company,sp_address,sp_phone,sp_email,sp_name from tbl_sponsorer 
  where 
     '$colname' LIKE '%$searchq%' order by id desc LIMIT $start_from, $webpagelimit") 
		or die("could not Search!");
					//echo $query1;
...
<div align="center">
    <div class="container" style="width:100%;">
        <div style="padding-top:50px;">
            ...
            <h2 style="padding-left:25px; margin-top:2px;color:#666"> Registered Sponsors</h2>
