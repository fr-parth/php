...
if (isset($_POST['submit'])) {
    ...
    if ($ExtDegreeID != '' && $course_level != '' && $Degree_code != ''&& $Degee_name != '' ) {
        ...
        $sql = mysql_query("SELECT group_member_id,Degee_name FROM `tbl_degree_master` WHERE `group_member_id`='$group_member_id' and `Degee_name`='$Degee_name' ");
        $row = mysql_fetch_row($sql);
        if ($row != '') {
            $errorreport = "This $dynamic_degree is already present ";
        } else {
            if(mysql_query("insert into `tbl_degree_master`(ExtDegreeID,Degee_name,Degree_code,course_level,group_member_id) values('$ExtDegreeID','$Degee_name','$Degree_code','$course_level','$group_member_id')")){
               // $report=" Degree  successfully inserted";
               echo "<script LANGUAGE='JavaScript'>
                    alert('$dynamic_degree successfully inserted');
                    window.location.href='list_group_degree.php';
                    </script>";
            }else{
    ...
    <form method="post">
        ...
        <div style="background-color:#F8F8F8 ;">
            ...
            <div class="row" style="padding-top:30px;">
                ...
                <div class="col-md-3">
                    <select name="course_level" id="course_level" class="form-control" required>
                        ...
                        <?php
                        $sql = "SELECT * FROM `tbl_CourseLevel` WHERE `group_member_id`='$group_member_id'";
            ...
            <div class="row" style="padding-top:60px;">
                ...
                <div class="col-md-1"><a href="list_group_degree.php"><input type="button" value="Back" class="btn btn-danger"></a></div>
            </div>
...
if (isset($_GET["degree_id"])) {
    ...
    $sql1 = "select * from tbl_degree_master where id='$degree_id' and group_member_id='$group_member_id' ";
...
{
$sql1 = mysql_query("SELECT group_member_id,Degee_name,Degree_code FROM `tbl_degree_master` WHERE `group_member_id`='$group_member_id' and  Degee_name='$DegreeName'");
$count=mysql_num_rows($sql1);

$sql2 = mysql_query("SELECT group_member_id,Degee_name,Degree_code FROM `tbl_degree_master` WHERE `group_member_id`='$group_member_id' and  Degree_code='$DegreeCode'");
...
$r = mysql_query("SELECT group_member_id,Degee_name FROM `tbl_degree_master` WHERE `group_member_id='$group_member_id' and Degree_code='$DegreeCode'");
