...
/*Author: Pranali Dalvi
  Date: 27/11/2020
  This file is created for downloading teacher subject data in excel 
*/
$report="";
...
$year= $_POST['year'];
$sch_name=mysql_query("select school_name,group_admin_id from tbl_school_admin where school_id='$college' ");
...
$qr="select * from tbl_teacher_subject_master where school_id='$college' $cond";
$rs_result=mysql_query($qr);
$num = mysql_num_rows($rs_result);
?>
<div align="center"><?php echo "<h2>". $school_name. "</h2>"; ?> <br>
        <?php echo "<h2>". $num ." Teacher Subject Data Downloaded Successfully"; ?><br><br>
        <?php echo "<a href='teacher_subject_data_report.php' class='btn btn-warning'>Back</a>". "</h2>";?> </div> 
...
<?php
 ...
 unset($_SESSION['report_header']);
  unset($_SESSION['report_values']);
    ...
    $_SESSION['report_header']=array("Sr.No.","Subject Code","Subject Name","Group Member ID","School ID","School Name","Academic Year","Teacher Member ID","Teacher Employee ID","Branch","Department","Division","Course Level","Semester","Uploaded By","Uploaded Date");
  $j1=0;
  ...
  $_SESSION['report_values'][$j][3]=$sch_name1['group_admin_id'];
  ...
  $_SESSION['report_values'][$j][7]=$row7['Teacher_Member_Id'];
  $_SESSION['report_values'][$j][8]=$row7['teacher_id'];
  $_SESSION['report_values'][$j][9]=$row7['Branches_id'];
  $_SESSION['report_values'][$j][10]=$row7['Department_id'];
  $_SESSION['report_values'][$j][11]=$row7['Division_id'];
  $_SESSION['report_values'][$j][12]=$row7['CourseLevel'];
  $_SESSION['report_values'][$j][13]=$row7['Semester_id'];
  ...
  $_SESSION['report_values'][$j][15]=$row7['upload_date'];
      ...
      echo ("<script LANGUAGE='JavaScript'>
					...
					window.location.href='Export_report.php?fn=teacher_subject_data';
                   ...
                   <form method="post">
                    ...
                    <div class="row">
              			 ...
              			 <div class="col-md-12 " align="center" style="color:#663399;" >
                   				...
                   				<h2>Download Teacher Subject Data</h2>
               			 </div>
