...
if(isset($_POST['submit']))
{
	  ...
	  $count=$_POST['count'];
				...
				for($i=0;$i<$count;$i++)
				          {
							  $activity=$_POST[$i];
							  $results=mysql_query("select * from tbl_thanqyoupointslist where school_id='0' and group_member_id='$group_member_id' and t_list like '$activity'");
							  //check already class exist or not
								 if(mysql_num_rows($results)==0 && $activity!="")
									{
										$query="insert into tbl_thanqyoupointslist(t_list,school_id,group_member_id) values('$activity','0','$group_member_id') ";
							 ...
							 if( $last_index1>0)
							   {
								   $last_index1;
									...
									alert('thank you reason added successfully');
									window.location.href='thanqyou.php';
									</script>");
									 $activity_list="";
               ...
               <div class="col-md-3" id="E-0" style="color:#FF0000;">
                ...
                <div id="add">
                  ...
                  <div class="col-md-2 col-md-offset-2 "  >
                    ...
                    <a href="thanqyou.php" style="text-decoration:none;"><input type="button" class="btn btn-danger" name="Back" value="Back" style="width:80px;font-weight:bold;font-size:14px;" /></a>
                    </div>
                    ...
                    <div class="col-md-3" style="color:green;" align="left">
