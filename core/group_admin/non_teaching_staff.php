...
//$s="SELECT t_name,t_complete_name,t_middlename,t_lastname,school_id,t_current_school_name,t_email,t_phone,t_address from tbl_teacher where group_member_id = '$group_member_id' order by school_id";

$sql=mysql_query("SELECT t_id,t_name,t_complete_name,t_middlename,t_lastname,school_id,t_current_school_name,t_email,t_phone,t_address from tbl_teacher where group_member_id = '$group_member_id' AND t_emp_type_pid NOT IN (133,134) order by school_id LIMIT $start_from, $webpagelimit");
...
$sql1 ="select COUNT(id) from tbl_teacher where group_member_id = '$group_member_id' AND t_emp_type_pid NOT IN (133,134) order by school_id";  
...
$colname=$_GET['colname'];
	if ($colname !=''and $colname != 'Select')
	{
		...
		t_name,t_complete_name,t_middlename,t_lastname,school_id,t_current_school_name,t_email,t_phone,t_address from tbl_teacher where group_member_id = '$group_member_id' AND t_emp_type_pid NOT IN (133,134) AND $colname LIKE '%$searchq%' order by school_id LIMIT $start_from, $webpagelimit") or die("could not Search!");
					
		$sql1 ="select COUNT(id) from tbl_teacher where group_member_id = '$group_member_id' AND t_emp_type_pid NOT IN (133,134) AND $colname LIKE '%$searchq%' order by school_id "; 
					$rs_result = mysql_query($sql1);  
					$row1 = mysql_fetch_row($rs_result);  
					$total_records = $row1[0];  
					$total_pages = ceil($total_records / $webpagelimit);
			...
			$query1=mysql_query("SELECT t_id,t_name,t_complete_name,t_middlename,t_lastname,school_id,t_current_school_name,t_email,t_phone,t_address from tbl_teacher where group_member_id = '$group_member_id' AND t_emp_type_pid NOT IN (133,134) AND (t_name LIKE '$searchq%' or t_complete_name LIKE '%$searchq%' or t_middlename LIKE '$searchq%' or t_lastname LIKE '$searchq%' or school_id LIKE '$searchq%' or t_current_school_name LIKE '%$searchq%' or t_email LIKE '$searchq%' or t_phone LIKE '$searchq%'or t_address LIKE '%$searchq%')order by school_id LIMIT $start_from, $webpagelimit") or die("could not Search!");
			
			$sql1 ="select COUNT(id) from tbl_teacher where group_member_id = '$group_member_id' AND t_emp_type_pid NOT IN (133,134) AND (t_name LIKE '$searchq%' or t_complete_name LIKE '%$searchq%' or t_middlename LIKE '$searchq%' or t_lastname LIKE '$searchq%' or school_id LIKE '$searchq%' or t_current_school_name LIKE '%$searchq%' or t_email LIKE '$searchq%' or t_phone LIKE '$searchq%'or t_address LIKE '%$searchq%')order by school_id "; 
...
<head>
    ...
    <title>Non Teaching Staff List</title>
...
<script type="text/javascript">
    $(function () {
        ...
        window.pagObj = $('#pagination').twbsPagination({
			...
			window.location.assign('volunteer_list.php?page='+page);
        });
    });
</script>
<?php }else{
...
<script type="text/javascript">
    $(function () {
        ...
        window.pagObj = $('#pagination').twbsPagination({
            ...
            console.info(page + '(from event listening)');
			window.location.assign('volunteer_list.php?colname=<?php echo $colname;?>&Search=<?php echo $searchq; ?>&spage='+page);
        });
    });
</script>
<?php }?>
...
<div class="container" style="width:100%;">
    <div class="row" style="padding-top:10px;height:30px;" align="center">
        <h2 style="margin-top:2px;color:#666"> List of Non Teaching Staff<?php //echo $dynamic_teacher;?></h2>
    </div>
		...
		<form style="margin-top:25px;">
			...
			<div class="col-md-1" >
			<input type="button" class="btn btn-info" value="Reset" onclick="window.open('volunteer_list.php','_self')" />
			</div>
		...
		{
			//$searchq=$_GET['Search'];
			//$q1="SELECT t_name,t_complete_name,t_middlename,t_lastname,school_id,t_current_school_name,t_email,t_phone,t_address from tbl_teacher where group_member_id = '$group_member_id' AND (t_name LIKE '$searchq%' or t_complete_name LIKE '$searchq%' or t_middlename LIKE '$searchq%' or t_lastname LIKE '%$searchq%' or school_id LIKE '$searchq%' or t_current_school_name LIKE '%$searchq%' or t_email LIKE '$searchq%' or t_phone LIKE '$searchq%'or t_address LIKE '$searchq%')order by school_id";

			//$query1=mysql_query("SELECT t_name,t_complete_name,t_middlename,t_lastname,school_id,t_current_school_name,t_email,t_phone,t_address from tbl_teacher where group_member_id = '$group_member_id' AND (t_name LIKE '$searchq%' or t_complete_name LIKE '%$searchq%' or t_middlename LIKE '$searchq%' or t_lastname LIKE '$searchq%' or school_id LIKE '$searchq%' or t_current_school_name LIKE '%$searchq%' or t_email LIKE '$searchq%' or t_phone LIKE '$searchq%'or t_address LIKE '%$searchq%')order by school_id") or die("could not Search!");
