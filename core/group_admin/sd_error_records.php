	...
	if($_GET['pro']=="dwnld"){		
		...
		$batchid = $_GET['batch_id'];
			...
			$data['display_table_name']='Teacher';
				...
				$data['fields']='t_complete_name, t_phone, t_email, t_school_name, t_school_id, t_id, t_emp_type_pid';

				$data['display_fields']='Teacher Name,Mobile,Email,School Name En,SchoolCode,TeacherId,EmployeeType';
			...
			while($er=@mysql_fetch_array($qd)){	
					...
					$t_id1 = trim($er['t_id']);
					$t_emp_type_pid1 = trim($er['t_emp_type_pid']);
		...
		$queryreject55 = "select * from tbl_school_admin where school_id='$t_school_id1'";
			...
			$mainschool55 = $rowquery55['school_id'];
					...
					if($t_complete_name1 == ''){
						...
						$t_complete_name = 'Teacher_Name_Not_Found';
					...
					if($t_school_name1 == ''){
						...
						$t_school_name = 'School_Name_Not_Found';
					...
					if($t_school_id1 == ''){
						...
						$t_school_id = 'School_id_Not_Found';
						$errmsg .= $t_school_id." , ";
					}else if ($t_school_id1 != $mainschool55){
						$t_school_id2 = $t_school_id1;
						$t_school_id = 'School_id_Not_Correct , ';
						$errmsg .= $t_school_id;
					}
					else{
						$t_school_id2 = $t_school_id1;
					...
					if($t_id1 == ''){
						$t_id2 = $t_id1;
						$t_id = 'Teacher_Id_Not_Found';
						$errmsg .= $t_id." , ";
					}else{
						$t_id2 = $t_id1;
					}
					if($t_emp_type_pid1 == ''){
						$t_emp_type_pid2 = $t_emp_type_pid1;
						$t_emp_type_pid = 'Employee_Type_Id_Not_Found';
						$errmsg .= $t_emp_type_pid." , ";
					}else{
						$t_emp_type_pid2 = $t_emp_type_pid1;
					}
					...
					echo "<td>$t_phone2</td>";
					echo "<td>$t_email2</td>";
					echo "<td>$t_school_name2</td>";
					echo "<td>$t_school_id2</td>";
					echo "<td>$t_id2</td>";
					echo "<td>$t_emp_type_pid2</td>";
