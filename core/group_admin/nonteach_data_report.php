...
$qr="select * from tbl_teacher where school_id='$college' AND t_emp_type_pid NOT IN (133,134) $cond";
...
?> <div align="center"> <?php if($j1>0){ echo "<h2>".$college_name."</h2><h3>".$j1." Non Teaching Downloaded Successfully"; ?>&nbsp;&nbsp;&nbsp;&nbsp; <?php echo "<a href='nonteach_data_report.php'>Back</a></h3>"; }else{echo "<h2>".$college_name."</h2><h3>Non Teaching data not found"; ?>&nbsp;&nbsp;&nbsp;&nbsp; <?php echo "<a href='nonteach_data_report.php'>Back</a></h3>";} ?> </div> <?php 

echo ("<script LANGUAGE='JavaScript'>		
					window.location.href='Export_report.php?fn=".$college."_nonteacher';
					</script>");
}
?>
                   ...
                   <form method="post">
                    ...
                    <div class="row">
              			 ...
              			 <div class="col-md-12 " align="center" style="color:#663399;" >
                   				...
                   				<h2>Download Non-Teaching Staff Data</h2>
               			 </div>
...
<select name="year" id="year" class="smartsearch form-control" required />
            ...
            <?php //$row=mysql_query("select t_academic_year from tbl_teacher where school_id='".$value['school_id']."' AND t_emp_type_pid NOT IN (133,134) group by t_academic_year");
			//while($value=mysql_fetch_array($row)){?>
