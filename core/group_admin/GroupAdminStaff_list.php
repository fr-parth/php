            ...
            <div style="background-color:#F8F8F8 ;">
                <div class="row">
                    <div class="col-md-3 " style="color:#700000 ;padding:5px;">&nbsp;&nbsp;&nbsp;&nbsp;
                        <a href="group_Admin_Staff_setup.php"><input type="submit" class="btn btn-primary"
                ...
                <div class="row" style="padding:10px;">
                    ...
                    <div class="col-md-12  " id="no-more-tables">
                        ...
                        <table class="table-bordered  table-condensed cf" id="example" width="100%;">
                            ...
                            //Updated by Rutuja for adding group_member_id for SMC-4565 on 27/02/2020
                            $arr = mysql_query("select * from tbl_cookie_adminstaff where group_member_id='$GroupMemId' order by id"); ?>
                            ...
                            <?php while ($row = mysql_fetch_array($arr)) {
                                ...
                                <tr style="color:#808080;" class="active">
                                    ...
                                    <td data-title="Phone" style="width:10%;">
										...
										<td><a href="group_Admin_Staff_setup.php?staff=<?= $cookieAdmin_id; ?>"
