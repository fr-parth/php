...
if($_GET['year'] and $year !='ALL' and $year!='')
	...
	SELECT distinct t.t_id,t.t_complete_name,t.t_dept ,t.school_id,t.t_academic_year
	  ...
	  and t.t_emp_type_pid in (133,134,135,137) and t.t_id not IN
	   (select sf.tID
...
<script type="text/javascript">
    $(function () {
      ...
      <?php if($_GET['year']){ ?>
         window.location.assign('society360_notGiven.php?sc_id=<?php echo $sc_id;?>&year=<?php echo $year;?>&group_name=<?php echo $group_name;?>&page='+page);
      <?php } else {?>
        window.location.assign('society360_notGiven.php?sc_id=<?php echo $sc_id;?>&page='+page);
      <?php } ?>
        });
    });
</script>
...
<script type="text/javascript">
    $(function () {
        ...
        window.pagObj = $('#pagination').twbsPagination({
            ...
            console.info(page + '(from event listening)');
      <?php if($_GET['year']){ ?>
				 window.location.assign('society360_notGiven.php?sc_id=<?php echo $sc_id;?>&year=<?php echo $year;?>&group_name=<?php echo $group_name;?>&Search=<?php echo $searchq; ?>&spage='+page);
			<?php } else {?>
				window.location.assign('society360_notGiven.php?sc_id=<?php echo $sc_id;?>&Search=<?php echo $searchq; ?>&spage='+page);
			<?php } ?>
        });
    });
</script>
...
<div align="center">
    <div class="container" style="width:100%;">
        <div style="padding-top:30px;">
            ...
            <h2 style="padding-left:20px; margin-top:2px;color:#666"> Society Activity-Not Given</h2>
     ...
     <?php } ?>
			...
			<div class="col-md-1" >
			<input type="button" class="btn btn-info" value="Reset" onclick="window.open('society360_notGiven.php?sc_id=<?php echo $_GET['sc_id']; ?>&year=<?php echo $_GET['year'];?>&group_name=<?php echo $group_name;?>','_self')" />
			</div>
				</form>
						 </div>
  					<form method="post" class="pull-left" action="society_not_given_school.php?year=<?php echo $year?>&group_name=<?php echo $group_name;?>">
