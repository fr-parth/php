...
$qr="select * from tbl_degree_master where school_id='$college'";

$rs_result=mysql_query($qr);
 unset($_SESSION['report_header']);
  unset($_SESSION['report_values']);

    $_SESSION['report_header']=array("Sr.No.","Member ID","Degree ID","Degree Name","Degree Code","Course Level","School ID");
  $j1=0;
  ...
  $_SESSION['report_values'][$j][2]=$row7['ExtDegreeID'];
  $_SESSION['report_values'][$j][3]=$row7['Degee_name'];
  $_SESSION['report_values'][$j][4]=$row7['Degree_code'];
  $_SESSION['report_values'][$j][5]=$row7['course_level'];
  $_SESSION['report_values'][$j][6]=$row7['school_id'];
     } ?><div align="center"> <?php if($j1>0){ echo "<h2>".$college_name."</h2><h3>".$j1." Degree Downloaded Successfully"; ?>&nbsp;&nbsp;&nbsp;&nbsp; <?php echo "<a href='degree_data_report.php'>Back</a></h3>"; }else{echo "<h2>".$college_name."</h2><h3>Degree data not found"; ?>&nbsp;&nbsp;&nbsp;&nbsp; <?php echo "<a href='degree_data_report.php'>Back</a></h3>";} ?> </div> </div> <?php 

echo ("<script LANGUAGE='JavaScript'>
				
					window.location.href='Export_report.php?fn=".$college."_degree';
