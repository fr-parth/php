...
$fr_date = date("d-m-Y H:i",mktime(00,00));//hour, minute, second
 $to_date = date("d-m-Y H:i",mktime(23,59));//hour, minute, second
  ...
  // print_r($_POST); exit;
    ...
    $student_sql = "SELECT count(distinct(ls.EntityID)) as cnt, ls.school_id, sa.school_name FROM tbl_LoginStatus as ls JOIN tbl_student as s ON ls.EntityID=s.id and ls.school_id=s.school_id JOIN tbl_school_admin as sa ON ls.school_id=sa.school_id where
 $where AND Entity_type='105' group by ls.school_id order by sa.school_name";
...
<div class="container">
  ...
  <div class="row" style="padding-top:10px;">
    ...
    <br>
    <form method="post" class="detail_color" style="cursor: pointer;" action="login_logout_stats.php">
    ...
    <div class="col-md-12">
      <table class="table-bordered  table-condensed cf" id="example" width="100%;">
                                ...
                                <?php
                                    ...
                                    ?>
                                    <form method="post" class="detail_color" style="cursor: pointer;" action="Login_logout_school_student.php">
