...
if(isset($_POST['reset'])){
    ...
    $condition = "WHERE sa.group_member_id='$GroupMemId' AND  date_format(aci.impliment_date,'%Y-%m')='".date("Y-m",strtotime('+1 Month'))."'";
            ...
            <div style="background-color:#F8F8F8; padding-top: 20px;">
                <div class="row">
                    ...
                    <div class="col-md-offset-3 col-md-6" align="center">
                        ...
                        <h2 class="center">AICTE College Readiness By Implementation Date FOR <?= date("M-Y", strtotime('+1 month'));?> </h2>
                    </div>
