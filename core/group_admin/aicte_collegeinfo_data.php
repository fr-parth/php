                    ...
                    <div class="col-md-12 table-responsive">
                        ...
                        <table class="table table-bordered" id="example">
                            ...
                            <tr style="background-color:#694489;color:white">
                                ...
                                <th style="width:10%;">College ID / Name </th>
                                <th style="width:5%;">Implementation Date</th>
                                <th style="width:8%;">Informer Detail</th>

								<!--Camel casing done for Designation by Pranali-->

                                <th style="width:8%;">ERP Incharge</th>
                                <th style="width:8%;">IT Incharge</th>
                                <th style="width:8%;">AICTE Coordinator</th>
                                <th style="width:8%;">TPO</th>
                                <th style="width:8%;">Art Circle Incharge</th>
                                <th style="width:8%;">Student Affair Incharge</th>
                                <th style="width:8%;">Admin Incharge</th>
                                <th style="width:8%;">Exam Incharge</th>
                                
                                <th style="width:8%;">Placement Help</th>
                            ...
                            $arr = mysql_query($sql1);
                             ...
                             if($impliment_date=="01-01-1970"){$impliment_date="";} ?>
                                <tr style="color:#333;" class="active">
                                    ...
                                    <td data-title="Exam Incharge"><?php echo $row['placement_help'].'<br>'.ucwords($row['placement_incharge_nm']).'<br>'.$row['placement_incharge_mob'].'<br>'.$row['placement_incharge_email']; ?> </td>
