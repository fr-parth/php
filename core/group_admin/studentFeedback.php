...
<script type="text/javascript">
    $(function () {
        ...
        window.pagObj = $('#pagination').twbsPagination({
           ...
           <?php if($_GET['year']){ ?>
              window.location.assign('studentFeedback.php?sc_id=<?php echo $sc_id;?>&year=<?php echo $year;?>&group_name=<?php echo $group_name;?>&page='+page);
           <?php } else {?>
			        window.location.assign('studentFeedback.php?sc_id=<?php echo $sc_id;?>&page='+page);
           <?php } ?>
        });
    });
</script>
...
<script type="text/javascript">
    $(function () {
        ...
        window.pagObj = $('#pagination').twbsPagination({
            ...
            console.info(page + '(from event listening)');
      <?php if($_GET['year']){ ?>
         window.location.assign('studentFeedback.php?sc_id=<?php echo $sc_id;?>&year=<?php echo $year;?>&group_name=<?php echo $group_name;?>&Search=<?php echo $searchq; ?>&spage='+page);
      <?php } else {?>
        window.location.assign('studentFeedback.php?sc_id=<?php echo $sc_id;?>&Search=<?php echo $searchq; ?>&spage='+page);
      <?php } ?>
        });
    });
</script>
...
<div align="center">
    <div class="container" style="width:100%;">
        ...
        <input type="hidden" name="sc_id" value="<?php echo $_GET['sc_id']; ?>"> </input>
       <?php if($_GET['year']){ ?>
         <input type="hidden" name="year" value="<?php echo $_GET['year']; ?>"> </input>
      ...
      <?php } ?>
			...
			<div class="col-md-1" >
			<input type="button" class="btn btn-info" value="Reset" onclick="window.open('studentFeedback.php?sc_id=<?php echo $_GET['sc_id']; ?>&year=<?php echo $_GET['year'] ;?>&group_name=<?php echo $group_name;?>','_self')" />
			</div>
			    </form>
		</div>
					<!-- <div style="margin-left: 800px;">
  					...
  					<form method="post" class="pull-left" action="school_list.php?year=<?php echo $year?>&group_name=<?php echo $group_name;?>">
      ...
      <button class="btn btn-info" type="submit"><i class="glyphicon glyphicon-chevron-left"></i>Back to  School List</button>
		...
		if (isset($_GET['Search']))
		{
            ...
            */
						echo $result['stu_feed_academic_year'];?></td>
