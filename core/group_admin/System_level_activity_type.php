...
<div class="container" style="padding:25px;">
    ...
    <div class="col-md-8 "  align="left">
               ...
               <a href="addsystemlevel_activity_type.php"><input type="button" class="btn btn-primary" name="Add" value="Add Activity" style="background-color:"></a>
                 </div>
...
<!-- align='center' removed for proper alignment for bug SMC-4428 by Pranali on 15-1-20 -->
                     <?php  $sql="select activity_type from  tbl_activity_type where school_id='0' and group_member_id='$group_member_id' ORDER BY  id DESC";
                    ...
                    $i=0;
                        ...
                        <tr>
                            ...
                            <td data-title="Activity" width="45%"><?php echo ucwords($row1['activity_type']);?></td>
                            <td data-title="Edit" width="10%"> <a href="edit_system_activity_type.php?activity=<?php echo $row1['id'];  ?>"   style="text-decoration:none"><span class="glyphicon glyphicon-pencil"></span> </a></td>
