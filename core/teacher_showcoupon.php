<?php 
 ...
 //get table record id
 $id= xss_clean(mysql_real_escape_string($_GET['id']));
 ...
 <div class="col-md-1">
   ...
   <div class="col-md-2">    
      ...
      $sql1= "SELECT ac.id,ac.sponsored_id ,sp.sp_name,ac.product_name FROM tbl_accept_coupon ac join tbl_sponsorer sp on sp.id=ac.sponsored_id where coupon_id=$cp_code ORDER BY id DESC LIMIT 1";
                           ...
                           ?>
                                     <a href="https://twitter.com/share" class="twitter-share-button" data-url="<?php echo $GLOBALS['URLNAME'];?>" data-text="I have used my Smart Cookie Coupon to get  <?php  echo xecho($record1['product_name']);?>   at <?php  echo xecho($record1['sp_name']);?> "  data-hashtags="smartcookieprogram" >Tweet</a>
             <?php }?>
              <?php  if($row['status']=='yes'){
                           ...
                           ?>
                                     <a href="https://twitter.com/share" class="twitter-share-button" data-url="<?php echo $GLOBALS['URLNAME'];?>" data-text="I have converted my Smart Cookie points into a rewards Coupon worth <?php echo xecho($record7['amount']);?> points. " data-size="" data-hashtags="smartcookieprogram" style="margin-top:5px;">Tweet</a>
             <?php }?>
</div>
</div>
</div>
...
<div class="col-md-8">
    ...
    <div class="row">
                        ...
                        <h1 style="font-size:18px; color:#333333;font-family:Verdana, Arial, Helvetica, sans-serif;"  >
                            ...
                            <?php echo xecho(ucwords($name));?>
                           
                            </div>
                            <div class="row" style="font-size:15px;">
                           
                 				<?php echo xecho($school_name);?>
...
<div class="row" style="">
                ...
                Coupon # :</div>
                 <div class="col-md-3" align="center">
                   <p><?php echo xecho($cp_code);?></p>
                   <p>&nbsp;</p>
                 </div> 
        </div>
                
                  <div class="row" style="padding-top:10px;">
                          <div class="col-md-4 col-md-offset-4" style="font-size:42px;font-weight:bold;" ><?php echo xecho($cp_point);?>
                            <p>&nbsp;</p>
                          </div>
        </div>
                          <div class="row">
              <div class="col-md-4 col-md-offset-4" style="font-size:18px;font-style:italic;">Points
			   ...
			   <br>
                ...
                echo '<img src='.$dir.$qrfile.' style="margin-left:60px;"/>'; ?>
               </div> 
                </div>
              </div>
           </div>
