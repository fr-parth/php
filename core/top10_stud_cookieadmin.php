<?php
error_reporting(0);
//include('conn.php'); This call function is already call in cookieadminheader.php
...
<select name="limit1" class="dropdownMenu1" id="dropdownMenu1" style="width:85%; height:30px; border-radius:2px;margin-left:50px;margin-top:20px;margin-bottom:20px;" onChange="onSchoolChange()">
   ...
   <?php $sql1=mysql_query("Select id,school_name,school_mnemonic from tbl_school  where `school_mnemonic`!='' order by `school_name` ASC");?>
