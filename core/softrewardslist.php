...
function myFunction()
{
 //alert('myfunction call sucussfully');
	 ...
	 document.getElementById("demo1").innerHTML = "<a href='softrewardslist.php'><input type='button' class='btn btn-danger' name='Cancel' value='Back' />";
    	...
    	<div class="panel-body">
        	<h5 class="panel-title">
				...
				<select name="user" id="user" onchange="showbranchwise(this.value)">
					...
					<?php 
						$sql=mysql_query("select distinct user from softreward order by user");
...
<div class="col-md-6">
	<div class="panel panel-default">
		...
		<div class="row">
			...
			<div class="row">
<input type="text" class="form-control" name="discount" id="discount" placeholder="Reward Name" onblur="valid_discount()"/>
			</div>
            ...
            <div class="row">
				<input type="text" class="form-control" name="UserName" id="UserName" placeholder="User Name" onblur="valid_points_per_discount()" value="" list="cityname" required pattern="[\S\s]*\S[\S\s]*"/>
				<datalist id="cityname"   onchange="showbranchwise(this.value)">
					<?php 
						$sql=mysql_query("select distinct user from softreward order by user");
					   while($row=mysql_fetch_array($sql))
					   {
			...
			<div class="row" >
                <div id="demo" class="col-md-4"><input type="submit" class="btn btn-primary" name="submit_discount" id="dome" value="Submit" onclick="" /></div>
...
<div class="panel panel-default">
		<div class="panel-heading">
			<h2 class="panel-title"><b>Student</b> 	</h2>
		</div>
		<div class="panel-body">
		<!--<div class="row">
			<div class="col-md-12">			
        ...
        <hr />
			...
			<div class="col-md-12">
				...
				<table class="table" id="dTable">
					<thead>
						<tr><th>Sr.No.</th><th>Name</th><th>SoftRewards</th><th>Points</th><th>Edit</th><th>Delete</th></tr>
					</thead>
					<tbody>
						<?php
                            $i=0;
						...
						<td><?php echo ucwords($rewardtype); // reward name?></td>
	...
	<a onclick="edit_discount('<?php echo $softid; ?>','<?php echo $rewardtype; ?>','<?php echo $star; ?>','<?php echo $user; ?>','<?php echo $imagespath; ?>');myFunction()">
						...
						<td><a href="delete_soft.php?softid=<?php echo $softid;?>"><img src="http://purlinbrackets.com.au/Prod/Order/prod_img/delete.png" alt="delete" width="20" height="20"></a>										
							</td>	
						<!--
