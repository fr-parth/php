...
if (!($_GET['Search'])){
	...
	$sql=mysql_query("SELECT * FROM tbl_teacher where t_phone ='' AND school_id = '$school_id' LIMIT $start_from, $webpagelimit") or die("Could not Search!");

	$sql1 =mysql_query("SELECT * FROM tbl_teacher where t_phone ='' AND school_id = '$school_id'");
...
else
{
	...
	//$colname=mysql_real_escape_string($_GET['colname']);
			...
			$sql = mysql_query("SELECT * FROM tbl_teacher where t_phone ='' AND school_id = '$school_id'  AND (t_complete_name LIKE '%$searchq%' or id LIKE '%$searchq%' or school_id LIKE '%$searchq%') LIMIT $start_from, $webpagelimit") or die("Could not Search!");
							
			$sql1 = mysql_query("SELECT * FROM tbl_teacher where t_phone ='' AND school_id = '$school_id'  AND (t_complete_name LIKE '%$searchq%' or id LIKE '%$searchq%' or school_id LIKE '%$searchq%')");
...
<script type="text/javascript">
    $(function () {
        ...
        window.pagObj = $('#pagination').twbsPagination({
			...
			window.location.assign('sc_analytics_details_teachers_without_phone.php?page='+page);
        });
    });
</script>
<?php }else{
...
<script type="text/javascript">
    $(function () {
        ...
        window.pagObj = $('#pagination').twbsPagination({
            ...
            console.info(page + '(from event listening)');
			window.location.assign('sc_analytics_details_teachers_without_phone.php?colname=<?php echo $colname;?>&Search=<?php echo $searchq; ?>&spage='+page);
        });
    });
</script>
<?php }?>
...
<div align="center">
    <div class="container" style="width:100%;">
        <div style="padding-top:30px;">
            ...
            <h2 style="padding-left:20px; margin-top:2px;color:#666"> <?php echo $dynamic_teacher;?> Without Phone Number</h2>
		...
		<form style="margin-top:5px;">
			...
			<div class="col-md-1" >
			<input type="button" class="btn btn-info" value="Reset" onclick="window.open('sc_analytics_details_teachers_without_phone.php','_self')" />
			</div>
			<div class="col-md-1" >
...
<div class="container">
	<div class="panel panel-default">
		<div class="panel-heading" align='center'><h3> <?php echo $dynamic_teacher;?> Without Phone Number</h3></div>
