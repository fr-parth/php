  ...
  <div class='container'>
   ...
   <div style="color:red;font-size:15px;font-weight:bold;margin-top:10px;"> <?php if(isset($_GET['report'])){ echo $_GET['report']; };?></div>
    ...
    <input class='form-control col-md-8' style="width:21.7%;margin-left:15px;" value="<?=$des?>" id='Designation' name="Designation" placeholder='Designation' type='text'>
          ...
          <div class='form-group'>
            <label class='control-label col-md-4'>Experience
			 (in Months)<b style="color:red";>*</b></label>
            
              <div class='col-md-3'>
               
                  <input class='form-control ' value="<?=$exp?>" id='experience' name='experience'  type='number'>
             
             
             
                </div>
                
                <div class='col-md-15' id="errorexperience" style="color:#FF0000;"></div>
              </div>
              ...
              <td><ul style="list-style-type:none; border-left:dotted; margin-left: -41px;"></ul>
               ...
               <td>
                 ...
                 <?php $Teacher="Teacher1";
						  ...
						  if($Tch !== false)
						  {?>
<li><input type="checkbox" class="name" name="permission[]" checked id="td" value="Teacher1"> <?php echo $dynamic_teacher;?>&nbsp;</li>
<?php }else{?>
<li><input type="checkbox" class="name" name="permission[]" id="td" value="Teacher1"> <?php echo $dynamic_teacher;?>&nbsp;</li>
<?php } ?>
...
<?php $Student="Student1";
						  ...
						  if($St !== false)
						  {?>
<li><input type="checkbox" class="name" name="permission[]" checked id="td" value="Student1"> <?php echo $dynamic_student;?>&nbsp;</li>
<?php }else{?>
<li><input type="checkbox" class="name" name="permission[]" id="td" value="Student1"> <?php echo $dynamic_student;?>&nbsp;</li>
<?php } ?>
...
<?php }else{?>
<li><input type="checkbox" class="name" name="permission[]" id="td" value="Semester"> Semester&nbsp;</li>
<?php } ?>
...
<?php $StuSem="StuSem";
						  ...
						  if($St !== false)
						  {?>
<li><input type="checkbox" class="name" name="permission[]" checked id="td" value="StuSem"> <?php echo $dynamic_student;?> Semester&nbsp;</li>
<?php }else{?>
<li><input type="checkbox" class="name" name="permission[]" id="td" value="StuSem"> <?php echo $dynamic_student;?> Semester&nbsp;</li>
<?php } ?>
...
<?php $TSub="TSub";
						  ...
						  if($St !== false)
						  {?>
<li><input type="checkbox" class="name" name="permission[]" checked id="td" value="TSub"> <?php echo $dynamic_teacher."$dynamic_subject";?>&nbsp;</li>
<?php }else{?>
<li><input type="checkbox" class="name" name="permission[]" id="td" value="TSub"> <?php echo $dynamic_teacher."$dynamic_subject";?>&nbsp;</li>
<?php } ?>
...
<?php $SSub="SSub";
						  ...
						  if($St !== false)
						  {?>
<li><input type="checkbox" class="name" name="permission[]" checked id="td" value="SSub"> <?php echo $dynamic_student."$dynamic_subject";?> &n</li>
<?php }else{?>
<li><input type="checkbox" class="name" name="permission[]" id="td" value="SSub"> <?php echo $dynamic_student."$dynamic_subject";?> &nbsp;</li>
<?php } ?>
...
<?php $CSub="CSub";
						  ...
						  if($St !== false)
						  {?>
<li><input type="checkbox" class="name" name="permission[]" checked id="td" value="CSub"> Class <


    >&nbsp;</li>
<?php }else{?>
<li><input type="checkbox" class="name" name="permission[]" id="td" value="CSub"> Class Subject&nbsp;</li>
<?php } ?>
  ...
  <?php $ScholM="School Master";
						  ...
						  if($SM !== false)
						  {?>
<li><input type="checkbox" class="name" name="permission[]" checked id="td" value="School Master"> School Master&nbsp;</li>
<?php }else{?>
<li><input type="checkbox" class="name" name="permission[]" id="td" value="School Master"> School Master&nbsp;</li><?php } ?>
...
<?php }else{?>
 <li><input type="checkbox" class="name" name="permission[]" id="td" value="Subject1"> Subject&nbsp;</li>
 <?php } ?>
...
<?php }else{?>
 <li><input type="checkbox" class="name" name="permission[]" id="td" value="Branch"> Branch&nbsp;</li>
 <?php } ?>
...
<?php }else{?>
 <li><input type="checkbox" class="name" name="permission[]" id="td" value="BrSubjects"> Branch Subjects&nbsp;</li>
 <?php } ?> 
...
<?php }else{?>
  <li><input type="checkbox" class="name" name="permission[]" id="td" value="Class"> Class&nbsp;</li>
 <?php } ?>
...
<?php }else{?>
  <li><input type="checkbox" class="name" name="permission[]" id="td" value="access"> School Admin Staff&nbsp;</li>
 <?php } ?>
...
<li><input type="checkbox" class="subpoint" name="permission[]" value="Blue Points To Teacher">Blue Point rewards to teachers&nbsp;</li>
 ...
 <?php } ?>-->
                   ...
                   <td style="vertical-align:top; ">
                    ...
                    <?php $TGP="TGP1";
						  ...
						  if($BGP !== false)
						  {?>
 <li><input type="checkbox" class="sublog" checked name="permission[]" value="TGP1">Green Points given to Teachers for Distribution&nbsp;</li><?php }else{?>
  <li><input type="checkbox" class="sublog" name="permission[]" value="TGP1">Green Points given to Teachers for Distribution&nbsp;</li>
 <?php } ?>
 ...
 <?php $SGP="S2gp";
						  ...
						  if($SG1 !== false)
						  {?>
 <li><input type="checkbox" class="sublog" checked name="permission[]" value="S2gp"> Green Points given to Students as rewards&nbsp;</li><?php }else{?>
  <li><input type="checkbox" class="sublog" name="permission[]" value="S2gp">Green Points given to Students as rewards&nbsp;</li>
 <?php } ?>
 ...
 <?php $TeacherBluePoint="Teacher Blue Point";
						  ...
						  {?>
 <li><input type="checkbox" class="sublog" checked name="permission[]" value="Teacher Blue Point"> Blue Points given to Teachers as Rewards&nbsp;</li><?php }else{?>
  <li><input type="checkbox" class="sublog" name="permission[]" value="Teacher Blue Point"> Blue Points given to Teachers as Rewards&nbsp;</li>
 <?php } ?>
 ...
 <?php $TeacherBluePoint="Teacher Green Point";
						  ...
						  if($TeacherBPoint !== false)
						  {?>
 <li><input type="checkbox" class="sublog" checked name="permission[]" value="Teacher Green Point"> Blue Points Given to Students for Distribution&nbsp;</li><?php }else{?>
  <li><input type="checkbox" class="sublog" name="permission[]" value="Teacher Green Point"> Blue Points Given to Students for Distribution&nbsp;</li>
 <?php } ?>
           </ul>
                    </td>
                  ...
                  <td style="vertical-align:top; ">
                      <ul style="list-style-type:none; margin-left: -35px;">
                          ...
                          <li><input type="checkbox" class="subreport" checked name="permission[]" value="TSR"> Teacher Subject&nbsp;</li>
                           <?php }else{?>
                          <li><input type="checkbox" class="subreport"  name="permission[]" value="TSR"> Teacher Subject&nbsp;</li>
                           <?php } ?>
                          ...
                          <li><input type="checkbox" class="subreport" checked name="permission[]" value="SSR"> Student Subject&nbsp;</li>
                           <?php }else{?>
                          <li><input type="checkbox" class="subreport"  name="permission[]" value="SSR"> Student Subject&nbsp;</li>
                           <?php } ?>
                          ...
                          <li><input type="checkbox" class="subreport" checked name="permission[]" value="TR1"> Teacher&nbsp;</li>
                           <?php }else{?>
                          <li><input type="checkbox" class="subreport"  name="permission[]" value="TR1"> Teacher&nbsp;</li>
                           <?php } ?>
                          ...
                          <li><input type="checkbox" class="subreport" checked name="permission[]" value="SR1"> Student&nbsp;</li>
                           <?php }else{?>
                          <li><input type="checkbox" class="subreport"  name="permission[]" value="SR1"> Student&nbsp;</li>
                          <?php } ?>
                      </ul>
                   </td>
             </tr>
