...
if (isset($_POST['submit'])) {
	...
	if($activity!='')
	{
    $results = mysql_query("SELECT act360_ID,act360_activity,act360_activity_level_ID,act360_credit_points,act360_school_ID FROM tbl_360activities where act360_school_ID='$sc_id' and act360_activity='$activity'");
    if (mysql_num_rows($results) == 0) {
        $query = "insert into tbl_360activities(act360_activity,act360_activity_level_ID, act360_credit_points,act360_school_ID) values('$activity','$activity_level_ID','$credit_points','$sc_id')";
            ...
            <div class="row" style="padding-top:30px;">
                ...
                <div class="col-md-3">
                    <select name="activity_level_ID" id="activity_level_ID" class="form-control" required  ">
                        ...
                        <?php
                        $sql = "SELECT * FROM tbl_360activity_level where actL360_enable=1";
