          ...
          <div class='panel-heading' align="center">
                ...
                <h3>Extract Excel Sheet</h3>
                   ...
                   <!-- <form name='frm' method='post' enctype='multipart/form-data' id='frm'>-->
                    ...
                    <select name="extract">
                        <option value="1"> <?php echo $dynamic_subject;?> Master</option>
                        <option value="2"> <?php echo $dynamic_teacher;?> <?php echo $dynamic_subject;?> Master</option>
						
						<?php if (($school_type == 'school' or $school_type == 'organization') && $user=='School Admin'){?>
                        <option value="3"> Class Semester Subject</option>
                        <option value="4"> Student Semester Subject</option>
                        <option value="5"> Subject Semester Master</option>
						<?php }?>
                    </select>
                    ...
                    <br>
                                ...
                                <div class='col-md-4'>
                                    <div class='col-md-4 indent-small'>
                                        <b style="margin-right:300px;"><input type='file' name='file'  id='file'  onChange="ValidateSingleInput(this);" style="margin-left:455px;margin-top:20px"/></b>                    </div>
                                </div>
                                <br><br>
                              ...
                              <div class='form-group'>
                                ...
                                <div class='col-md-3' style="margin-top:-35px">
                                  ...
                                  <a href="scadmin_dashboard.php"><button class='btn-lg btn-danger'  type='button'>Back</button></a>
                                </div>
                                </div>
                                <div class="row">
