...
$sql=mysql_query(" SELECT s.std_complete_name,s.school_id ,  tvc.coupon_id, tvc.code, tvc.user_id FROM tbl_selected_vendor_coupons tvc 
...
$sql1 =" SELECT count(s.std_complete_name),s.school_id ,  tvc.coupon_id, tvc.code, tvc.user_id FROM tbl_selected_vendor_coupons tvc 
 join tbl_student s on  s.id=tvc.user_id and s.school_id=tvc.school_id where   
 tvc.entity_id='3' AND 
 (tvc.used_flag ='used' AND tvc.school_id = '$school_id')";  
...
if($searchq !='')
	...
	{
		$query1=mysql_query("SELECT s.std_complete_name,s.school_id ,  tvc.coupon_id, tvc.code, tvc.user_id FROM tbl_selected_vendor_coupons tvc 
 join tbl_student s on  s.id=tvc.user_id and s.school_id=tvc.school_id where   
 tvc.entity_id='3' AND 
 (tvc.used_flag ='used' AND tvc.school_id = '$school_id')
 and
...
<script type="text/javascript">
    $(function () {
        ...
        window.pagObj = $('#pagination').twbsPagination({
			...
			window.location.assign('sc_vendor_coupon_purchased_student.php?page='+page);
        });
    });
</script>
<?php }else{
...
<script type="text/javascript">
    $(function () {
        ...
        window.pagObj = $('#pagination').twbsPagination({
            ...
            console.info(page + '(from event listening)');
			window.location.assign('sc_vendor_coupon_purchased_student.php?Search=<?php echo $searchq; ?>&spage='+page);
        });
    });
</script>
...
<div align="center">
    <div class="container" style="width:100%;">
		...
		<div class="col-md-2" style="width:17%;">
			...
			<div class="col-md-1" >
			<input type="button" class="btn btn-info" value="Reset" onclick="window.open('sc_vendor_coupon_purchased_student.php','_self')" />
			</div>
