	...
	if($school_id != "")
		{
		 ...
		 $sql= "SELECT sp.sc_id,ucwords(sp.sc_list) as sc_list,ucwords(a.activity_type) as activity_type FROM tbl_studentpointslist sp JOIN tbl_activity_type a WHERE sp.school_id='$school_id'  AND a.id = sp.sc_type";
 			 $arr = mysql_query($sql);
