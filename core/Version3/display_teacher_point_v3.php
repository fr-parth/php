...
//input from user
 ...
 //Below query added by Rutuja Jori for displaying count of request by Student to Teacher & Teacher to Teacher	
$r=	mysql_query("select stud_id2 from tbl_request where stud_id2='$teacher_id' and school_id='$school_id' and flag='N'");
  			...
  			if(mysql_num_rows($arr)>=1) {
    			while($post = mysql_fetch_assoc($arr)) {
						...
						$brown_point=(int)$post['brown_point'];
      				   ...
      				   $posts[] =array('green_points'=>$green_points,'blue_points'=>$blue_points,'water_points'=>$water_point,'brown_points'=>$brown_point,'totalRequestCount'=>$count);
