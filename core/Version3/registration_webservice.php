...
function message_india($email, $mobile, $pass, $ehr){
	...
	$url=SEND_SMS_PATH."?user=$dynamic_user&password=$dynamic_pass&sender=$dynamic_sender&PhoneNumber=$mobile&Text=$Text&msgType=$msgType&Pe_id=$pe_id&template_id=$template_id";
