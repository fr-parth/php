...
if($_GET['designations']!='' && $_GET['ids']!='')
{
 $report="";
// include("scadmin_header.php");

 $division_id= $_GET["ids"];	
 $division_name= $_GET["designations"];	
...
if (isset($_POST['submit'])) {
   ...
   // $division_id = $_POST['division_id'];
    ...
    $results = mysql_query("SELECT * FROM tbl_teacher_designation WHERE school_id='$sc_id' and designation='$division' ");
    if (mysql_num_rows($results) == 0) {
        $query = "insert into tbl_teacher_designation (designation,school_id) values('$division','$sc_id') ";
        $rs = mysql_query($query);
    ...
    <form method="post">
        ...
        <div class="row">
            ...
            <div class="col-md-3 " align="center" style="color:#663399;">
				...
				<div class="row" style="padding-top:30px;">
                                    ...
                                    <div class="col-md-2" style="color:#808080;font-size:18px;margin-left:10px">Designation:<span style="color:red;font-size: 25px;">*</span></div>
                                    <div class="col-md-3">
        ...
        <div class="row" style="padding-top:15px;">
            ...
            <div class="col-md-3 " align="left">
                ...
                <a href="list_school_designation.php" style="text-decoration:none;"> <input type="button"
