...
<head>
    ...
    <title><?php echo $dynamic_level;?></title>
                ...
                <div class="row">
                    ...
                    <div class="col-md-3 " style="color:#700000 ;padding:5px;">&nbsp;&nbsp;&nbsp;&nbsp;
                        ...
                        <a href="Add_course_level.php"> <input type="submit" class="btn btn-primary" name="submit"
                                                               value="Add <?php echo $dynamic_level;?>"
                    ...
                    <div class="col-md-6 " align="center">
                        ...
                        <h2><?php echo $dynamic_level;?> List </h2>
...
<!--Done changes in th for label by Dhanashri_Tak-->
                            <tr>
								...
								<th style="text-align: center;">Ext <?php echo $dynamic_level;?> ID</th>
                                <th style="text-align: center;"><?php echo $dynamic_level;?></th>
