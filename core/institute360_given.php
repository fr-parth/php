...
<head>
    ...
    <title>Institute Activity Given</title>
...
<script type="text/javascript">
    $(function () {
        ...
        window.pagObj = $('#pagination').twbsPagination({
            ...
            console.log(page);
      			window.location.assign('institute360_given.php?yr=<?php echo $yr."&dpt=".$dpt; ?>&page='+page);
...
<script type="text/javascript">
    $(function () {
     ...
     window.location.assign('institute360_given.php?yr=<?php echo $yr."&dpt=".$dpt; ?>&Search=<?php echo $searchq; ?>&spage='+page);
         <?php } else{ ?>
     window.location.assign('institute360_given.php?Search=<?php echo $searchq; ?>&spage='+page);
         <?php } ?>
        });
    });
</script>
...
<div align="center">
    <div class="container" style="width:100%;">
        <div style="padding-top:30px;">
            ...
            <h2 style="padding-left:20px; margin-top:2px;color:#666"> Institute Activity- Given</h2>
       ...
       <input type='hidden' name='dpt' value='<?php echo $_GET['dpt']?>'> </input>
			...
			<div class="col-md-1" >
			<input type="button" class="btn btn-info" value="Reset" onclick="window.open('institute360_given.php?yr=<?php echo $yr; ?>&dpt=<?php echo $dpt; ?>','_self')" />
			</div>
