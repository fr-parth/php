...
include("cookieadminheader.php");
 ...
 $to_date = date("d-m-Y H:i",mktime(23,59));//hour, minute, second$timeStamp = mktime(0, 0, 0, $month, 1, $year);
   ...
   $group_member_id = $_SESSION['group_admin_id'];
    ...
    $query12=mysql_query("SELECT Entity_type FROM tbl_LoginStatus where school_id='$sc_id'");
...
<?php
       ...
       //            if($entity_type =='105' || $entity_type =='205'){
       //              if($school_type == 'school' or $school_type == 'organization'){
       ?>
