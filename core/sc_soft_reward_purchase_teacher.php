...
//$soft_reward_user added and used in all below queries by Pranali to take dynamic usertype based on $dynamic_teacher for SMC-4626 on 9-4-20			
...
$sql=mysql_query("SELECT  t.t_complete_name,p.user_id,p.school_id ,s.rewardType FROM purcheseSoftreward 
as p 
...
where userType='".$soft_reward_user."' and  t.school_id='$school_id'
...
if($searchq !='')
	...
	{
		$query1=mysql_query("SELECT t.t_complete_name,p.user_id,p.school_id ,s.rewardType FROM purcheseSoftreward 
as p 
inner join softreward as s on p.reward_id=s.softrewardId 
 inner join tbl_teacher t on t.id=p.user_id and p.school_id=t.school_id
where (userType='".$soft_reward_user."')  and  (t.school_id='$school_id') 
...
<script type="text/javascript">
    $(function () {
        ...
        window.pagObj = $('#pagination').twbsPagination({
			...
			window.location.assign('sc_soft_reward_purchase_teacher.php?page='+page);
        });
    });
</script>
<?php }else{
...
<script type="text/javascript">
    $(function () {
        ...
        window.pagObj = $('#pagination').twbsPagination({
            ...
            console.info(page + '(from event listening)');
			window.location.assign('sc_soft_reward_purchase_teacher.php?Search=<?php echo $searchq; ?>&spage='+page);
        });
    });
</script>
...
<div align="center">
    <div class="container" style="width:100%;">
		...
		<div class="col-md-2" style="width:17%;">
			...
			<div class="col-md-1" >
			<input type="button" class="btn btn-info" value="Reset" onclick="window.open('sc_soft_reward_purchase_teacher.php','_self')" />
			</div>
			<div class="col-md-1" >
