...
echo $group_member_id=$result['group_member_id'];
...
if($school_id !='')
	{
		...
		$query=mysql_query("insert into tbl_thanqyoupointslist(t_list,school_id,group_member_id) values('$t_lists[$i]','$school_id','$group_member_id')");
		$i++;
		}
