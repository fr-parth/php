...
<html lang="en">
    ...
    <body>
			...
			<a class="dropdown-toggle" data-toggle="dropdown" href="#">Green Point Log</a></li>
				...
				<ul class="dropdown-menu">
                                <?php $TGP="TGP1";
									...
									if($BGP !== false || $flag)
								{?>
                                <li><a href="recalculate.php">Green Point Given By Teacher Log</a></li>
								...
								{?>
                                 ...
                                 <li><a href="recalculate.php">Green Point Given By <?php 
                                 echo $dynamic_school_admin; ?> Log</a></li>
...
<div style="height:10px;"></div>
        ...
        <table id="example" class=" table-bordered table-striped table-condensed cf" align="center" style="width:100%">
                ...
                <tr>
                   ...
                   <td data-title="Teacher Name" width="15%"><?php echo $student['t_complete_name'];?></td>
                   ...
                   <td data-title="Used Points"   width="15%"><?php echo $student['tc_used_point'];?></td>
                </tr>
			    <?php
				$i++;
				}
...
<div style="height:10px;"></div>
        ...
        <table id="example" class=" table-bordered table-striped table-condensed cf" align="center" style="width:100%">
                ...
                <tr>
                   ...
                   <td data-title="Blue points" width="15%"><?php echo $student['sc_point'];?></td>
