<?Php
/*Created by Rutuja for SMC-4415 to show Blue points log assigned to School by Cookie & Group Admin on 13/01/2020*/
if(isset($_GET['name']))
{
...
<div style="height:10px;"></div>
        ...
        <table id="example" class=" table-bordered table-striped table-condensed cf" align="center" style="width:100%">
                ...
                $arrs = mysql_query("SELECT d.assigned_by,d.points,d.date,d.entity_id FROM tbl_distribute_points_by_cookieadmin d join tbl_school_admin s on d.entity_id=s.school_id where d.point_color='BLUE'  and d.entity_id='$school_id'
					order by d.id desc");
...
<div style="height:20px;"></div>
		...
		<!-- Camel casing done for Green Points Given to Teachers for Distribution by Pranali -->
        	<h2 style="padding-left:20px; margin-top:2px;color:#666" align="center"> <?php echo $dynamic_Blue_Points_given_for_Distribution_to_School;?></h2>
        </div>
        <div   class="container" style="padding-top:20px;">
