...
<head>
    ...
    <title>Green Points Distibuted By CookieAdmin</title>
...
$sql=mysql_query("SELECT * FROM tbl_distribute_points_by_cookieadmin where 
point_color = 'GREEN' order by id desc
LIMIT $start_from, $webpagelimit");	

$sql1 ="SELECT count(*) FROM tbl_distribute_points_by_cookieadmin where
 point_color = 'GREEN' order by id desc"; 
...
//$colname=mysql_real_escape_string($_GET['colname']);
	if ($searchq != '')
	{ 
		$query1=mysql_query("SELECT * FROM tbl_distribute_points_by_cookieadmin where 
point_color = 'GREEN' and
 
 entity_id LIKE '%$searchq%' or points LIKE '%$searchq%'
  or date LIKE '%$searchq%'  order by id desc
...
LIMIT $start_from, $webpagelimit")
		...
		or die("could not Search!");
					//echo $query1;
		$sql1 ="SELECT * FROM tbl_distribute_points_by_cookieadmin where 
point_color = 'GREEN' 
 and  $colname LIKE '%$searchq%' 
 order by id desc"; 
					$rs_result = mysql_query($sql1);  
...
<script type="text/javascript">
    $(function () {
        ...
        window.pagObj = $('#pagination').twbsPagination({
			...
			window.location.assign('analytics_details_green_points_distributed_by_cookieadmin.php?page='+page);
        });
    });
</script>
<?php }else{
...
<script type="text/javascript">
    $(function () {
        ...
        window.pagObj = $('#pagination').twbsPagination({
            ...
            console.info(page + '(from event listening)');
			window.location.assign('analytics_details_green_points_distributed_by_cookieadmin.php?Search=<?php echo $searchq; ?>&spage='+page);
        });
    });
</script>
<?php }?>
...
<div align="center">
    <div class="container" style="width:100%;">
        <div style="padding-top:30px;">
            ...
            <h2 style="padding-left:20px; margin-top:2px;color:#666"> Green Points Distibuted By CookieAdmin</h2>
		...
		<form style="margin-top:5px;">
			...
			<div class="col-md-1" >
			<input type="button" class="btn btn-info" value="Reset" onclick="window.open('analytics_details_green_points_distributed_by_cookieadmin.php','_self')" />
			</div>
            ...
            <table id="example" class="col-md-12 table-bordered " align="center">
                ...
                while($result = mysql_fetch_array($query1)) {
                    ...
                    <tr>
						...
						<td data-title="School ID"><?php echo $result['entity_id']; ?></td>
						<td data-title="Points"><?php echo $result['points']; ?></td>
                        <td data-title="Date"><?php echo $result['date']; ?></td>
