...
Date : 08-11-2019
This file was created for Updation of Rewards Rule Engine (for assigning points) in Cookie Admin
*/
            ...
            <form method="post" action="" style="max-width:1200px; width:100%;">
             ...
             while($result=mysql_fetch_array($query))
              ...
              $i++;
                    ...
                    <div class="col-md-1"><a href="home_cookieadmin.php"><input type="button" name="cancel" value="Cancel" class="btn btn-danger"></a></div>
