...
$sql=mysql_query(" SELECT * FROM tbl_teacher where t_phone=''
        
LIMIT $start_from, $webpagelimit");	

$sql1 =" SELECT count(*) FROM tbl_teacher where t_phone=''";  
...
if($searchq !='')
	...
	{
		$query1=mysql_query("SELECT * FROM tbl_teacher where (t_phone='')
 and
...
<script type="text/javascript">
    $(function () {
        ...
        window.pagObj = $('#pagination').twbsPagination({
			...
			window.location.assign('analytics_details_teachers_without_phone.php?page='+page);
        });
    });
</script>
<?php }else{
...
<script type="text/javascript">
    $(function () {
        ...
        window.pagObj = $('#pagination').twbsPagination({
            ...
            console.info(page + '(from event listening)');
			window.location.assign('analytics_details_teachers_without_phone.php?Search=<?php echo $searchq; ?>&spage='+page);
        });
    });
</script>
...
<div align="center">
    <div class="container" style="width:100%;">
        <div style="padding-top:30px;">
            ...
            <h2 style="padding-left:20px; margin-top:2px;color:#666">Teachers without Phone</h2>
		...
		<div class="col-md-2" style="width:17%;">
			...
			<div class="col-md-1" >
			<input type="button" class="btn btn-info" value="Reset" onclick="window.open('analytics_details_teachers_without_phone.php','_self')" />
			</div>
