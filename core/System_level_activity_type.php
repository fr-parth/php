	   	...
	   	$cp_point=$_POST['coupon'];
			...
			$sc_total_point=$row['sc_total_point'];
					...
					if($sc_total_point>=$cp_point)
					{
						...
						//end date format changed by sachin
...
<div class="row" style="padding:5px;height:50px; background-color:#C1CDCD ;border-color:#C1CDCD">
    ...
    <div class="col-md-8 "  align="left">
				...
				<!--Added 50% for label-->
                    ...
                    <h1 style="padding-left:50%; margin-top:5px;">List of Activity Type</h1>
         </div>
        ...
        <div id="no-more-tables " style="padding:10px;" >
                ...
                <thead>
                    <tr>
                        ...
                        <th width="30%" align="left">Activity Type</th>
                ...
                <tbody>
                     <?php  $sql="select id,activity_type from  tbl_activity_type where school_id='0' and group_member_id='0' ORDER BY  id DESC";
                    ...
                    $i=0;
                        ...
                        <tr>
							...
							<td data-title="Activity Type" width="50%" ><?php echo ucwords($row1['activity_type']);?></td>

                            <td data-title="Edit" width="10%" align="center"> <a href="edit_system_activity_type.php?activity=<?php echo $row1['id'];  ?>"   style="text-decoration:none" ><span class="glyphicon glyphicon-pencil"></span></a></td>

                            <td data-title="Delete" width="10%" align="center"><a style="text-decoration:none" onClick="confirmation(<?php echo $row1['id']; ?> )" ><span class="glyphicon glyphicon-trash"></span></a></td>
