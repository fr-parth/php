...
<div class="panel panel-default"><br>
  ...
  <div class="panel-heading" align="center"><b><?php echo $dynamic_student ?> <?php echo $dynamic_subject?> Report</b></div><br>
 ...
 <p><table border="1" align="center" width="450" height="300">
  ...
  <tr>
    <td align="center">Duplicate Reocrd</td>
     <?php $Duplicate=mysql_query("select * from  tbl_student_subject where status='duplicate' AND school_id = '$school_id'");
	...
	?>
        ...
        <td align="center"><?php echo $dynamic_student ?> Not Match</td>
  ...
  <tr>
    ...
    <?php $subject=mysql_query("select * from tbl_student_subject where status='Subject Code' AND school_id = '$school_id'");
