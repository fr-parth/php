...
<table class="table">
  ...
  <tbody>
    <?php
      ...
      $sql ="SELECT * FROM tbl_otp_log WHERE delivery_method ='SMS' and school_id ='$school_id' ";
...
<!-- <script type="text/javascript">
    $(function () {
        ...
        window.pagObj = $('#pagination').twbsPagination({
			...
			window.location.assign('Send_SMS_Log.php?colname=<?php echo $colname;?>&Search=<?php echo $searchq; ?>&spage='+page);
        });
    });
</script> -->
</html>
