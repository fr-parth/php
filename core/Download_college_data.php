...
/*change done by Pranali intern start*/echo 'DTE Code' . "\t" . 'School ID' . "\t" .'School Name'."\t". 'School Admin Name' . "\t" . 'Stream' . "\t". 'Address' . "\t" . 'Email_ID' . "\t". 'Phone'."\t" .'Batch_No'."\n";
...
/*changes done end*/ echo 'DTE Code' . "\t" . 'School ID' . "\t" .'School Name'."\t". 'School Admin Name' . "\t" . 'Stream' . "\t". 'Address' . "\t" . 'Email_ID' . "\t". 'Phone'."\t". 'School_Type'."\n";
