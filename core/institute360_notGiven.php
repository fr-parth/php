...
<head>
    ...
    <title>Institute Activity Not Given</title>
...
if(($yr!='' and $yr!='ALL') and ($dpt!='' and $dpt!='ALL')){
  ...
  FROM tbl_teacher  t
   where t.school_id='$school_id' and t.t_academic_year='$yr' and t.t_dept='$dpt' and t.t_emp_type_pid ='137' and t.t_id NOT IN
   (
  select ft.tID
  from tbl_360_activities_data ft where ft.activity_level_id='2' and  ft.tID is not NULL and  ft.schoolID='$school_id' )
...
elseif(($yr!='ALL' and $yr!='') and ($dpt=='' or $dpt=='ALL')){
  $sql3=mysql_query("SELECT distinct t.t_id,t.t_complete_name,t.t_dept ,t.school_id,t.t_academic_year
  FROM tbl_teacher  t
   where t.school_id='$school_id' and t.t_academic_year='$yr' and t.t_emp_type_pid ='137' and t.t_id NOT IN
   (
  select ft.tID
  from tbl_360_activities_data ft where ft.activity_level_id='2' and  ft.tID is not NULL and  ft.schoolID='$school_id' )
...
elseif(($yr=='ALL' or $yr=='') and ($dpt!='' and $dpt!='ALL')){
    $sql3=mysql_query("SELECT distinct t.t_id,t.t_complete_name,t.t_dept ,t.school_id,t.t_academic_year
    FROM tbl_teacher  t
     where t.school_id='$school_id' and t.t_dept='$dpt' and t.t_emp_type_pid ='137' and t.t_id NOT IN
     (
    select ft.tID
    from tbl_360_activities_data ft where ft.activity_level_id='2' and  ft.tID is not NULL and  ft.schoolID='$school_id' )
  ...
  $sql3=mysql_query("SELECT distinct t.t_id,t.t_complete_name,t.t_dept ,t.school_id,t.t_academic_year
  FROM tbl_teacher  t
   where t.school_id='$school_id' and t.t_emp_type_pid ='137' and t.t_id NOT IN
   (
  select ft.tID
  from tbl_360_activities_data ft where ft.activity_level_id='2' and  ft.tID is not NULL and  ft.schoolID='$school_id' )
...
<script type="text/javascript">
    $(function () {
        ...
        window.pagObj = $('#pagination').twbsPagination({
           ...
           console.log(page);
        			window.location.assign('institute360_notGiven.php?yr=<?php echo $yr."&dpt=".$dpt; ?>&page='+page);
    ...
    $(function () {
        ...
        window.pagObj = $('#pagination').twbsPagination({
            ...
            <?php if($_GET['yr'] or $_GET['dpt']){ ?>
      			window.location.assign('institute360_notGiven.php?yr=<?php echo $yr."&dpt=".$dpt; ?>&Search=<?php echo $searchq; ?>&spage='+page);
                <?php } else{ ?>
            window.location.assign('institute360_notGiven.php?Search=<?php echo $searchq; ?>&spage='+page);
                <?php } ?>
        });
    });
</script>
...
<div align="center">
    <div class="container" style="width:100%;">
       ...
       <input type='hidden' name='dpt' value='<?php echo $_GET['dpt']?>'> </input>
			...
			<div class="col-md-1" >
			<input type="button" class="btn btn-info" value="Reset" onclick="window.open('institute360_notGiven.php?yr=<?php echo $yr; ?>&dpt=<?php echo $dpt; ?>','_self')" />
			</div>
            ...
            LIMIT $start_from, 10")
                ...
                while($result = mysql_fetch_array($query)) {
                    ...
                    <tr>
						...
						<td data-title="ID"><?php echo $result['t_id']; ?></td>
