...
//echo $result['school_id'];exit;
//print_r($result);exit;
$B_id=$_GET['batch_id'];
//print_r($_GET['batch_id']);exit;
//print_r($B_id);exit;
...
<div class="panel panel-default"><br>
  ...
  <div class="panel-heading" align="center"><b><?php echo $dynamic_student  ?> Master Report</b></div><br>

  <div class="row">
  <div class="col-md-4 col-md-offset-5">
<div class="dropdown1" style="position:absolute; left:-258px; top:3px;">
...
Batch ID's
  ...
  <?php
  //echo "Select batch_id from tbl_raw_student where s_school_id='$sc_id' group by batch_id";exit;
   $sql1=mysql_query("Select batch_id from tbl_raw_student where s_school_id='$sc_id' group by batch_id" );?>
 ...
 <p><table border="1" align="center" width="450" height="300">
  ...
  <tr>
    <td align="center">No. of Records</td>
     <?php //print_r($B_id);exit; 
					$Recordscount=mysql_query("select no_record_uploaded from  tbl_raw_student where batch_id='$B_id' and s_school_id='$sc_id'");
