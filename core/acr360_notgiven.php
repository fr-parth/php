...
<head>
    ...
    <title>ACR Activity Not Given</title>
...
if(($yr!='' and $yr!='ALL') and ($dpt!='' and $dpt!='ALL')){
  ...
  FROM tbl_teacher  t
   ...
   (
  select ft.tID
  from tbl_360_activities_data ft where ft.activity_level_id='4' and  ft.tID is not NULL and  ft.schoolID='$school_id' )
  group by t.t_id");
...
<script type="text/javascript">
    $(function () {
        ...
        window.pagObj = $('#pagination').twbsPagination({
         ...
         console.log(page);
        			window.location.assign('acr360_notgiven.php?yr=<?php echo $yr."&dpt=".$dpt; ?>&page='+page);
    ...
    $(function () {
        ...
        window.pagObj = $('#pagination').twbsPagination({
            ...
            <?php if($_GET['yr'] or $_GET['dpt']){ ?>
      			window.location.assign('acr360_notgiven.php?yr=<?php echo $yr."&dpt=".$dpt; ?>&Search=<?php echo $searchq; ?>&spage='+page);
                <?php } else{ ?>
            window.location.assign('acr360_notgiven.php?Search=<?php echo $searchq; ?>&spage='+page);
                <?php } ?>
        });
    });
</script>
...
<div align="center">
    <div class="container" style="width:100%;">
       ...
       <input type='hidden' name='dpt' value='<?php echo $_GET['dpt']?>'> </input>
			...
			<div class="col-md-1" >
			<input type="button" class="btn btn-info" value="Reset" onclick="window.open('acr360_notgiven.php?yr=<?php echo $yr; ?>&dpt=<?php echo $dpt; ?>','_self')" />
			</div>
