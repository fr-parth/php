...
$sql=mysql_query("SELECT * FROM tbl_student where std_email='' and school_id='$school_id'
LIMIT $start_from, $webpagelimit");	

$sql1 ="SELECT count(*) FROM tbl_student where std_email='' and school_id='$school_id'"; 
...
//$colname=mysql_real_escape_string($_GET['colname']);
	if ($searchq != '')
	{ 
		$query1=mysql_query("SELECT * FROM tbl_student where (std_email='' and school_id='$school_id') and
 ...
 (std_complete_name LIKE '%$searchq%' or id LIKE '%$searchq%'
  ...
  LIMIT $start_from, $webpagelimit") or die("could not Search!");
			...
			$sql1 ="SELECT count(*) FROM tbl_student where (std_email='' and school_id='$school_id') and
...
$query1=mysql_query("SELECT * FROM tbl_student where std_email=''
...
<script type="text/javascript">
    $(function () {
        ...
        window.pagObj = $('#pagination').twbsPagination({
			...
			window.location.assign('sc_analytics_details_students_without_email.php?page='+page);
        });
    });
</script>
<?php }else{
...
<script type="text/javascript">
    $(function () {
        ...
        window.pagObj = $('#pagination').twbsPagination({
            ...
            console.info(page + '(from event listening)');
			window.location.assign('sc_analytics_details_students_without_email.php?Search=<?php echo $searchq; ?>&spage='+page);
        });
    });
</script>
<?php }?>
...
<div align="center">
    <div class="container" style="width:100%;">
        <div style="padding-top:30px;">
            ...
            <h2 style="padding-left:20px; margin-top:2px;color:#666"> <?php echo $dynamic_student;?> Without Email ID</h2>
		...
		<form style="margin-top:5px;">
			...
			<div class="col-md-1" >
			<input type="button" class="btn btn-info" value="Reset" onclick="window.open('sc_analytics_details_students_without_email.php','_self')" />
			</div>
			<div class="col-md-1" >
