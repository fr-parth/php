...
$result = mysql_query("SELECT * FROM tbl_semester_master where(class  ='' or class is null ) and School_ID='$school_id'");
?>
<html>
<head>
<style>
...
<div class="container">
	<div class="panel panel-default">
		<div class="panel-heading" align='center'><h3> Semester  Without Class</h3></div>
				...
				<tbody>
					 ...
					 ?>
						<tr>
							...
							<td data-title=""><?php echo $row['class']; ?></td>
