...
if(isset($_POST['submit']))
{
	...
	$results=mysql_query("SELECT * FROM tbl_studentpointslist where sc_type='$activity_type_id' and group_member_id='$group_member_id' and school_id='0'");
