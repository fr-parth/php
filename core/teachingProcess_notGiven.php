...
<head>
    ...
    <title>Teaching Process Not Given</title>
...
if(($yr!='' and $yr!='ALL') and ($dpt!='' and $dpt!='ALL')){
       ...
       $ss="	SELECT distinct t.t_id,t.t_complete_name,t.t_dept ,t.school_id,t.t_academic_year
    FROM tbl_teacher  t
     where t.school_id='$school_id' and t.t_academic_year='$yr' and t.t_dept='$dpt' and t.t_emp_type_pid
            in (133,134,135,137) and t.t_id NOT IN
     (
    select ft.feed360_teacher_id
    from tbl_360feedback_template ft where ft.feed360_school_id='$school_id' and ft.feed360_teacher_id is not null)
    group by t.t_id";
    $sql3=mysql_query($ss);
...
<script type="text/javascript">
    $(function () {
        ...
        window.pagObj = $('#pagination').twbsPagination({
            ...
            console.log(page);
        			window.location.assign('teachingProcess_notGiven.php?yr=<?php echo $yr."&dpt=".$dpt;?>&page='+page);
    ...
    $(function () {
        ...
        window.pagObj = $('#pagination').twbsPagination({
            ...
            <?php if($_GET['yr'] or $_GET['dpt']){ ?>
      			window.location.assign('teachingProcess_notGiven.php?yr=<?php echo $yr."&dpt=".$dpt; ?>&Search=<?php echo $searchq; ?>&spage='+page);
                <?php } else{ ?>
            window.location.assign('teachingProcess_notGiven.php?Search=<?php echo $searchq; ?>&spage='+page);
                <?php } ?>
        });
    });
</script>
...
<div align="center">
    <div class="container" style="width:100%;">
       ...
       <input type='hidden' name='dpt' value='<?php echo $_GET['dpt']?>'> </input>
			...
			<div class="col-md-1" >
			<input type="button" class="btn btn-info" value="Reset" onclick="window.open('teachingProcess_notGiven.php?yr=<?php echo $yr; ?>&dpt=<?php echo $dpt; ?>','_self')" />
			</div>
