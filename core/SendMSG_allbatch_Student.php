...
<div class="container"  style="padding:30px;width:1500px" >
				...
				Send SMS/ Email to Students 
				  ...
				  <ul class="dropdown-menu " role="menu" aria-labelledby="dropdownMenu1" style="margin-left: 133%;">
				...
				Batch ID's
				  ...
				  <ul class="dropdown-menu " role="menu" aria-labelledby="dropdownMenu2" style="margin-left: 133%;">
               ...
               <?php $i=0;?>
                  <table class="table-bordered  table-condensed cf" id="example" width="100%;" >
                     <thead>
                    	<tr style="background-color:#428BCA" ><th style="width:10%;" ><b>Sr.No</b></th><th style="width:20%;"><b>Student PRN</b></th><th style="width:20%;" >Name</th><th style="width:20%;">Phone No.</th><th style="width:20%;">Email ID</th> </th><th style="width:10%;">Batch ID</th> </th><th style="width:10%;">SMS Status</th>  </th><th style="width:10%;">EMAIL Status</th> 
                        <th style="width:15%;">Send SMS/Email Student</th>
                        </tr></thead><tbody>
                 <?php
				 
				   $i=1;
		
				  $arr=mysql_query("select id,std_PRN,std_complete_name,std_phone,std_email,batch_id,send_unsend_status,school_id,email_status,std_country from tbl_student where school_id='$School_id' and batch_id like '$batch_id' order by id");?>
				  ...
				  ?>
                    ...
                    <td data-title="Name" style="width:12%;"><?php echo $row['std_complete_name']?></td> 
				     ...
				     <td data-title="Phone" style="width:8%;"><?php echo $row['std_email'];?> </td>
				      <td data-title="Phone" style="width:6%;"><?php echo $row['batch_id'];?> </td>
					   <td data-title="Phone" style="width:5%;"><?php echo $row['send_unsend_status'];?> </td>
					    <td data-title="Phone" style="width:5%;"><?php echo $row['email_status'];?> </td>
						...
						<a href="SendEmail_Student.php?email=<?php echo $row['std_email'];?>&school_id=<?php echo $row['school_id'];?>&status=<?php echo $row['email_status'];?>"><img src="Images/E.png"></a>
						 </td>
