...
$duplicate_records=$_GET['duplicate'];
$error_records = $_GET['error'];
...
<div class="panel panel-default"><br>
  ...
  <div class="panel-heading" align="center"><b><?php echo $tbl_name; ?> Report</b></div><br>
...
<br>
 ...
 <p><table border="1" align="center" width="450" height="300">
  ...
  <tr>
    ...
    <td align="center"><?php if($duplicate_records != NULL or $duplicate_records != ''){ echo $duplicate_records; }else{ echo 0; } ?></td>
  ...
  <tr>
    ...
    <?php
        ...
        <td align="center"><?php if($error_records != NULL or $error_records != ''){ echo $error_records; }else{ echo 0; } ?></td>
    <?php 
	// }
	?>
  </tr>
  <!--   ----------------      End of row ------------------------------------------------------ -->
   ...
   <tr>
        <td align="center">Uploaded Records</td>
    ...
    <?php
		    ...
		    {*/
            ?> 
            <td align="center"><?php  if($uploaded_records != NULL or $uploaded_records != ''){ echo $uploaded_records; }else{ echo 0; } ?></td>
    <?php 
	 //}
	?>
