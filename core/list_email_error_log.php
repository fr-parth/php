...
Date:31/10/2020
This file is created for display error log summary of email with count for SMC-4929.
*/
...
$sql=mysql_query("select id,email from tbl_error_log where email !='' and (datetime between '".$_SESSION['from']."' and '".$_SESSION['to']."') group by email LIMIT $start_from, $webpagelimit");	

$sql1 ="select id, email from tbl_error_log where email !='' and (datetime between '".$_SESSION['from']."' and '".$_SESSION['to']."') group by email ";  
...
<script type="text/javascript">
    $(function () {
        ...
        window.pagObj = $('#pagination').twbsPagination({
			...
			window.location.assign('list_email_error_log.php?page='+page);
        });
    });
</script>
<?php }else{
...
<script type="text/javascript">
    $(function () {
        ...
        window.pagObj = $('#pagination').twbsPagination({
            ...
            console.info(page + '(from event listening)');
			window.location.assign('list_email_error_log.php?Search=<?php echo $searchq; ?>&spage='+page);
        });
    });
</script>
...
<div align="center">
    <div class="container" style="width:100%;">
        <div style="padding-top:30px;">
            ...
            <h2 style="padding-left:20px; margin-top:2px;color:#666">Email Error Log</h2>
        ...
        <div id="no-more-tables" style="padding-top:20px;">
            ...
            <table id="example" class="col-md-12 table-bordered " align="center">
                ...
                while($result = mysql_fetch_array($sql)) {
					...
					$querys=mysql_query("select id,email from tbl_error_log where email ='".$result['email']."' and (datetime between '".$_SESSION['from']."' and '".$_SESSION['to']."')");
                    ...
                    <tr>
                        ...
                        <td data-title="User Name"><?php echo $result['email'];?></td>
			...
			<?php 
			$qr=mysql_query("select  email from tbl_error_log where email !='' and (datetime between '".$_SESSION['from']."' and '".$_SESSION['to']."') ");
