...
<!-- <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js"></script>-->
    ...
    <script type="text/javascript">
       ...
       if(id_first_name.trim()=="" || id_first_name.trim()==null)
        {
            ...
            document.getElementById('errorstudent').innerHTML='Please Enter first name!';
            return false;
        }
           ...
           // return true;
        }else if(id_first_name.trim()!="" || id_first_name.trim()!=null){
            document.getElementById('errorstudent').innerHTML='';
        }
        else{
     
        document.getElementById('errorstudent').innerHTML='It is not valid first name';
        return false;
        }
       ...
       if(id_last_name.trim()=="" || id_last_name.trim()==null)
        ...
        document.getElementById('errorlname').innerHTML='It is not valid last name';
        return false;
        }
       ...
       if(school_id.trim()=="" || school_id.trim()==null)
        {
            document.getElementById('errorSchoolid').innerHTML='Please Enter school ID';
            return false;
        }
        ...
        document.getElementById('errorSchoolid').innerHTML='It is not valid school ID';
        return false;
        }
       ...
       if(sc_school_name.trim()=="" || sc_school_name.trim()==null)
        ...
        document.getElementById('errorSchool').innerHTML='It is not valid school name';
        return false;
        }
      ...
      if(group_id=="")
        {
        document.getElementById('errorGroup').innerHTML='Please select group type';
            return false;
        }
        
        var schoolPattern=document.getElementById("schoolPattern").value;
      if(schoolPattern=="")
        {
        document.getElementById('errorPattern').innerHTML='please select School Pattern';
            return false;
        }
        var school_type=document.getElementById("school_type").value;
      if(school_type=="")
        {
        document.getElementById('errorStype').innerHTML='please select school type';
            return false;
        } 
    /*  var gender1 = document.getElementById("gender1").checked;
       ...
       if(id_email.trim()=="" || id_email.trim()==null)
        ...
        document.getElementById('errorEmail').innerHTML='It is not valid email ID!';
        return false;
        }
    ...
    */  
       ...
       if(id_phone.trim()=="" || id_phone.trim()==null)
        ...
        document.getElementById('errorPhone').innerHTML='It is not valid phone number';
        return false;
        }
/*      var address = document.getElementById("id_address").value;
      ...
      if(state==null || state=="" || state=="Select State")
       ...
       if(city.trim()=="" || city.trim()==null)
        {
            document.getElementById('errorCity').innerHTML='It is not valid city';
            return false;
        }
...
if($counts > 0 || $counts1 > 0){
 ...
 //var_dump($calculated_json);die;
         ...
         $calculated_lon = $calculated_json->{'results'}[0]->{'geometry'}->{'location'}->{'lng'};
            ...
            $_SESSION['name']=$_POST['id_first_name'];
            $id_last_name = $_POST['id_last_name'];
            $_SESSION['lname']=$id_last_name;
            $school_type = $_POST['school_type'];
            $_SESSION['school_type']=$_POST['school_type'];
            $name = $id_first_name . " " . $id_last_name;
            $acite_aid = $_POST['acite_aid'];
            $_SESSION['acite_aid']=$_POST['acite_aid'];
            $aciteid = $_POST['aciteId'];
            $_SESSION['aciteId']=$_POST['aciteId'];
            $phone = $_POST['id_phone'];
            ...
            $country_code= $_POST['country-code'];
            $_SESSION['country_code']=$_POST['country-code'];
            $schoolPattern= $_POST['schoolPattern'];
            $_SESSION['schoolPattern']=$_POST['schoolPattern'];
            $country = mysql_real_escape_string($_POST['country']);
            $_SESSION['country']=$_POST['country'];
            $state = mysql_real_escape_string($_POST['state']);
            $_SESSION['state']=$_POST['state'];
        ...
        if ($user_type == 1) {
            ...
            $aicteaid="Select aicte_application_id from tbl_school_admin where aicte_application_id='$acite_aid' AND aicte_application_id !=''";
            $aid=mysql_query($aicteaid);
            $aicteids="Select aicte_permanent_id from tbl_school_admin where aicte_permanent_id='$aciteid' AND aicte_permanent_id !=''";
            $aids=mysql_query($aicteids);
            if (mysql_num_rows($row2) > 0){
                echo "<script>alert('School id already exist, please try with different id!!'); window.location.href='/core/addschool.php'; </script>";
                EXIT;
                } //conditions for aicte application and permenent id is added by Sayali for SMC-4743 on 8/9/2020 
                else if (mysql_num_rows($aid) > 0)
                {
                echo "<script>alert('AICTE Application ID  already exist, please try with different id!!'); window.location.href='/core/addschool.php'; </script>";
                EXIT;

                } 
                else if(mysql_num_rows($aids) > 0)
                {
                echo "<script>alert('AICTE Permanent ID  already exist, please try with different id!!'); window.location.href='/core/addschool.php'; </script>";
                EXIT;

                }
             
            /*Below query updated by Rutuja Jori for inserting School pattern to solve SMC-4817 on 08-09-2020*/
            $sqls = "INSERT INTO `tbl_school_admin`(name,address, scadmin_city, scadmin_gender,scadmin_country, email,  reg_date,scadmin_state,mobile,password,school_type,group_status,school_id,school_name,CountryCode,aicte_permanent_id,aicte_application_id,school_pattern) VALUES ('$name','$address','$city','$gender','$country', '$email','$dates','$state','$phone','$password','$school_type','$group_id','$school_id','$school_name','$country_code','$aciteid','$acite_aid','$schoolPattern')";
    ...
    //Staff insertion and access permission to staff functionality done by Pranali Dalvi for SMC-4645 on 4-4-20
            ...
            if ($count >= 1 && mysql_num_rows($arr1) >= 1) {
                ...
                if($school_type=='school') { 
                    $user = 'School Admin';
                    $user1='School Admin Staff';
                    $entity_id='102';
                    $smsid ='welcomeschooladminandstaff';
    ...
    //message to User added , autocomplete="off" and country code & mobile number field merge into one row by Pranali for SMC-4673 on 19-5-20
    //sendsms.php file called for SMS sending by Pranali for SMC-4673 on 6-6-20   
    ...
    //     }   
               ...
               //access permission to staff
                ...
                echo "<script>alert('Successfully Added New ".$user." and Staff');window.location.href='addschool.php'</script>";
            }
...
session_unset($_SESSION['school_type']);
session_unset($_SESSION['acite_aid']);
session_unset($_SESSION['aciteId']);
session_unset($_SESSION['phone']);
session_unset($_SESSION['gender']);
session_unset($_SESSION['address']);
session_unset($_SESSION['country_code']);
session_unset($_SESSION['schoolPattern']);
session_unset($_SESSION['city']);
session_unset($_SESSION['country']);
session_unset($_SESSION['state']);
session_unset($_SESSION['school_id']);
session_unset($_SESSION['school_name']);
session_unset($_SESSION['group_id']);
session_unset($_SESSION['amount']);
session_unset($_SESSION['company_name']);
session_unset($_SESSION['category']);
session_unset($_SESSION['payment_method']);
session_unset($_SESSION['address']);
        ...
        <div class='container' style="padding-top:20px;">
            <div class='panel panel-primary dialog-panel'
                ...
                <!-- Title School/Sponsor Registration & Add Excel Sheet modified by Pranali -->
                    <h3 align="center">School/Sponsor Registration</h3>
                ...
                <div class='panel-body'>
                    <form class='form-horizontal' role='form' method="post">
                        ...
                        <div class="row form-group">
                            ...
                            <br><div class='col-md-3 indent-small' id="errorstudent" style="color:#FF0000"></div><br>
                             <div class='col-md-3 ' id="errorlname" style="color:#FF0000" align="center"></div>
                        </div>
                        ...
                        <div class="row form-group" id="school_id1">
                            <label class='control-label col-md-3 col-md-offset-1'>School ID<span class="error"><b> * </b></span></label>
                            <div class='col-md-3'>
                                <div class='form-group internal'>
                                    <input type="text"  name="school_id" id='school_id' class='form-control' placeholder='Enter School ID' maxlength="20" value="<?php if ($_SESSION['school_id']!='') {
                                               echo $_SESSION['school_id'];
                                           } ?>" autocomplete="off"><div  id="errorSchoolid" style="color:#FF0000" align="right"></div>
                        ...
                        <div class="row form-group" id="sc_school_name1">
                            ...
                            <div class='col-md-3'>
                                <div class='form-group internal'>
                                    <input class='form-control ' type="text" id='sc_school_name' name="sc_school_name" placeholder='Enter School Name' maxlength="80" value="<?php if ($_SESSION['school_name']!='') {
                                               echo $_SESSION['school_name'];
                                           } ?>" autocomplete="off"> <div  id="errorSchool" style="color:#FF0000" align="right"></div>
                        ...
                        <div class="row form-group" id="group_id1">
                            ...
                            <div class='col-md-3'>
                                <div class='form-group internal'>
                                    <select  name="group_id" id='group_id' class='form-control'  />
                                        ...
                                        <option value="school" <?php if($_SESSION['group_id']=="school") echo "selected";?>>School</option>
                                        <option value="organization" <?php if($_SESSION['group_id']=="organization") echo "selected";?>>Organization</option>
                                        <option value="NYKS" <?php if($_SESSION['group_id']=="NYKS") echo "selected";?>>NYKS</option>
                                    </select>
                                </div> <div  id="errorGroup" style="color:#FF0000" align="right"></div>
                                <!--<div  id="errorcat" style="color:#FF0000" align="center">      -->
                            </div>
                            <!-- <div id="errorcat" style="color:#FF0000" align="center"></div>-->
                        </div>
                        ...
                        <div class="row form-group" id="school_type1">
                            ...
                            <div class='col-md-3'>
                                <div class='form-group internal'>
                                    <select  name="school_type" id='school_type' class='form-control'  >
                                        <!--                                        <option value="" disabled selected="selected">Select Type</option>-->
                                        <option value="">Select</option>
                                        <option value="school" <?php if($_SESSION['school_type']=="school") echo "selected";?>>School</option>
                                        <option value="organization" <?php if($_SESSION['school_type']=="organization") echo "selected";?>>Organization</option>
                                        <option value="NYKS" <?php if($_SESSION['school_type']=="NYKS") echo "selected";?>>NYKS</option>
                                           
                                    </select>
                                </div><div  id="errorStype" style="color:#FF0000" align="right"></div>
                                <!--<div  id="errorcat" style="color:#FF0000" align="center">      -->
                            </div>
                            <!-- <div id="errorcat" style="color:#FF0000" align="center"></div>-->
                            ...
                            <div class="row form-group" id="group_id1">
                            <label class='control-label col-md-3 col-md-offset-1'>School Pattern<span class="error"><b> * </b></span></label>
                            <div class='col-md-3'>
                                <div class='form-group internal'>
                                    <select  name="schoolPattern" id='schoolPattern' class='form-control'  />
                                       
                                        <option value="">Select</option>
                                        <?php if($_SESSION['schoolPattern']=='Annual'){ ?>
                                        <option value="Annual" selected>Annual</option>
                                        <option value="Semester">Semester</option>
                                        <?php } else if($_SESSION['schoolPattern']=='Semester'){?>
                        ...
                        </div><div  id="errorPattern" style="color:#FF0000" align="right"></div>
                        </div>
                        </div>
                        
                              <div class="row form-group" id="aictepid">
                            <label class='control-label col-md-3 col-md-offset-1'>AICTE Permanent ID</label>
                            <div class='col-md-3'>
                                <div class='form-group internal'>
                                    <input class='form-control ' id='aciteId' name="aciteId" placeholder='Enter AICTE Permanent ID' maxlength="80" value="<?php if($_SESSION['aciteId']!='') echo $_SESSION['aciteId']; else echo ""; ?>" autocomplete="off">
                        ...
                        <div class="row form-group" id="aicte_application_id">
                            <label class='control-label col-md-3 col-md-offset-1'>AICTE Application ID</label>
                            <div class='col-md-3'>
                                <div class='form-group internal'>
                                    <input class='form-control ' id='acite_aid' name="acite_aid" placeholder='Enter AICTE Application ID' maxlength="80" value="<?php if($_SESSION['acite_aid']!='') echo $_SESSION['acite_aid']; else echo ""; ?>" autocomplete="off">
                                ...
                                <div class='form-group internal'>
                                    <select  name="method" id='method' class='form-control'>
                                      <option value="" disabled selected="selected">Select Method</option>
                                        <option value="free" 
                                        <?php 
                                            if($_SESSION['payment_method']=="free")
                                                echo "selected";
                                            else echo "";   
                                        ?>>Free</option>
                                           <option value="Cash" 
                                        ...
                                        ?>>Cash</option>
                                              <option value="Cheque" 
                                              <?php 
                                            if($_SESSION['payment_method']=="Cheque")
                                                echo "selected";
                                            else echo "";   
                                        ?>>Cheque</option>
                       ...
                       <!-- <div class="row form-group" id="datediv">
                        ...
                        <div class='row form-group' id="amount">
                            ...
                            <div class='col-md-3 form-group internal'>
                               <input type="text" name="amount" value="<?php if ($_SESSION['amount']!='') {
                        ...
                        <div class='row form-group'>
                            ...
                            <div class='col-md-3 form-group internal'>
                                <input class='form-control' id='id_email' name="id_email" placeholder='Email ID'
                                       type='text' maxlength="55" value="<?php 
                                    if($report!=''){
                                        echo '';
                                    }
                                    else if ($_SESSION['email']!='') {
                                        echo $_SESSION['email'];
                                    } ?>" autocomplete="off"><!-- required onBlur="return validemail()"-->
             ...
             {?>
               ...
               <option value="<?php echo $result['calling_code'];?>" <?php if($_POST['country-code']==$result['calling_code']) echo "selected"; else echo "";?>><?php echo $result['calling_code']."  -  ".$result['country'];?></option>
             ...
             <input class='form-control' id='id_phone' name="id_phone" placeholder='Enter Mobile No.'
                                       ...
                                       value="<?php 
                                        ...
                                        {
                                           echo $_SESSION['phone'];
                                        } ?>" maxlength="15" required autocomplete="off"> <div class='indent-small' id="errorPhone" style="color:#FF0000"></div>
                                   <!-- </div> -->
                               </div>
                            <!--    
   ...
   -->
                        ...
                        <div class="row form-group">
                            ...
                            <div class='col-md-3 '>
                                ...
                                <textarea class='form-control' id='id_address' name="address" placeholder='Address' rows='3' maxlength="200" value="<?php 
                                if($_SESSION['address']!='') {
                        ...
                        <div class='row form-group'>
                            ...
                            <div class='col-md-3'>
                                <select id="country" name="country" class='form-control' style="width:100%;"
                                        value=" <?php if ($_SESSION['country']!='') {
                                            echo $_SESSION['country'];
                                        } ?>"></select>
                            </div><div class='indent-small' id="errorCountry" style="color:#FF0000"></div>
                        </div>
                        ...
                        <div class='row form-group'>
                            ...
                            <div class='col-md-3'>
                                <input class='btn-lg btn-danger' type='submit' name='reset' value='Reset' />
                            </div>
                        </div>
