...
$fr_date = date("d-m-Y H:i",mktime(00,00));//hour, minute, second
 ...
 $arr=mysql_query($student_sql);
    ...
    $query1=mysql_query("SELECT school_type,school_name FROM tbl_school_admin where school_id='$sc_id'");
      ...
      // echo "Data of " '.$school_name.' ',' '.($sc_id).';
     //$res_count = mysql_num_rows($arr);
...
<div class="container">
  <div class="row">
        ...
        <div class="radius" style="height:50px; background-color:#694489;" align="center">
          <h2 style="padding-left:20px;padding-top:10px;color:white"><?= $type_nm; ?> Login-Logout School-wise Teacher Statistics</h2>
        </div>
  </div>
  ...
  <div class="row" style="padding-top:10px;">
    ...
    <br>
    <form method="post" class="detail_color" style="cursor: pointer;" action="login_logout_teacher.php">
    ...
    <div class="col-md-12">
      <table class="table-bordered  table-condensed cf" id="example" width="100%;">
                                ...
                                <!-- Camel casing done for Sr. No. by Pranali -->
                                    ...
                                    <th style="width:21%;">Teacher ID</th>
                                    <th style="width:21%;">Teacher Department Name</th>
                                      ...
                                      <tr style="color:#808080;" class="active detail_color">
                                        ...
                                        <!-- <td data-title="school_id"><b><?php //echo $row['school_id']; ?></b></td> -->
                                         <td data-title="student_name"><b><?php echo $row['t_complete_name']; ?></b></td>  
                                          <td data-title="student_name"><b><?php echo $row['t_id']; ?></b></td>  
                                           <td data-title="student_name"><b><?php echo $row['t_dept']; ?></b></td>  
