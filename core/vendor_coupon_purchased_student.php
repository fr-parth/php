...
$sql=mysql_query(" SELECT tvc.coupon_id, tvc.code, tvc.user_id,s.std_complete_name,s.school_id
...
$sql1 =" SELECT count(tvc.coupon_id), tvc.code, tvc.user_id,s.std_complete_name,s.school_id
 FROM tbl_selected_vendor_coupons tvc 
 INNER JOIN tbl_student s ON tvc.user_id=s.id where tvc.entity_id='3'";  
...
if($searchq !='')
	...
	{
		$query1=mysql_query("SELECT tvc.coupon_id, tvc.code, tvc.user_id,s.std_complete_name,s.school_id
 FROM tbl_selected_vendor_coupons tvc 
 INNER JOIN tbl_student s ON tvc.user_id=s.id where tvc.entity_id='3'
 and
...
<script type="text/javascript">
    $(function () {
        ...
        window.pagObj = $('#pagination').twbsPagination({
			...
			window.location.assign('vendor_coupon_purchased_student.php?page='+page);
        });
    });
</script>
<?php }else{
...
<script type="text/javascript">
    $(function () {
        ...
        window.pagObj = $('#pagination').twbsPagination({
            ...
            console.info(page + '(from event listening)');
			window.location.assign('vendor_coupon_purchased_student.php?Search=<?php echo $searchq; ?>&spage='+page);
        });
    });
</script>
...
<div align="center">
    <div class="container" style="width:100%;">
        <div style="padding-top:30px;">
            ...
            <h2 style="padding-left:20px; margin-top:2px;color:#666">Vendor Coupons Used By Students</h2>
		...
		<div class="col-md-2" style="width:17%;">
			...
			<div class="col-md-1" >
			<input type="button" class="btn btn-info" value="Reset" onclick="window.open('vendor_coupon_purchased_student.php','_self')" />
			</div>
