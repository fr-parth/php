...
if(isset($_POST['delete']))
{
    ...
    if (answer){ 
		<?php $r = mysql_query("delete from tbl_360activities where act360_ID='$act360_ID' and act360_school_ID='$sc_id' "); ?>
...
if(isset($_POST['submit']))
{
	...
	$r = "update tbl_360activities set act360_activity='$act' ,act360_credit_points='$act360_credit_points' where act360_ID='$act360_ID' and act360_school_ID='$sc_id' ";
	

	}
else
{
$sql1 = mysql_query("select * from tbl_360activities where act360_activity ='$act' and act360_school_ID='$sc_id'");
...
$r = mysql_query("select * from tbl_360activities where act360_activity ='$act'and act360_school_ID='$sc_id'");
...
<div class="col-md-4 form-group">
          ...
          <div class="row" >
			 ...
			 <?php } else{ ?>
			 <div class="col-md-3 col-md-offset-1" id="del" style="padding:15px;">
                <input type="submit"  class="btn btn-danger" name="delete" value="Delete" style="width:100%; color:#FFFFFF;" >
              </div>
			  <?php } ?>
