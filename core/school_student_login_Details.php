...
$start_from = ($fpage-1) * $webpagelimit;
 ...
 $findq="Select std_complete_name,id,std_PRN,school_id,first_login_date,last_login_date from 
tbl_student where school_id='$school_id' $wheres order by last_login_date desc"; 

$sq = mysql_query("Select std_complete_name,id,std_PRN,school_id,first_login_date,last_login_date from 
tbl_student where school_id='$school_id' $wheres order by last_login_date desc LIMIT $start_from, $webpagelimit");

$sq1 ="Select count(id),std_complete_name,id,std_PRN,school_id,first_login_date,last_login_date from 
tbl_student  where school_id='$school_id' $wheres order by last_login_date desc";
...
$start_from = ($page-1) * $webpagelimit;
	$findq2="Select std_complete_name,id,std_PRN,school_id,first_login_date,last_login_date from tbl_LoginStatus
 tbl_student  where school_id='$school_id' AND last_login_date like '%$date%' order by id desc";
$sql=mysql_query("Select std_complete_name,id,std_PRN,school_id,first_login_date,last_login_date from tbl_LoginStatus
 tbl_student  where school_id='$school_id' AND last_login_date like '%$date%' order by id desc
LIMIT $start_from, $webpagelimit");	

$sql1 ="Select count(id),std_complete_name,id,std_PRN,school_id,first_login_date,last_login_date from 
tbl_student where school_id='$school_id' AND last_login_date like '%$date%' order by last_login_date desc"; 
...
//$colname=mysql_real_escape_string($_GET['colname']);
	if ($searchq != '')
	{ 
$findq1="Select std_complete_name,id,std_PRN,school_id,first_login_date,last_login_date from 
tbl_student where school_id='$school_id' and std_complete_name LIKE '%$searchq%' or id LIKE '%$searchq%'
  or school_id LIKE '%$searchq%' or first_login_date LIKE '%$searchq%' or last_login_date LIKE '%$searchq%' 
order by last_login_date desc";
		$query1=mysql_query("Select std_complete_name,id,std_PRN,school_id,first_login_date,last_login_date from 
tbl_student where school_id='$school_id' and std_complete_name LIKE '%$searchq%' or id LIKE '%$searchq%'
  or school_id LIKE '%$searchq%' or first_login_date LIKE '%$searchq%' or last_login_date LIKE '%$searchq%' 
order by last_login_date desc LIMIT $start_from, $webpagelimit") or die("could not Search!");
			...
			$sql1 ="Select count(id),std_complete_name,id,std_PRN,school_id,first_login_date,last_login_date from 
tbl_student where school_id='$school_id' AND std_complete_name LIKE '%$searchq%' or id LIKE '%$searchq%'
 or school_id LIKE '%$searchq%' or first_login_date LIKE '%$searchq%' or last_login_date LIKE '%$searchq%' order by last_login_date desc"; 
	...
	$findq3="Select std_complete_name,EntityID,school_id,first_login_date,last_login_date from 
tbl_student  where school_id='$school_id' and  $colname LIKE '%$searchq%' order by id desc";
...
$query1=mysql_query("Select std_complete_name,EntityID,school_id,first_login_date,last_login_date from 
tbl_student  where school_id='$school_id' and  $colname LIKE '%$searchq%' order by last_login_date desc LIMIT $start_from, $webpagelimit")
 or die("could not Search!");
					//echo $query1;
		$sql1 ="Select count(id),std_complete_name,id,std_PRN,school_id,first_login_date,last_login_date from 
tbl_student where school_id='$school_id' and  $colname LIKE '%$searchq%' order by last_login_date desc"; 
					$rs_result = mysql_query($sql1);  
					$row1 = mysql_fetch_row($rs_result);  
					$total_records = $row1[0];  
					$total_pages = ceil($total_records / $webpagelimit);
...
<?php if ($_GET['find']){?>
    ...
    $(function () {
        ...
        window.pagObj = $('#pagination').twbsPagination({
			...
			window.location.assign('school_student_login_Details.php?info=<?php echo $info;?>&find=<?php echo Find;?>&from=<?php echo $from;?>&to=<?php echo $to;?>&fpage='+page);
        });
    });
</script>
<?php }
...
<script type="text/javascript">
    $(function () {
        ...
        window.pagObj = $('#pagination').twbsPagination({
            ...
            console.info(page + '(from event listening)');
			window.location.assign('school_student_login_Details.php?page='+page);
        });
    });
</script>
<?php }else{
...
<script type="text/javascript">
    $(function () {
        ...
        window.pagObj = $('#pagination').twbsPagination({
            ...
            console.info(page + '(from event listening)');
			window.location.assign('school_student_login_Details.php?Search=<?php echo $searchq; ?>&spage='+page);
        });
    });
</script>
<?php }?>
...
<div align="center">
    <div class="container" style="width:100%;">
        <div style="padding-top:30px;">
            ...
            <h2 style="padding-left:20px; margin-top:2px;color:#666"> <?php echo $dynamic_student;?> Login Details</h2>
		...
		<form style="margin-top:5px;">
		  ...
		  <div class='row' style="margin-left:410px;">
			...
			<input type="button" class="btn btn-info" value="Reset" onclick="window.open('school_student_login_Details.php','_self')" />
			</div>
			...
			<div class="col-md-1" style="margin-left:50px">
			 <a href="Export_report.php?fn=studentlogin__<?php echo date('Y-m-d');?>" style="float:right; text-decoration:none;"><input type="button" value="Generate Excel Report" class="btn btn-info" style="margin-right: -500px;" /></a>
			</div><br><br>
			</div>
...
else if($findq2 !='')
{
  ...
  unset($_SESSION['report_values']);
    ...
    $_SESSION['report_header']=array("Sr.No.","Student Name","Member ID","First Login Time","Last Login Time");
  $j1=0;
  ...
  $_SESSION['report_values'][$j][1]=$row7['std_complete_name'];
