...
<?php if ($_GET['find']){?>
    ...
    $(function () {
        ...
        window.pagObj = $('#pagination').twbsPagination({
			...
			window.location.assign('saleperson_summary_org.php?from_date=<?php echo $from_date; ?>&to_date=<?php echo $to_date; ?>&find=<?php echo Find; ?>&fpage='+page);
        });
    });
</script>
<?php }
...
<script type="text/javascript">
    $(function () {
        ...
        window.pagObj = $('#pagination').twbsPagination({
            ...
            console.info(page + '(from event listening)');
			window.location.assign('saleperson_summary_org.php?page='+page);
        });
    });
</script>
<?php }else{
...
<script type="text/javascript">
    $(function () {
        ...
        window.pagObj = $('#pagination').twbsPagination({
            ...
            console.info(page + '(from event listening)');
			window.location.assign('saleperson_summary_org.php?Search=<?php echo $searchq; ?>&spage='+page);
        });
    });
</script>
<?php }?>
...
<div align="center">
    <div class="container" style="width:100%;">
		...
		<div class="col-md-1" style="font-weight:bold; margin-right:-36px;"> From</div>
			...
			<div class="col-md-1" >
			<input type="button" class="btn btn-info" value="Reset" onclick="window.open('saleperson_summary_org.php','_self')" />
			</div>
