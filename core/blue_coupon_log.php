   ...
   <table id="example" class="display" width="100%" cellspacing="0">
        ...
        <tbody>
         <?php
          ...
          $sql = "SELECT gp.*,school_name,school_id FROM `tbl_giftof_bluepoint` gp join tbl_school_admin sa on gp.`user_id`=sa.`school_id` or gp.`user_id`=sa.`id` where `entities_id`='102' and `points`!=0 group by coupon_id order by `id` desc";
