...
//////////// *****distance calculation query****** ////////	
	...
	{
		 $query ="select id, name, email, school_name, school_id,address, DTECode, stream, CountryCode, mobile, scadmin_city, scadmin_country,scadmin_state, group_type, group_name,img_path,$distance_in_km from tbl_school_admin s $having_order  LIMIT $limit OFFSET $offset";
