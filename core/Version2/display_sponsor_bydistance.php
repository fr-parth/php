...
include 'conn.php';
//input from user
  $std_latitude=xss_clean(mysql_real_escape_string((float)$obj->{'std_latitude'}));
 $std_longitude=xss_clean(mysql_real_escape_string((float)$obj->{'std_longitude'}));
 $dist=xss_clean(mysql_real_escape_string((int)$obj->{'distance'}));
