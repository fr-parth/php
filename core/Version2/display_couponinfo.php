	...
	if( $cp_id != "" )
		{
 			...
 			$arr = mysql_query("select c.cp_code, cp_stud_id, s.std_complete_name, s.std_name, s.std_lastname, s.school_id, s.std_Father_name, s.std_school_name, s.std_img_path, amount, c.status, cp_gen_date, c.validity, c.Stud_Member_Id from tbl_coupons c join tbl_student s on c.Stud_Member_Id=s.id where cp_code=\"$cp_id\"");
