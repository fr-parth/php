		...
		*/
			...
			if( $input_type != "" &&  $input_id != "" )
			{
				if($input_type=='VENDOR_INFO')
				{
					...
					$getVendorInfo="select count(id) as idCount from tbl_sponsorer where (v_status='Active' or v_status is null) and id='$input_id'";
					...
					if($count['idCount']>=1) 
					{
						...
						*/
						...
						$lon = xss_clean(mysql_real_escape_string($obj->{'long'}));
