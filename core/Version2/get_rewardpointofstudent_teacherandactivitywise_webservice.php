	...
	*/		
		...
		//$limit call from core/securityfunctions.php
			...
			while($post1 = mysql_fetch_assoc($arr4)) {
						...
						{
							$t_name=$post1['std_complete_name'];
						}
						else{
							$t_name='';
						}
