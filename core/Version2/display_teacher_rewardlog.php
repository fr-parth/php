...
LEFT JOIN tbl_studentpointslist sp ON sp.sc_id =st.sc_studentpointlist_id
LEFT JOIN tbl_school_subject ss ON ss.Subject_Code =st.subject_id
join tbl_student s on  s.std_PRN=st.sc_stud_id 
