...
*/
		...
		$arr=mysql_query("SELECT tp.* FROM techindi_Dev.tbl_teacher_point tp join tbl_school_admin sa ON sa.id =tp.assigner_id where(tp.sc_teacher_id='$t_id' or tp.sc_teacher_id='$user_id')and tp.sc_entities_id='102' union SELECT tp.* FROM techindi_Dev.tbl_teacher_point tp join tbl_teacher t ON t.id = tp.assigner_id where(tp.sc_teacher_id='$t_id' or tp.sc_teacher_id='$user_id')and tp.sc_entities_id='103' and tp.school_id='$school_id' order by id desc limit $limit OFFSET $offset");
