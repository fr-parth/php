...
include 'conn.php';
  ...
  if(mysql_num_rows($result)==1) {
    while($post = mysql_fetch_assoc($result)) {
		/* Author VaibhavG
		* here I have been passed full image path to the std_img_path key & pushed into final array as per the discussed with Android Developer Pooja Paramshetti fir the ticket number SAND-480
		*/
