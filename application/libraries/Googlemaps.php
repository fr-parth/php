...
class Googlemaps {
	...
	//Commented old $apikey by VaibhavG for the ticket number SMC-3245 22Aug18 5:57PM
	//var $apiKey					= 'AIzaSyBrF5WZNU9OKnU_NkKFwuy7Ufo22AYp4cQ';
	//Added below new $apikey by VaibhavG for the ticket number SMC-3245 22Aug18 5:57PM

	//var $apiKey						= 'AIzaSyCsoxrWRL4sdXdF6LaucFAHpwHSLLbuSvY';  

//Commented old $apikey by Pranali for the ticket number SMC-3505 23-5-19 2:57PM
// AIzaSyCVr3QfrTI4XYkwH40WZtOwCJDtlyJpd8w
	var $apiKey						= 'AIzaSyDKXKdHQdtqgPVl2HI2RnUa_1bjCxRCQo4';						// If you've got an API key you can use it by passing this parameter. Setup an API key here: https://code.google.com/apis/console
	...
	var $zoom						= 15;						// The default zoom level of the map. If set to "auto" will autozoom/center to fit in all visible markers. If "auto", also overrides the $center parameter
	...
	var $places						= TRUE;					// Whether or not the map will be used to show places
	...
	//Added below address value for $placesAutocompleteInputID by VaibhavG for the ticket number SMC-3245 22Aug18 5:57PM
	var $placesAutocompleteInputID	= 'address';						// The ID attribute of the textfield that the autocomplete should effect
	...
	function create_map()
	{
		...
		if ($this->maps_loaded == 0)
		{
			if ($this->apiKey!="") 
			{
				if ($this->https) { $apiLocation = 'https'; }else{ $apiLocation = 'https'; }
