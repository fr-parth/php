...
class AICTEcollegeinfo extends CI_Controller
{
	...
	public function index($id=NULL)
	{
		if($id!=NULL){
			...
			$this->load->view('college_data_form',$data);	
		}else{
			$this->load->view('college_data_form');	
		}
	}
...
// exit;
			...
			echo ("<script LANGUAGE='JavaScript'>
					alert('Thanks for updating your college information. We will contact you soon for further process.');
					window.location.href='../index.php';
					</script>");
			$this->session->set_flashdata("success_msg","Your Data has been added successfully.");
		}else{
