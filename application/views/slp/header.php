...
<!DOCTYPE html>
<html lang="en">
<head><title>SmartCookie :: Salesperson</title>
    <meta charset="utf-8">
    ...
    <!--Loading style-->
    <link type="text/css" rel="stylesheet" href="<?php echo base_url(); ?>Assets/css/themes/style3/orange-blue.css" id="theme-change" class="style-change color-change">
             ...
             <!--   <ul class="nav navbar-nav ">
               ...
               <!-- <div class="news-update-box hidden-xs"><span class="text-uppercase mrm pull-left">News:</span>
                    <ul id="news-update" class="ticker list-unstyled">
                      <li>Welcome to SmartCookie - Sponsor</li>
                ...
                <!--    <li class="dropdown"><a data-hover="dropdown" href="#" class="dropdown-toggle"><i class="fa fa-bell fa-fw"></i><span class="badge badge-green">3</span></a>
                    ...
                    <?php $this->load->helper('imageurl'); ?>
                            <a data-hover="dropdown" href="#" class="dropdown-toggle">                          
                                <img src="<?php echo imageurl($user[0]->p_image,'avatar','sp_profile');?>" alt="" class="img-responsive img-circle"/>                               
                                &nbsp;
                                <span class="hidden-xs"><?= $user[0]->p_name; ?></span>&nbsp;<span class="caret"></span>
                            </a>
                        <ul class="dropdown-menu dropdown-user pull-right">
                         <!--   <li><a href="extra-profile.html"><i class="fa fa-user"></i>My Profile</a></li>
                            ...
                            <li><a href="<?php echo site_url('Csalesperson/logout'); ?>"><i class="fa fa-key"></i>Log Out</a></li>
                        </ul>
                    </li>
        ...
        <nav id="sidebar" role="navigation" data-step="2" data-intro="Template has &lt;b&gt;many navigation styles&lt;/b&gt;" data-position="right" class="navbar-default navbar-static-side">
            <div class="sidebar-collapse menu-scroll">
                <ul id="side-menu" class="nav">
                    ...
                    <li class="user-panel">
                        <div class="thumb">
                        <img src="<?php echo imageurl($user[0]->p_image,'avatar','sp_profile');?>" alt="" class="img-circle"/>                      
                        </div>
                        <div class="info">
                            <p><b><?=$user[0]->p_name;?></b></p>                            
                            <p>Salesperson</p>
                            <div class='row text-center' style='background-color:#CF4346;'>
                            <p><?='SLP'.$user[0]->person_id;?></p>
                            </div>
                        </div>
                        <div class="clearfix"></div>
                    </li>

                    <li <?php if(uri_string()=='Csalesperson' or 
                    uri_string()=='Csalesperson/RegisteredSponsorsList'){ echo 'class="active"'; }; ?> ><a href="<?php echo site_url('Csalesperson'); ?>"><i class="fa fa-tachometer fa-fw">
                        <div class="icon-bg bg-orange"></div>
                    </i><span class="menu-title">Dashboard</span></a></li>              

                    
                    <li <?php if(uri_string()=='Csalesperson/page/RegisterSponsor'){ echo 'class="active"'; }; ?> >
                    <a href="<?php echo site_url('Csalesperson/page/RegisterSponsor'); ?>"><i class="fa fa-edit fa-fw">
                        <div class="icon-bg bg-green"></div>
                    </i><span class="menu-title">Register Sponsor</span></a>
                    </li>
                    <!--
                    <li <?php if(uri_string()=='Csalesperson/page/SMSPanel'){ echo 'class="active"'; }; ?> >
                    <a href="<?php echo site_url('Csalesperson/page/SMSPanel'); ?>"><i class="fa fa-edit fa-fw">
                        <div class="icon-bg bg-green"></div>
                    </i><span class="menu-title">Send SMS/Email</span></a>
                    </li>-->
                    
                    <li <?php if(uri_string()=='Csalesperson/page/sponsor_map'){ echo 'class="active"'; }; ?> >
                    <a href="<?php echo site_url('Csalesperson/page/sponsor_map'); ?>"><i class="fa fa-dot-circle-o">
                        <div class="icon-bg bg-green"></div>
