<?php //Updated by Sayali Balkawade for Display Logo and Entity,header ,footer and back button  name on 30/12/2020 for SMC-5058 ?>
<!DOCTYPE html>
<html lang="en">
<head>
<style>
...
<!-- Created by Rutuja Jori for updating password for Login with OTP functionality for SMC-4995 on 07-12-2020 -->
<?php 
error_reporting(0);
...
<?php } ?>
            <div class="form-head" align='center'><?php echo $entity_name; ?>  Update Password</div>
            ...
            <br>
                ...
                <div>
                       <?php 
                  echo form_submit('update_password', 'Update','class="myButton btn btn-primary" id="update_password" onclick=" return OTPLoginForm();"');
                ?>
