              ...
              <div class="visible-xs">
                <img src="<?php echo base_url();?>Assets/images/logo/220_76.png" />
                    ...
                    <div class='row bg-red text-center title-text'>
                        <span class='panel-title color-white'><?php echo $entity_name; ?> Registration</span>
                    </div><br>
...
<?php 
                  echo form_submit('submit', 'Submit','class="btn btn-primary" id="submit" onclick=" return OTPLoginForm_stud();"');
                ?>

                    
            <a href="<?php echo base_url();?>core/express_registration_sp.php" style="text-decoration:none;"> <input type="button"  class="btn btn-danger" name="Back" value="Back"/></a>
              </div>
            <br>
