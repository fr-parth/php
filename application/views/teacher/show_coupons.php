        ...
        <div class="col-md-6 col-md-offset-3" id="printablediv">
            <div class="panel panel-primary coupon_primary" >
                ...
                <div class="panel-body">
					...
					Coupon Code : <?php echo $generated_coupon_details[0]->coupon_id ?></br>
                    Coupon Points : <?php echo $generated_coupon_details[0]->amount ?></br>
					Issued Date : <?php echo $generated_coupon_details[0]->issue_date ?>
