...
$data_array = array();*/
/* For Sponsors Data */
foreach ($sponsorinfo as $coordinate)
		{
    /* Each row is added as a new array */
    $data_array[] = $coordinate;
    $res[] = $coordinate;
    $locations[] = array(
        "title" => $coordinate->sp_company,
        "lat" => $coordinate->lat,
        "lng" => $coordinate->lon
        //"description" =>  "Shop Name : <b>" . $coordinate->sp_company . "</b><br>Address : <b>" . $coordinate->sp_address . "," . $coordinate->sp_city . "," . $coordinate->sp_country."</b><br>Discount Percentage : <b>" . $coordinate->discount  
    );
}
