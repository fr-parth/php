...
<!-- <script>
    ...
    <div id="title-breadcrumb-option-demo" class="page-title-breadcrumb">
                <div class="page-header pull-left">
                    <div class="page-title">Coupon Details</div>
                </div>
        ...
        <div class="col-lg-12">
         ...
         <div class="col-md-3">	Issued To: </div>
          ...
          <div class="row" style="margin-top:5%;">
         <div class="col-md-3"></div>
         <div class="col-md-3">	Generation Date: </div>
     ...
     <div class="row" style="margin-top:5%;">
         ...
         <div class="col-md-3"><?php echo ($this->session->userdata('usertype')=='employee')?'Organization':'School'; ?> Name: </div>
          <div class="col-md-6"><?php echo $couponinfo[0]->school_name;?> </div>
    </div>
				...
				<?php 
						...
						$output=$couponinfo[0]->cp_code;

						echo "<img src='".base_url()."/application/views/qr_img0.50j/php/qr_img.php?d=$output'>";
