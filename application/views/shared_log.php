     ...
     <div id="area-chart-spline" style="width: 100%; height:300px; display:none;"></div>
            ...
            <div id="title-breadcrumb-option-demo" class="page-title-breadcrumb">
                <div class="page-header pull-left">
                    <div class="page-title">Shared Points Log</div>
                </div>
                <ol class="breadcrumb page-breadcrumb pull-right">
                    ...
                    <li class="active">Share Points Log</li>
                </ol>
                                  ...
                                  <div id="no-more-tables">
                                    <table class="table table-bordered table-hover " id="example" style="margin-left: 0px !important;">
                                        ...
                                        <tbody>
                                            <?php 
                                            $i=1;
                                            foreach($sharedinfo as $t) {?>
                                        <tr>
                                            <td data-title="Sr.No"><?php echo $i;?></td>
                                            <td data-title="<?php echo ($this->session->userdata('usertype')=='employee')?'Employee':'Student'; ?> Name"><?php if( $t->std_complete_name!="")
											{
