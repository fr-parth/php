            ...
            <div class="page-content">
                ...
                <th>Assign</th>
                                        ...
                                        <tr>
                                            ...
                                            <td data-title=""><?php if ($t->std_img_path==""){ ?> <img src="<?php echo base_url()?>images/avtar.png"  alt="" class="img-circle" style="height:50px;width:50px;"/><?php  } else {?><img src="<?php echo base_url()?><?php echo $t->std_img_path?>"  alt="" class="img-circle" style="height:50px;width:50px;"/> <?php };?></td>
                                            ...
                                            <td><a href="share_points/<?php echo $t->std_PRN?>"><button type="button" class="btn btn-success">Request</button></a></td>
