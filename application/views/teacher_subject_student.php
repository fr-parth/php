        ...
        <?php print_r($row);die;?>
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 scroll">
                <table id="example" class="table table-striped table-inverse table-bordered table-responsive table-dark" style="border:none;" align="center" role="grid" aria-describedby="example_info">
                    ...
                    <?php
                        $i=0;
                        foreach($row as $teacherstud){
                    ?>  
                        <tr>
                            <td><?php echo $i++; ?></td>
                            <td><?php echo $teacherstud[$i]->student_id; ?></td>
                            <td><?php echo $teacherstud[$i]->std_complete_name; ?></td>
                            <td><?php echo $teacherstud[$i]->std_school_name; ?></td>
                            <td><?php echo $teacherstud[$i]->std_dept; ?></td>
                            <td><?php echo $teacherstud[$i]->std_class; ?></td>
