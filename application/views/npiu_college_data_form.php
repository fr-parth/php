...
body{
    ...
    <!-- <form id="facultyDetailsForm" class="form-horizontal" role="form" method="post"> -->
    <form id="facultyDetailsForm" action="<?= base_url('NPIUcollegeinfo/InsertCollege_data');?>" class="form-horizontal" role="form" method="post" enctype="multipart/form-data">
    ...
    <div class="form-group required" >
               ...
               <label><h3>Some Of The Following People Can Help In The Implementation</h3></label>
                ...
                <div class="form-group" >
                    ...
                    <div class="col-md-12">
                        <label><h3>Special Project Coordinator</h3></label>
                    </div>
                    <div class="col-lg-12 col-md-12 table-responsive">
                        <table class="table table-bordered">
                            <thead>
                                ...
                                <th style="width: 30%;">Name of In-charge</th>
                                <th style="width: 15%;">Mobile No</th>
                                <th style="width: 20%;">Email Id</th>
                                <!-- <th style="width: 15%;">Meeting Date & Time</th> -->
                            </thead>
                            <tbody class="text-justify">
                                <!--Updated by Rutuja for fetching values from tbl_special_project table on 23-11-2020 for SMC-4953-->
                                <?php $k=1; foreach($special_project_detail as $sp){?>
                                <tr>
                                    <td><?= $k++; ?></td>
                                    <td><input type="hidden" name="project_id[]" id="project_id_<?= $k;?>" value="<?= $sp->id;?>"><input type="hidden" name="project_name[]" id="project_name_<?= $k;?>" value="<?= $sp->project_name;?>"><?= $sp->project_name;?> Coordinator</td>
                                    <td><input class="form-control" type="text" name="project_incharge_nm[]" id="project_incharge_nm_<?= $k;?>" placeholder="Enter Name"></td>
                                    <td><input class="form-control nums_only" type="text" name="project_incharge_mob[]" id="project_incharge_mob_<?= $k;?>" placeholder="Enter Mobile No."></td>
                                    <td><input class="form-control" type="email" name="project_incharge_email[]" id="project_incharge_email_<?= $k;?>" placeholder="Enter Email ID"></td>
                                    <!-- <td><input class="form-control datetimepick" name="erp_meet_date" id="erp_meet_date"  type="text" placeholder="YYYY-MM-DD H:M" autocomplete="off" data-date-format="YYYY-MM-DD - HH:ii p" data-link-field="dtp_input1"></td> -->
                                </tr>
                                <?php } ?>
  ...
  <div class="modal-dialog modal-lg" >
     ...
     <script type="text/javascript">
      $(document).ready(function() {
        ...
        //alert(college_val);
            ...
            $.ajax({
                url:"<?php echo base_url();?>NPIUcollegeinfo/Search_college_data",
                type:"POST",
                data:{
                    sc_id:college_id
                    // ct:city
    ...
    <script>
        $("#search").click(function(){
            ...
            if(state=="" && city==""){
                ...
                $.ajax({
                    url:"<?php echo base_url();?>NPIUcollegeinfo/Search_college_Ajax",
                    type:"POST",
                    data:{
                        st:state,
                        ct:city
     ...
     <script>
        $("#search1").click(function(){
            ...
            if(str==""){
                ...
                $.ajax({
                    url:"<?php echo base_url();?>NPIUcollegeinfo/Search_college_info",
                    type:"POST",
                    data:{
                        application_id:str                       
                    },
    ...
    $("#search2").click(function(){
        ...
        if(p_id==""){
            ...
            //alert(p_id);
            $.ajax({
                url:"<?php echo base_url();?>NPIUcollegeinfo/Search_permanent_id",
                type:"POST",
                data:{
                    permanent_id:p_id
