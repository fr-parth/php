     ...
     <div id="area-chart-spline" style="width: 100%; height:300px; display:none;"></div>
            ...
            <div id="title-breadcrumb-option-demo" class="page-title-breadcrumb">
                <div class="page-header pull-left">
                    <div class="page-title">Assign Points on Behalf of Teacher Log</div>
                </div>
                                ...
                                <div class="row">
                                  ...
                                  <div id="no-more-tables">
                                    <table class="table table-bordered table-hover " id="example" style="margin-left: 0px !important;">
                                        ...
                                        <tr>
                                            <th>Sr. No.</th>
                        <th>Activity/<?php echo ($this->session->userdata('usertype')=='employee')?'Project':'Subject'; ?></th>
                        <th>Points</th>
                        <th><?php echo ($this->session->userdata('usertype')=='employee')?'Employee':'Student'; ?> Name</th>
						 <th>On Behalf of <?php echo ($this->session->userdata('usertype')=='employee')?'Manager':'Teacher'; ?></th>
                        <th>Date</th>
                                        ...
                                        <tbody>
                                            <?php 
                                            $i=1;
                                            foreach($assign_points_log as $t) {?>
                                        <tr>
                                            <td data-title="Sr.No"><?php echo $i;?></td>
                                             <td data-title="Reason" ><?php echo ucwords(strtolower( $t->reason));?></td>
                                            <td data-title="Points" ><?php echo $t->sc_point;?></td>
											    <td data-title="Points" ><?php echo ucwords(strtolower( $t->student));?></td>
												 <td data-title="Points" ><?php echo ucwords(strtolower( $t->teacher));?></td>
